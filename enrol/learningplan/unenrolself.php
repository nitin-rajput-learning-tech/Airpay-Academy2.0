...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'learningplan'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/learningplan/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_learningplan', format_string($course->fullname));
