...
$string['newenrols_desc'] = 'Allow users to  enrol into new courses via Learning Plan.';
...
$string['pluginname'] = 'Learning Plan enrolment';
$string['pluginname_desc'] = 'The  Learning Plan enrolment plugin allows users to choose which courses they want to participate in. The courses may be protected by an enrolment key. Internally the enrolment is done via the manual enrolment plugin which has to be enabled in the same course.';
$string['requirepassword'] = 'Require enrolment key';
$string['requirepassword_desc'] = 'Require enrolment key in new courses and prevent removing of enrolment key from existing courses.';
$string['role'] = 'Default assigned role';
$string['self:config'] = 'Configure  Learning Plan enrol instances';
$string['self:holdkey'] = 'Appear as the  Learning Plan enrolment key holder';
$string['self:manage'] = 'Manage enrolled users';
$string['self:unenrol'] = 'Unenrol users from course';
$string['self:unenrolself'] = 'Unenrol  Learning Plan from the course';
$string['sendcoursewelcomemessage'] = 'Send course welcome message';
$string['sendcoursewelcomemessage_help'] = 'If enabled, users receive a welcome message via email when they  they are enrolled to Learning Plan.';
$string['showhint'] = 'Show hint';
$string['showhint_desc'] = 'Show first letter of the guest access key.';
$string['status'] = 'Allow existing enrolments';
$string['status_desc'] = 'Enable  Learning Plan enrolment method in new courses.';
$string['status_help'] = 'If enabled together with \'Allow new enrolments\' disabled, only users who  Learning Plan enrolled previously can access the course. If disabled, this  Learning Plan enrolment method is effectively disabled, since all existing  Learning Plan enrolments are suspended and new users cannot self enrol.';
...
$string['welcometocoursetext'] = 'Hi,<br/>

    <div>You have successfully enrolled to the following course.</div>
    
    <div>Course name: "{$a->coursename}"</div>

  ';
//code commented by anil
...
$string['notforyour']='Not applicable for your';
$string['learningplan:config']='Config';
$string['learningplan:holdkey']='Hold key';
$string['learningplan:manage']='Manage learningplan';
$string['learningplan:unenroluser']='Unenrol users';
$string['learningplan:unenrolself']='Unenrol self';
$string['learningplan:unenrol'] = 'Unenrol'; 
