...
$string['newenrols_desc'] = 'Allow users to  enrol into new courses via program.';
...
$string['pluginname_desc'] = 'The  program enrolment plugin allows users to choose which courses they want to participate in. The courses may be protected by an enrolment key. Internally the enrolment is done via the manual enrolment plugin which has to be enabled in the same course.';
$string['requirepassword'] = 'Require enrolment key';
$string['requirepassword_desc'] = 'Require enrolment key in new courses and prevent removing of enrolment key from existing courses.';
$string['role'] = 'Default assigned role';
$string['self:config'] = 'Configure  program enrol instances';
$string['self:holdkey'] = 'Appear as the  program enrolment key holder';
$string['self:manage'] = 'Manage enrolled users';
$string['self:unenrol'] = 'Unenrol users from course';
$string['self:unenrolself'] = 'Unenrol  program from the course';
...
$string['status_desc'] = 'Enable  program enrolment method in new courses.';
$string['status_help'] = 'If enabled together with \'Allow new enrolments\' disabled, only users who  program enrolled previously can access the course. If disabled, this  Learning Plan enrolment method is effectively disabled, since all existing  Learning Plan enrolments are suspended and new users cannot self enrol.';
...
$string['program:config'] = 'Configure program enrol instances';
$string['program:enrol'] = 'Enrol users';
$string['program:manage'] = 'Manage user enrolments';
