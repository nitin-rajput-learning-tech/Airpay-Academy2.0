...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'classroom'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/classroom/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_classroom', format_string($course->fullname));
