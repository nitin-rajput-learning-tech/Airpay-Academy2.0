...
$string['newenrols_desc'] = 'Allow users to  enrol into new courses via Classroom.';
...
$string['pluginname'] = 'Classroom enrolment';
$string['pluginname_desc'] = 'The  classroom enrolment plugin allows users to choose which courses they want to participate in. The courses may be protected by an enrolment key. Internally the enrolment is done via the manual enrolment plugin which has to be enabled in the same course.';
$string['requirepassword'] = 'Require enrolment key';
$string['requirepassword_desc'] = 'Require enrolment key in new courses and prevent removing of enrolment key from existing courses.';
$string['role'] = 'Default assigned role';
$string['self:config'] = 'Configure  Classroom enrol instances';
$string['self:holdkey'] = 'Appear as the  Classroom enrolment key holder';
$string['self:manage'] = 'Manage enrolled users';
$string['self:unenrol'] = 'Unenrol users from course';
$string['self:unenrolself'] = 'Unenrol  Classroom from the course';
...
$string['classroom:config'] = 'Configure classroom enrol instances';
$string['classroom:enrol'] = 'Enrol users';
$string['classroom:manage'] = 'Manage user enrolments';
