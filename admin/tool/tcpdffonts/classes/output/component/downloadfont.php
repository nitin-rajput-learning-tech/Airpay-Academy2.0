...
/**
 * Download font action.
 *
 * File         downloadfont.php
 * Encoding     UTF-8
 *
...
/**
 * tool_tcpdffonts\output\component\downloadfont
 *
 * @package     tool_tcpdffonts
 *
 * @copyright   2021 RvD
...
class downloadfont implements renderable, templatable {
    ...
    public function __construct($baseurl, $instance, $instanceisfontfamily = false, $actionstring = null) {
        ...
        if (empty($actionstring)) {
            $this->actionstring = get_string('action:font:download', 'tool_tcpdffonts');
        } else {
