...
* remove folder theme/epsilon/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/epsilon/scss/bootstrap
...
* comment out this line in theme/epsilon/scss/_print.scss
    @page {
...
* remove folder theme/epsilon/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/epsilon/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/epsilon/amd/src
* edit theme/epsilon/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/epsilon run "grunt amd" to compile the bootstrap JS
* in folder theme/epsilon run "grunt css" to compile scss
