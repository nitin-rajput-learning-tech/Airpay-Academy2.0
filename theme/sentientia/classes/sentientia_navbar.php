...
/**
 * Creates a breadcrumb navbar for theme_sentientia that allows easy control of the navbar items.
 *
 * Adapted from Moodle core's \theme_boost\boostnavbar for theme_sentientia. The core
 ...
 */
class sentientia_navbar implements \renderable {
    ...
    /**
     * Prepares the navigation nodes for use with the sentientia navbar.
     */
