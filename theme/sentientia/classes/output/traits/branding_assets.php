...
trait branding_assets {
    ...
    public function should_display_navbar_logo(): bool {
        ...
        if (empty($logopath)) {
            ...
            if (empty($logopath)) {
                $logopath = $this->image_url('default_logo', 'theme_sentientia');
            }
        }
     ...
     *   3. theme_sentientia default_logo image
     */
    ...
    public function carousellogo(): string {
        ...
        if (empty($carousellogo)) {
            $carousellogo = $this->image_url('carousel_logo', 'theme_sentientia');
        }
        return $carousellogo;
    }
    ...
    public function loginordering(): bool {
        $order = get_config('theme_sentientia', 'loginorder');
        return $order != 0;
    }
