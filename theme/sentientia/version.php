...
$plugin->version   = 2026092201;  // dashboard tenant scope extracted to a tested class; fails closed
...
$plugin->release   = '1.0.56-beta';  // dashboard i18n complete (body + template fragments) + F-12 residue pass
