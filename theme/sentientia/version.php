...
$plugin->version   = 2026092200;  // guest/login/suspended-user queries: /-bounded tenant paths
...
$plugin->release   = '1.0.55-beta';  // dashboard i18n complete (body + template fragments) + F-12 residue pass
