 ...
 *
 * theme_sentientia/datatable is a shared AMD client used by 14+ WS
 ...
 * theme_sentientia\ws_contract_scanner so the same logic runs from CLI
...
final class ws_contract_test extends \advanced_testcase {
    ...
    public function test_every_datatable_ws_accepts_client_contract(): void {
        ...
        if (!empty($result['failures'])) {
            ...
            $this->fail(
                "The shared theme_sentientia/datatable client POSTs "
