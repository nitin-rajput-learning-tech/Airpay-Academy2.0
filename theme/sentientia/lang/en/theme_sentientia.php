...
$string['nav_aiquiz'] = 'AI Quiz';
$string['nav_analytics'] = 'Analytics';
$string['nav_authoringstudio'] = 'Authoring Studio';
...
$string['dash_sec_system_health'] = 'System Health';
$string['dash_sec_user_analytics'] = 'User Analytics';
$string['dash_sec_compliance_overview'] = 'Compliance Overview';
$string['dash_sec_my_team'] = 'My Team';
$string['dash_sec_team_compliance'] = 'Team Compliance';
$string['dash_sec_activity_timeline'] = 'Activity Timeline';
$string['dash_sec_recent_achievements'] = 'Recent Achievements';
$string['dash_sec_recommended'] = 'Recommended for You';
$string['dash_activity_user_completed'] = '{$a->user} completed {$a->course}';
$string['dash_activity_user_enrolled'] = '{$a->user} enrolled in {$a->course}';
$string['login_hero_subtitle'] = 'Upskill. Get certified. Get hired.';
$string['login_feature_upskill_title'] = 'Upskill on demand';
$string['login_feature_upskill_desc'] = 'Job-ready courses in finance, payments, tech & business — built by the people running real platforms.';
$string['login_feature_assess_title'] = 'Hiring assessments';
$string['login_feature_assess_desc'] = 'Take employer-graded tests. Pass once, get shortlisted by hiring partners across the industry.';
$string['login_feature_cert_title'] = 'Verified certificates';
$string['login_feature_cert_desc'] = 'Every completion ships with a tamper-proof certificate you can share on LinkedIn or attach to a CV.';
$string['login_stat_learners'] = 'Learners upskilling';
$string['login_stat_courses'] = 'Courses available';
$string['login_stat_certificates'] = 'Certificates earned';
$string['login_form_title'] = 'Welcome back';
$string['login_form_subtitle'] = 'Pick up your courses, take assessments, and earn your next certificate.';
$string['login_forgot'] = 'Forgot Password?';
$string['login_create_account'] = 'Create an Account';
$string['login_privacy'] = 'Privacy Policy';
