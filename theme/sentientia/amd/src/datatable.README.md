# `theme_sentientia/datatable` — shared admin datatable component
...
3. Deploy both files + `scss/moodle/partials/_datatable.scss` to XAMPP:
   ```powershell
   Copy-Item "moodle-enhancement\theme\sentientia\amd\src\datatable.js" `
             "C:\xampp\htdocs\moodle5\public\theme\sentientia\amd\src\datatable.js"
   Copy-Item "moodle-enhancement\theme\sentientia\amd\build\datatable.min.js" `
             "C:\xampp\htdocs\moodle5\public\theme\sentientia\amd\build\datatable.min.js"
   Copy-Item "moodle-enhancement\theme\sentientia\scss\moodle\partials\_datatable.scss" `
             "C:\xampp\htdocs\moodle5\public\theme\sentientia\scss\moodle\partials\_datatable.scss"
   ```
