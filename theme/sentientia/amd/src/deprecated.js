...
//
// theme_sentientia/deprecated — emit graceful JS deprecation notices.
//
...
//
// API:
//   import {deprecate} from 'theme_sentientia/deprecated';
//
//   // When a function is called:
//   export const oldApi = (...args) => {
//       deprecate('oldApi', 'newApi', 'theme_sentientia/widget');
//       // ... legacy implementation ...
//   };
//
//   // Force the warning regardless of debug setting:
//   deprecate('oldApi', 'newApi', 'theme_sentientia/widget', {force: true});
//
// Output format (matches Moodle 5.2 shape):
//   [DEPRECATED] theme_sentientia/widget#oldApi — use newApi
//   Called from: <stack frame>
//
// When we upgrade to Moodle 5.2, callers swap
// 'theme_sentientia/deprecated' → 'core/deprecated' (identical API).
//
// @module     theme_sentientia/deprecated
 ...
 * @param {string} module   - the module owning the deprecation, e.g. "theme_sentientia/widget"
