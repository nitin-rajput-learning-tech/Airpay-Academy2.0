 ...
 *
 * @module     theme_sentientia/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_sentientia/drawers:show}
     * @property {String} drawerShown See {@link event:theme_sentientia/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_sentientia/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_sentientia/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_sentientia/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_sentientia/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_sentientia/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_sentientia/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_sentientia/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_sentientia/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_sentientia/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_sentientia/drawers:hidden',
    };
     ...
     * @returns {module:theme_sentientia/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_sentientia/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_sentientia/drawers:close');
     ...
     *
     * @param {module:theme_sentientia/drawers} comparisonInstance
     */
