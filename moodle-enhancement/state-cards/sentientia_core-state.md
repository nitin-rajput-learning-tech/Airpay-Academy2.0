...
| **Version** | `2026060100` / `0.3.0-alpha` (MATURITY_ALPHA) |
| **Owner** | Nitin Rajput |
| **Status** | Seams shipped + default-legacy (dormant). Wave 4 registry built + locally rehearsed; live cutover gated on Nitin's deploy. |
...
db/install.xml                      local_sentientia_customer + local_sentientia_tenant (W4)
db/upgrade.php                      W4 savepoint 2026060100 (creates the 2 tables)
...
classes/org.php                     W3.1 seam (manager_id_of / manager_id_for_current_user)
