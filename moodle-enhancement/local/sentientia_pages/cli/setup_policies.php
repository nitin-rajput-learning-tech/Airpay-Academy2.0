...
if (!empty($existing)) {
    ...
    $version1->content = file_get_contents($CFG->dirroot . '/local/sentientia_pages/pages/privacy.html');
    ...
    $version2->content = file_get_contents($CFG->dirroot . '/local/sentientia_pages/pages/terms.html');
