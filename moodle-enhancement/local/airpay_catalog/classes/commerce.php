...
class commerce {
    ...
    public static function get_course_price(int $courseid): array {
        ...
        $priceconfig = get_config('local_airpay_catalog', 'course_price_' . $courseid);
    ...
    public static function set_course_price(int $courseid, float $price): void {
        set_config('course_price_' . $courseid, $price, 'local_airpay_catalog');
    }
    ...
    public static function get_homepage_courses(int $limit = 6): array {
        ...
        $featured_ids = get_config('local_airpay_catalog', 'homepage_featured_courses');
