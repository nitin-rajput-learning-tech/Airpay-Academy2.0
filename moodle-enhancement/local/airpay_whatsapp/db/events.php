...
/**
 * Event observer registrations for local_airpay_whatsapp.
 *
...
$observers = [
    ...
    [
        ...
        'callback'  => '\\local_airpay_whatsapp\\observer::course_updated',
        'priority'  => 0,
        'internal'  => false,
    ],
    ...
    [
        ...
        'callback'  => '\\local_airpay_whatsapp\\observer::certificate_issued',
        'priority'  => 0,
        'internal'  => false,
    ],
    ...
    [
        ...
        'callback'  => '\\local_airpay_whatsapp\\observer::course_completed',
        'priority'  => 0,
        'internal'  => false,
    ],
];
