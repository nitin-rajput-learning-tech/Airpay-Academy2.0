 ...
 *     - send_template() logs to local_airpay_send_log with status=mocked
...
class whatsapp_client {
     ...
     *   int    $log_id   ID of the local_airpay_send_log row
    ...
    public static function send_template(
        ...
        $api_key = get_config('local_airpay_whatsapp', 'karix_api_key');
