...
/**
 * Event observers for local_airpay_whatsapp — Stream F / Wave E2 P4 (2026-05-25).
 *
...
class observer {
    ...
    public static function course_updated(\core\event\course_updated $event): void {
        ...
        try {
            ...
            debugging('[airpay_whatsapp] course_updated observer failed: '
    ...
    public static function certificate_issued(\core\event\base $event): void {
        try {
            ...
            debugging('[airpay_whatsapp] certificate_issued observer failed: '
                . $e->getMessage(), DEBUG_DEVELOPER);
        }
    }
    ...
    public static function course_completed(\core\event\course_completed $event): void {
        ...
        try {
            ...
            debugging('[airpay_whatsapp] course_completed observer failed: '
                . $e->getMessage(), DEBUG_DEVELOPER);
        }
    }
    ...
    private static function active_enrolled_user_ids(int $courseid, int $cap): array {
        ...
        if (count($rows) > $cap) {
            debugging('[airpay_whatsapp] course_updated observer truncated: '
    ...
    private static function read_announced(): array {
        $raw = (string) (get_config('local_airpay_whatsapp',
