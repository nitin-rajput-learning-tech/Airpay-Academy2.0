...
/**
 * @covers \local_airpay_whatsapp\channel_router
 * @covers \local_airpay_whatsapp\whatsapp_client
 * @covers \local_airpay_whatsapp\sms_client
 *
...
class channel_router_test extends \advanced_testcase {
    ...
    public function test_whatsapp_client_logs_mock_when_flag_off(): void {
        ...
        $row = $DB->get_record('local_airpay_send_log', ['id' => $result['log_id']]);
    ...
    public function test_whatsapp_fails_when_no_mobile_on_file(): void {
        ...
        global $DB;
        $DB->set_field('local_airpay_user_channel_prefs', 'mobile_number', '',
            ['userid' => $user->id]);
