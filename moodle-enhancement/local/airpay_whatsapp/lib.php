...
/**
 * Library callbacks for local_airpay_whatsapp.
 *
 ...
 */
function local_airpay_whatsapp_myprofile_navigation(
    ...
    $url = new moodle_url('/local/airpay_whatsapp/preferences.php');
    $node = new \core_user\output\myprofile\node(
        'contact',                                  // category
        'airpay_whatsapp_prefs',                    // name
        get_string('preferences_nav', 'local_airpay_whatsapp'),
        null,
        $url
    );
    $tree->add_node($node);
