...
// @module     local_sentientia_manager/manager_actions
...
const openDecideForm = (requestid, decision, returnFocus) => {
    ...
    const modalForm = new ModalForm({
        formClass: 'local_sentientia_manager\\form\\decide_request_dynamic_form',
...
const openCreateAllocationForm = (returnFocus) => {
    const modalForm = new ModalForm({
        formClass: 'local_sentientia_manager\\form\\create_allocation_dynamic_form',
        args: {},
...
const openBulkAllocateForm = (returnFocus) => {
    const modalForm = new ModalForm({
        formClass: 'local_sentientia_manager\\form\\bulk_allocate_dynamic_form',
        args: {},
...
const confirmDeleteAllocation = (allocid, name, returnFocus) => {
    Notification.deleteCancelPromise(
        ...
        Ajax.call([{
            methodname: 'local_sentientia_manager_delete_allocation',
            args: {id: allocid},
        }])[0].then(() => {
            Notification.addNotification({
