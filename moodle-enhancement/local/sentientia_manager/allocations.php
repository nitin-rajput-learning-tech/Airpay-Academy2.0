...
$PAGE->set_url('/local/sentientia_manager/allocations.php');
...
$data = [
    ...
    'requests_url'    => (new moodle_url('/local/sentientia_manager/requests.php'))->out(false),
    'exporturl'       => (new moodle_url('/local/sentientia_manager/exportcsv.php',
