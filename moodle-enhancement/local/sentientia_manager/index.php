...
$PAGE->set_url('/local/sentientia_manager/index.php');
...
$team = \local_sentientia_manager\team_manager::get_team($viewuserid);
$summary = \local_sentientia_manager\team_manager::summarize_team($team);
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_sentientia_manager/dashboard', $data);
echo $OUTPUT->footer();
