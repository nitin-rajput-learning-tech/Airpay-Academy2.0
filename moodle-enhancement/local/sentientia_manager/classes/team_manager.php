...
class team_manager {
     ...
     * (Goal A audit): require_capability('local/sentientia_manager:view')
     ...
     *   2. Anyone with local/sentientia_manager:view capability.
    ...
    public static function can_manage(int $viewerid = 0): bool {
        ...
        if (has_capability('local/sentientia_manager:view',
     ...
     * for `require_capability('local/sentientia_manager:view', ...)`.
