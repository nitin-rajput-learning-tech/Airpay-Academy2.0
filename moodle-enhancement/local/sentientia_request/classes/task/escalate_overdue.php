...
namespace local_sentientia_request\task;
...
class escalate_overdue extends \core\task\scheduled_task {
    ...
    public function execute() {
        ...
        $expired   = \local_sentientia_request\request_manager::auto_expire();
        mtrace("sentientia_request: escalated=$escalated expired=$expired");
    }
}
