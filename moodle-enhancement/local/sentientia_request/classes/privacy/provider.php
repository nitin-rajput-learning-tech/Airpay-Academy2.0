...
namespace local_sentientia_request\privacy;
...
class provider implements
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        $exists = $DB->record_exists_select('local_sentientia_request',
    ...
    public static function get_users_in_context(userlist $userlist): void {
        ...
        $ids = $DB->get_fieldset_sql(
            "SELECT DISTINCT userid FROM {local_sentientia_request}
              UNION SELECT DISTINCT approver_userid FROM {local_sentientia_request}
                  WHERE approver_userid IS NOT NULL
              UNION SELECT DISTINCT decided_by_userid FROM {local_sentientia_request}
