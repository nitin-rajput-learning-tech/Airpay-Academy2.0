...
use local_airpay_core\customer;
...
expect(str_contains($brand['icon_192_url'], '/local/airpay_core/pix/customer/1/icon-192.png'),
    'icon_192_url path correct');
expect(str_contains($brand['icon_512_url'], '/local/airpay_core/pix/customer/1/icon-512.png'),
...
// Restore
$DB->set_field('local_airpay_customer_brand', 'short_name', 'Academy',
    ['customerid' => 1]);
customer::invalidate_branding_cache(1);
