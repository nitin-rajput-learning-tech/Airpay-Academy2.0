 ...
 *   php local/airpay_core/cli/classify_existing_users.php > /tmp/classification.csv
 *
 *   # Actually write the rows (requires --commit):
 *   php local/airpay_core/cli/classify_existing_users.php --commit
 *
 *   # Re-classify (drop existing rows + re-write — DESTRUCTIVE,
 *   # requires --confirm too):
 *   php local/airpay_core/cli/classify_existing_users.php --commit --reclassify --confirm
 *
