 ...
 *   php local/airpay_core/cli/find_orphan_files.php
 *
 *   # Report a specific area:
 *   php local/airpay_core/cli/find_orphan_files.php --area=coursebannerimage
 *
 *   # Limit sample size (default: 500 most-recent file hashes):
 *   php local/airpay_core/cli/find_orphan_files.php --limit=2000
 *
 *   # Output as CSV for further triage:
 *   php local/airpay_core/cli/find_orphan_files.php --csv > orphans.csv
 *
 *   # Delete the orphan rows ([CONFIRM] gate per CLAUDE.md §3):
 *   php local/airpay_core/cli/find_orphan_files.php --delete --confirm
 *
 * Notes:
