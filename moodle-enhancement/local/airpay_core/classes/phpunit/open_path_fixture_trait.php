...
namespace local_airpay_core\phpunit;
 ...
 *         use \local_airpay_core\tests\fixtures\open_path_fixture_trait;
 *
 ...
 * `\local_airpay_core\tests\fixtures\open_path_fixture_trait` callers).
 *
