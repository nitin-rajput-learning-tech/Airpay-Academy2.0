...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_database_table('local_sentientia_email_log',
            [
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        if ($DB->get_manager()->table_exists('local_sentientia_email_log')
            && $DB->record_exists('local_sentientia_email_log', ['userid' => $userid])) {
            $hit = true;
        }
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        if ($DB->get_manager()->table_exists('local_sentientia_email_log')) {
            $payload['log'] = array_values(
                (array) $DB->get_records('local_sentientia_email_log',
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        if ($DB->get_manager()->table_exists('local_sentientia_email_log')) {
            $DB->delete_records('local_sentientia_email_log');
        }
        if ($DB->get_manager()->table_exists('local_sentientia_email_prefs')) {
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        $uid = $contextlist->get_user()->id;
        if ($DB->get_manager()->table_exists('local_sentientia_email_log')) {
            $DB->delete_records('local_sentientia_email_log', ['userid' => $uid]);
        }
        if ($DB->get_manager()->table_exists('local_sentientia_email_prefs')) {
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        if ($DB->get_manager()->table_exists('local_sentientia_email_log')) {
            $userids = array_merge($userids,
                (array) $DB->get_fieldset_select('local_sentientia_email_log',
    ...
    public static function delete_data_for_users(
        ...
        if ($DB->get_manager()->table_exists('local_sentientia_email_log')) {
            $DB->delete_records_select('local_sentientia_email_log',
