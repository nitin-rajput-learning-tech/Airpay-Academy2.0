 ...
 *
 * @module local_airpay_evaluation/non_respondents_actions
 */
...
define([
    ...
    function openBulkAssignModal(evaluationid, returnFocus) {
        Str.get_string('bulk_assign_modal_title', 'local_airpay_evaluation')
            .then(function(title) {
                var modalForm = new ModalForm({
                    formClass: 'local_airpay_evaluation\\form\\bulk_assign_audience_form',
                ...
                modalForm.addEventListener(modalForm.events.LOADED, function() {
                    ...
                    if (modalBody) {
                        require(['local_airpay_evaluation/audience_form_helper'],
