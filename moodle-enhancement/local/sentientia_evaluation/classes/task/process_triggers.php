...
class process_triggers extends \core\task\scheduled_task {
    ...
    public function get_name(): string {
        return get_string('task_process_triggers', 'local_sentientia_evaluation');
    }

    public function execute(): void {
        $result = \local_sentientia_evaluation\evaluation_engine::process_due_triggers(500);
        mtrace('local_sentientia_evaluation: '
