...
/**
 * @covers \local_airpay_emails\observer
 *
...
class observer_test extends \advanced_testcase {
    ...
    public function test_mark_reminders_suppressed_on_completion_stamps_sent_rows(): void {
        ...
        $reminders = $DB->get_records('local_airpay_email_log',
        ...
        $completion = $DB->get_record('local_airpay_email_log',
    ...
    public function test_mark_skips_already_suppressed_rows(): void {
        ...
        $r = $DB->get_record('local_airpay_email_log', ['userid' => $u->id]);
