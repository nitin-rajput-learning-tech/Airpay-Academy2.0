...
if ($hassiteconfig) {
    ...
    $settings = new admin_settingpage(
        'local_airpay_emails_settings',
        get_string('pluginname', 'local_airpay_emails') . ' — Settings'
    );

    $settings->add(new admin_setting_heading(
        'local_airpay_emails/ramping_heading',
        get_string('setting_ramping_heading', 'local_airpay_emails'),
        get_string('setting_ramping_desc', 'local_airpay_emails')
    ));
    ...
    $settings->add(new \local_airpay_emails\admin\setting_cadence_json(
        'local_airpay_emails/default_cadence_days_json',
        get_string('setting_default_cadence', 'local_airpay_emails'),
        get_string('setting_default_cadence_help', 'local_airpay_emails'),
        '[1,3,7,14,21]',
        PARAM_TEXT,
        40
    ));
    ...
    $settings->add(new admin_setting_configtext(
        'local_airpay_emails/default_max_reminders',
        get_string('setting_default_cap', 'local_airpay_emails'),
        get_string('setting_default_cap_help', 'local_airpay_emails'),
        '5',
        PARAM_INT
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_airpay_emails/default_auto_stop',
        get_string('setting_default_auto_stop', 'local_airpay_emails'),
        get_string('setting_default_auto_stop_help', 'local_airpay_emails'),
        1
    ));

    // Section separator for the certificate-attachment settings.
    $settings->add(new admin_setting_heading(
        'local_airpay_emails/cert_heading',
        get_string('setting_cert_heading', 'local_airpay_emails'),
        get_string('setting_cert_desc', 'local_airpay_emails')
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_airpay_emails/attach_certificate_pdf',
        get_string('setting_attach_cert', 'local_airpay_emails'),
        get_string('setting_attach_cert_help', 'local_airpay_emails'),
        1
    ));
