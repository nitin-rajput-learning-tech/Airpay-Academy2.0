 ...
 * - Save/revert actions
 *
 * @module local_airpay_emails/template_editor
    ...
    var Editor = {
        ...
        loadTemplate: function(templateKey) {
            ...
            var promises = Ajax.call([{
                methodname: 'local_airpay_emails_get_template',
        ...
        saveTemplate: function() {
            ...
            var promises = Ajax.call([{
                methodname: 'local_airpay_emails_save_template',
                args: {
        ...
        revertTemplate: function() {
            ...
            var promises = Ajax.call([{
                methodname: 'local_airpay_emails_revert_template',
                args: {
                    templatekey: self.currentTemplate,
                    tenantid: self.currentTenant
                }
        ...
        _updatePreview: function() {
            ...
            var promises = Ajax.call([{
                methodname: 'local_airpay_emails_preview_template',
                args: {
                    templatekey: self.currentTemplate,
                    tenantid: self.currentTenant,
                    bodyhtml: bodyHtml,
