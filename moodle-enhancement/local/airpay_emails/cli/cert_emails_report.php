 ...
 * to `local_airpay_email_log` in the Sprint B schema migration.
 *
 * USAGE
 *   php local/airpay_emails/cli/cert_emails_report.php
 *     -- default: report from start-of-today, all tenants, summary table
 *
 *   php local/airpay_emails/cli/cert_emails_report.php --since=2026-05-01
 *     -- report since the given ISO date
 *
 *   php local/airpay_emails/cli/cert_emails_report.php --tenant=77
 *     -- restrict to a specific tenant root (1=Airpay, 77=Public, 177=ZEEA)
 *
 *   php local/airpay_emails/cli/cert_emails_report.php --status=failed
 *     -- only show failed sends — useful when diagnosing email outage
 *
 *   php local/airpay_emails/cli/cert_emails_report.php --detail
 *     -- per-row listing instead of aggregate summary
 *
 *   php local/airpay_emails/cli/cert_emails_report.php --csv
