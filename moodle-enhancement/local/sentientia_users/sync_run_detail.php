...
$PAGE->set_url(new moodle_url('/local/sentientia_users/sync_run_detail.php',
    ['id' => $run_id]));
$PAGE->set_pagelayout('standard');
$PAGE->set_title(get_string('hrms_run_detail_title', 'local_sentientia_users', $run_id));
$PAGE->set_heading(get_string('hrms_run_detail_heading', 'local_sentientia_users', $run_id));
...
if (empty($errors)) {
    ...
    $table->head = [
        get_string('hrms_col_line',     'local_sentientia_users'),
        get_string('hrms_col_severity', 'local_sentientia_users'),
        get_string('hrms_col_email',    'local_sentientia_users'),
        get_string('hrms_col_empcode',  'local_sentientia_users'),
        get_string('hrms_col_username', 'local_sentientia_users'),
        get_string('hrms_col_name',     'local_sentientia_users'),
        get_string('hrms_col_message',  'local_sentientia_users'),
        get_string('hrms_col_missing',  'local_sentientia_users'),
    ];
