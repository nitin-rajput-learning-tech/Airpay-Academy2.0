...
class list_users extends external_api {
    ...
    public static function execute(string $search = '', string $sort = 'lastname', string $sortdir = 'asc',
        ...
        $can_edit   = has_capability('local/sentientia_users:edit', $context);
        $can_delete = has_capability('local/sentientia_users:delete', $context);
        ...
        if (strlen($params['filters']) > 4096) {
            throw new \moodle_exception('filterstoolong', 'local_sentientia_users');
        }
        ...
        foreach ($records as $u) {
            ...
            $profileurl = (new \moodle_url('/local/sentientia_users/profile.php', ['id' => $u->id]))->out(false);
