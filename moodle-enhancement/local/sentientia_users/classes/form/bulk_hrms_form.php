...
class bulk_hrms_form extends \moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('filepicker', 'csvfile',
            get_string('hrms_csvfile', 'local_sentientia_users'),
            null, [
                'accepted_types' => ['.csv'],
                'maxfiles'       => 1,
            ]);
        ...
        $mandatory = implode(', ', \local_sentientia_users\hrms_importer::MANDATORY_COLUMNS);
        $standard  = implode(', ', \local_sentientia_users\hrms_importer::STANDARD_COLUMNS);
        ...
        $this->add_action_buttons(true,
            get_string('hrms_runimport', 'local_sentientia_users'));
    }
