...
$PAGE->set_url(new moodle_url('/local/sentientia_users/help.php'));
...
$links = [
    ...
    [
        ...
        'url'   => (new moodle_url('/local/sentientia_users/profile.php'))->out(false),
    ],
    [
        'icon' => 'fa-bell',
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_sentientia_users/help', $data);
echo $OUTPUT->footer();
