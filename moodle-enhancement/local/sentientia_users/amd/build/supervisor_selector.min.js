 ...
 * form. Calls `local_airpay_users_search_supervisors` instead of the
 ...
 *
 * @module local_airpay_users/supervisor_selector
 */
    ...
    return {
        ...
        transport: function(selector, query, success, failure) {
            ...
            var promise = Ajax.call([{
                methodname: 'local_airpay_users_search_supervisors',
                args: {
                    query: query,
