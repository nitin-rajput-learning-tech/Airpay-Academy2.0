...
$profilecontext = \local_sentientia_users\user_manager::build_profile_context($id);
...
if (!empty($profilecontext)) {
    echo $OUTPUT->render_from_template('local_sentientia_users/profile', $profilecontext);
