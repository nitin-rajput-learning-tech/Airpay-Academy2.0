...
//
// P1 #57 (2026-05-20) — Hindi (hi) translations for local_airpay_cart.
...
// Capabilities.
$string['airpay_cart:view']         = 'अपना कार्ट देखें';
$string['airpay_cart:purchase']     = 'कार्ट में आइटम जोड़ें और खरीदें';
$string['airpay_cart:viewallorders'] = 'सभी ऑर्डर देखें (एडमिन)';
$string['airpay_cart:refund']       = 'रिफ़ंड प्रोसेस करें';
$string['airpay_cart:manageprices'] = 'कोर्स मूल्य निर्धारण प्रबंधित करें';
...
$string['privacy:metadata:local_airpay_cart_history']             = 'कार्ट और ऑर्डर इतिहास';
$string['privacy:metadata:local_airpay_cart_history:userid']      = 'ऑर्डर देने वाला यूज़र';
$string['privacy:metadata:local_airpay_cart_history:items']       = 'खरीद के समय कोर्स ID और मूल्य';
$string['privacy:metadata:local_airpay_cart_history:totalamount'] = 'ऑर्डर कुल';
$string['privacy:metadata:local_airpay_cart_history:status']      = 'ऑर्डर स्थिति';
$string['privacy:metadata:local_airpay_cart_history:timecreated'] = 'ऑर्डर कब दिया गया';

// Privacy — invoices.
$string['privacy:metadata:local_airpay_cart_invoices']                 = 'जारी किए गए इनवॉइस';
$string['privacy:metadata:local_airpay_cart_invoices:userid']          = 'जिस यूज़र को इनवॉइस जारी किया गया';
$string['privacy:metadata:local_airpay_cart_invoices:billing_name']    = 'इनवॉइस पर बिलिंग नाम';
$string['privacy:metadata:local_airpay_cart_invoices:billing_email']   = 'इनवॉइस पर बिलिंग ईमेल';
$string['privacy:metadata:local_airpay_cart_invoices:billing_phone']   = 'इनवॉइस पर बिलिंग फ़ोन';
$string['privacy:metadata:local_airpay_cart_invoices:billing_address'] = 'इनवॉइस पर बिलिंग पता';
$string['privacy:metadata:local_airpay_cart_invoices:billing_gstn']    = 'यदि प्रदान किया गया तो ग्राहक GSTN';

// Privacy — ledger + gateway sub-provider.
$string['privacy:metadata:local_airpay_cart_ledger'] = 'भुगतान खाता-बही (अपरिवर्तनीय ऑडिट लॉग)';
