...
$PAGE->set_url(new moodle_url('/local/airpay_cart/admin_orders.php'));
$PAGE->set_pagelayout('admin');
$PAGE->set_title(get_string('allorders', 'local_airpay_cart'));
$PAGE->set_heading(get_string('allorders', 'local_airpay_cart'));
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_airpay_cart/admin_orders', $data);
echo $OUTPUT->footer();
