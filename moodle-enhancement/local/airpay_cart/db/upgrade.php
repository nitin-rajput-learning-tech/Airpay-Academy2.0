...
/**
 * Schema upgrades for local_airpay_cart.
 *
...
function xmldb_local_airpay_cart_upgrade(int $oldversion): bool {
    global $DB;

    // ── 2026051201 — Phase 8.1 security remediation ──────────────────
    //
    // Phase 8.1 / B9 changed `local/airpay_cart:manageprices` from
