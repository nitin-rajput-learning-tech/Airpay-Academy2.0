...
class tenant_manager {
    ...
    public static function get_public_tenant_id(): int {
        ...
        $configured = get_config('local_airpay_org', 'public_tenant_id');
        if (!empty($configured)) {
    ...
    /**
     * Determine which org table to use (prefers airpay_org, falls back to costcenter).
     *
