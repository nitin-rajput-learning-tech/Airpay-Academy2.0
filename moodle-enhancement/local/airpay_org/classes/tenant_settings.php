 ...
 *
 * Use this instead of poking columns of local_airpay_org directly.
 *
...
class tenant_settings {
    ...
    public static function for_tenant(int $tenantid): \stdClass {
        ...
        global $DB;
        $row = $DB->get_record('local_airpay_org', ['id' => $tenantid]);
        if (!$row) {
            return self::defaults();
        }
