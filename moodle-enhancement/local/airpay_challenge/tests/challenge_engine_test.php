...
final class challenge_engine_test extends \advanced_testcase {
    ...
    public function test_reevaluate_user_picks_up_new_completion(): void {
        ...
        $this->assertSame(0, (int) $DB->get_field(
            'local_airpay_challenge_attempts', 'progress', ['id' => $aid]));
        ...
        $this->assertSame('in_progress', $DB->get_field(
            'local_airpay_challenge_attempts', 'status', ['id' => $aid]));
    ...
    public function test_completed_attempt_is_terminal_skips_reevaluation(): void {
        ...
        $after = $DB->get_record('local_airpay_challenge_attempts',
            ['id' => $aid], '*', MUST_EXIST);
    ...
    public function test_delete_cascades_to_attempts_and_leaderboard(): void {
        ...
        $this->assertFalse($DB->record_exists('local_airpay_challenge_challenges', ['id' => $cid]));
        $this->assertFalse($DB->record_exists('local_airpay_challenge_attempts', ['challengeid' => $cid]));
        $this->assertFalse($DB->record_exists('local_airpay_challenge_leaderboard', ['challengeid' => $cid]));
    }
