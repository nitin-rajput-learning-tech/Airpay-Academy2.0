...
function xmldb_local_airpay_challenge_upgrade(int $oldversion): bool {
    global $DB;
    ...
    if ($oldversion < 2026050700) {
        ...
        $tbl = new xmldb_table('local_airpay_challenge_challenges');
        ...
        $tbl = new xmldb_table('local_airpay_challenge_attempts');
        if (!$dbman->table_exists($tbl)) {
            $tbl->add_field('id',             XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE);
            ...
            $tbl->add_key('fk_challenge', XMLDB_KEY_FOREIGN, ['challengeid'],
                'local_airpay_challenge_challenges', ['id']);
        ...
        $tbl = new xmldb_table('local_airpay_challenge_leaderboard');
        if (!$dbman->table_exists($tbl)) {
            $tbl->add_field('id',                XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE);
            $tbl->add_field('challengeid',       XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '0');
            $tbl->add_field('userid',            XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '0');
        ...
        upgrade_plugin_savepoint(true, 2026050700, 'local', 'airpay_challenge');
    }
