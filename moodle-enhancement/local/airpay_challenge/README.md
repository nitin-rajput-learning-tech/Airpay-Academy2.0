...
- `local_airpay_challenge_challenges` — challenge definitions.
- `local_airpay_challenge_attempts` — per-user progress.
- `local_airpay_challenge_leaderboard` — ranking snapshot.
...
```powershell
# Visit /local/airpay_challenge/index.php as a participant
