...
$PAGE->set_url(new moodle_url('/local/sentientia_catalog/index.php'));
$PAGE->set_context(context_system::instance());
$PAGE->set_title(get_string('catalog', 'local_sentientia_catalog'));
...
$manager = \local_sentientia_catalog\catalog_manager::class;
...
$data = [
    ...
    // URLs.
    'baseurl'           => (new moodle_url('/local/sentientia_catalog/index.php'))->out(false),
...
$data['sort_options'] = [
    [
        ...
        'label'     => get_string('newest',  'local_sentientia_catalog'),
        'is_active' => ($sort === 'newest'),
    ],
    [
        'url'       => $data['baseurl'] . '?sort=popular' . $sort_qs_extra,
        'label'     => get_string('popular', 'local_sentientia_catalog'),
        'is_active' => ($sort === 'popular'),
    ],
    [
        'url'       => $data['baseurl'] . '?sort=name' . $sort_qs_extra,
        'label'     => get_string('atoz',    'local_sentientia_catalog'),
        'is_active' => ($sort === 'name'),
    ],
];
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_sentientia_catalog/catalog', $data);
echo $OUTPUT->footer();
