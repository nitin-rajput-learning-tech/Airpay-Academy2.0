...
// available.
//
// Run: php public/local/airpay_users/cli/smoke_grades_widget.php
//
...
$res = \local_airpay_users\user_manager::get_grades_summary($userid);
...
$res = \local_airpay_users\user_manager::get_grades_summary($userid, 6);
