...
$PAGE->set_url(new moodle_url('/local/airpay_users/bulk_import.php'));
...
class local_airpay_users_bulkimport_form extends moodleform {
...
$form = new local_airpay_users_bulkimport_form();
$summary = null;
...
if ($data = $form->get_data()) {
    ...
    if ($content === false || $content === '') {
        ...
        try {
            $summary = \local_airpay_users\bulk_import_processor::process(
...
if ($summary) {
    ...
    echo $OUTPUT->render_from_template(
        'local_airpay_users/bulk_import_summary', $context_data);
}
