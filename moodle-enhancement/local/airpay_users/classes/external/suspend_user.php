...
/**
 * Web service: suspend or activate a user.
 *
...
class suspend_user extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'suspended' => new external_value(PARAM_BOOL, 'true=suspend, false=activate'),
        ]);
    }
    ...
    public static function execute(int $userid, bool $suspended): array {
        ...
        $newstate = \local_airpay_users\user_manager::suspend(
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'userid'    => new external_value(PARAM_INT, 'User ID'),
            'suspended' => new external_value(PARAM_BOOL, 'New suspended state'),
        ]);
    }
}
