...
// Brings airpay_users to full Hindi parity.

// Capabilities.
$string['airpay_users:edit']             = 'यूज़र संपादित करें';
$string['airpay_users:view']             = 'यूज़र प्रोफ़ाइल देखें';
$string['airpay_users:bulkstatuschange'] = 'थोक स्थिति परिवर्तन';
...
$string['activeregistration_help'] = 'सक्षम होने पर, यूज़र्स /local/airpay_users/signup.php पर साइन अप कर सकते हैं। नए अकाउंट डिफ़ॉल्ट रूप से Public टेनेंट में जाते हैं (नीचे कॉन्फ़िगर करने योग्य)।';
