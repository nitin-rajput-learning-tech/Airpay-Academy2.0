...
$PAGE->set_url(new moodle_url('/local/sentientia_skills/level_definitions.php',
    ['skillid' => $skillid]));
...
$levels = \local_sentientia_skills\skills_manager::get_skill_levels($skillid);
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_sentientia_skills/level_definitions', $data);
