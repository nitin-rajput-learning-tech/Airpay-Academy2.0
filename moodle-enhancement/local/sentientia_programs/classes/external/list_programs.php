...
class list_programs extends external_api {
    ...
    public static function execute(string $search = '', string $sort = 'name', string $sortdir = 'asc',
        ...
        if (strlen($params['filters']) > 4096) throw new \moodle_exception('filterstoolong', 'local_sentientia_programs');
        ...
        $total = (int) $DB->count_records_sql(
            "SELECT COUNT(*) FROM {local_sentientia_programs} p WHERE $wheresql", $sqlparams);
        ...
        foreach ($records as $p) {
            $viewurl = (new \moodle_url('/local/sentientia_programs/view.php',
