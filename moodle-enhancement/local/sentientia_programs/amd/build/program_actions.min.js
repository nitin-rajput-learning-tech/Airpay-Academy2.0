...
define('local_airpay_programs/program_actions', [
    ...
    var openProgramForm = function(programid, returnFocus) {
        ...
        return getString(titleKey, 'local_airpay_programs').then(function(title) {
    ...
    var openEnrolUsersForm = function(programid, returnFocus) {
        return getString('enrol_users', 'local_airpay_programs').then(function(title) {
            var modalForm = new ModalForm({
    ...
    var openBulkEnrolAudienceForm = function(programid, returnFocus) {
        return getString('audience_modal_title', 'local_airpay_programs').then(function(title) {
            var modalForm = new ModalForm({
            ...
            modalForm.addEventListener(modalForm.events.LOADED, function() {
                ...
                if (modalBody) {
                    // Was: const helper = await import('local_airpay_programs/audience_form_helper');
                    // Replaced with AMD require() because dynamic import() isn't
                    // supported in the AMD-bundled context.
                    require(['local_airpay_programs/audience_form_helper'], function(helper) {
    ...
    var openAssignCoursesForm = function(levelid, returnFocus) {
        return getString('add_courses', 'local_airpay_programs').then(function(title) {
            var modalForm = new ModalForm({
    ...
    var confirmUnassignCourse = function(levelid, courseid, name, returnFocus) {
        return Promise.all([
            getString('add_courses', 'local_airpay_programs'),
