...
$string['quiz_help']      = 'इसे एंटरप्राइज़ परीक्षा के रूप में पंजीकृत करने के लिए एक मौजूदा Moodle क्विज़ गतिविधि चुनें। केवल वही क्विज़ दिखाए जाते हैं जो पहले पंजीकृत नहीं हैं। पहले क्विज़ को उसके कोर्स में बनाएँ (गतिविधि जोड़ें > क्विज़), फिर इसे यहाँ पंजीकृत करें।';
...
$string['confirmdelete']          = 'परीक्षा "{$a}" अपंजीकृत करें? अंतर्निहित Moodle क्विज़ को हटाया नहीं जाएगा — यह अपने कोर्स में बना रहेगा। केवल एंटरप्राइज़ परीक्षा मेटाडेटा (टेनेंट, प्रदर्शन नाम, स्थिति) हटाया जाएगा।';
...
// Index page.
$string['noexams_subtitle'] = 'टेनेंट स्कोपिंग, कस्टम उत्तीर्ण ग्रेड और डैशबोर्ड रिपोर्टिंग जोड़ने के लिए मौजूदा Moodle क्विज़ को एंटरप्राइज़ परीक्षाओं के रूप में पंजीकृत करें।';
