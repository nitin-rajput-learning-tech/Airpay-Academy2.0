...
class dlt_template_registry {
    ...
    public static function get(string $template_key, string $channel,
        ...
        global $DB;
        $row = $DB->get_record('local_sentientia_dlt_templates', [
    ...
    public static function upsert(array $values): int {
        ...
        $existing = $DB->get_record('local_sentientia_dlt_templates', [
        ...
        if ($existing) {
            ...
            $DB->update_record('local_sentientia_dlt_templates', $existing);
        ...
        return (int) $DB->insert_record('local_sentientia_dlt_templates', $row);
    }
    ...
    public static function transition_status(int $id, string $new_status,
        ...
        $row = $DB->get_record('local_sentientia_dlt_templates', ['id' => $id],
            '*', MUST_EXIST);
        ...
        $DB->update_record('local_sentientia_dlt_templates', $row);
    }
    ...
    public static function list_all(?string $channel = null,
        ...
        $sql = "SELECT * FROM {local_sentientia_dlt_templates}";
        if (!empty($where)) {
