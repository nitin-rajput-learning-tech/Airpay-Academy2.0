...
final class submit_rating_test extends \advanced_testcase {
    ...
    public function test_submit_rating_rejects_zero(): void {
        ...
        rating_manager::submit_rating(42, 'local_airpay_courses', (int) $u->id, 0);
    }
    ...
    public function test_submit_rating_rejects_six(): void {
        ...
        $this->expectException(\moodle_exception::class);
        rating_manager::submit_rating(42, 'local_airpay_courses', (int) $u->id, 6);
    }
    ...
    public function test_submit_rating_rejects_guest_userid(): void {
        ...
        $this->expectException(\moodle_exception::class);
        rating_manager::submit_rating(42, 'local_airpay_courses', 1, 4);  // 1 = guest
    }
    ...
    public function test_submit_rating_rejects_system_userid(): void {
        ...
        $this->expectException(\moodle_exception::class);
        rating_manager::submit_rating(42, 'local_airpay_courses', 0, 4);  // 0 = no user
    }
    ...
    public function test_submit_rating_rejects_invalid_itemid(): void {
        ...
        $this->expectException(\moodle_exception::class);
        rating_manager::submit_rating(0, 'local_airpay_courses', (int) $u->id, 4);
    }
    ...
    public function test_get_average_reflects_all_ratings(): void {
        ...
        rating_manager::submit_rating(42, 'local_airpay_courses', (int) $u1->id, 5);
        rating_manager::submit_rating(42, 'local_airpay_courses', (int) $u2->id, 3);
        rating_manager::submit_rating(42, 'local_airpay_courses', (int) $u3->id, 4);

        $avg = rating_manager::get_average(42, 'local_airpay_courses');
    ...
    public function test_get_user_rating_returns_users_rating(): void {
        $this->resetAfterTest();
        $u = $this->getDataGenerator()->create_user();
        rating_manager::submit_rating(42, 'local_airpay_courses', (int) $u->id, 4);

        $this->assertSame(4,
            rating_manager::get_user_rating(42, 'local_airpay_courses', (int) $u->id));
    }
