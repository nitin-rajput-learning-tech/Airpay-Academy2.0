 ...
 * Sibling of the airpay_learningpath + airpay_classroom helpers.
 *
 * @module local_airpay_programs/audience_form_helper
 */
...
define(['core/ajax', 'core/notification'], function(Ajax, Notification) {
    ...
    function refreshPreview(root) {
        ...
        Ajax.call([{
            methodname: 'local_airpay_programs_preview_audience',
