...
$PAGE->set_url(new moodle_url('/local/airpay_proctoring/review.php'));
$PAGE->set_pagelayout('admin');
$PAGE->set_title(get_string('reviewqueue', 'local_airpay_proctoring'));
$PAGE->set_heading(get_string('reviewqueue', 'local_airpay_proctoring'));
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_airpay_proctoring/review_queue',
