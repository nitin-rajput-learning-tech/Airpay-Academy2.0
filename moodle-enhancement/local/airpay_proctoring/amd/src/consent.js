 ...
 *
 * @module local_airpay_proctoring/consent
 */
...
export const open = async (quizid) => {
    ...
    const r = await Ajax.call([{
        methodname: 'local_airpay_proctoring_start_session',
        args: { quizid: QUIZ_ID }
...
const renderConsentStep = () => {
    ...
    document.getElementById('consent_proceed').onclick = async () => {
        await Ajax.call([{
            methodname: 'local_airpay_proctoring_give_consent',
...
const renderIdentityStep = () => {
    ...
    document.getElementById('id_submit').onclick = async () => {
        ...
        const r = await Ajax.call([{
            methodname: 'local_airpay_proctoring_submit_identity',
        ...
        if (r.passed) {
            ...
            setTimeout(() => {
                ...
                require(['local_airpay_proctoring/proctor'], (P) => P.start(SESSION_ID));
