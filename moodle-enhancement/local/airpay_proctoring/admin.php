...
$PAGE->set_url(new moodle_url('/local/airpay_proctoring/admin.php'));
$PAGE->set_pagelayout('admin');
$PAGE->set_title(get_string('adminhome', 'local_airpay_proctoring'));
$PAGE->set_heading(get_string('adminhome', 'local_airpay_proctoring'));
...
$data = [
    ...
    'review_queue_url' => has_capability('local/airpay_proctoring:review', $ctx)
        ? (new moodle_url('/local/airpay_proctoring/review.php'))->out(false) : '',
    'has_review_cap'  => has_capability('local/airpay_proctoring:review', $ctx),
];

echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_airpay_proctoring/admin_home', $data);
echo $OUTPUT->footer();
