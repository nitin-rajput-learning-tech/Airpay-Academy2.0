...
// Capabilities.
$string['airpay_proctoring:attempt']      = 'Attempt a proctored quiz';
$string['airpay_proctoring:viewattempts']  = 'View proctoring attempt details';
$string['airpay_proctoring:review']        = 'Review flagged proctoring sessions';
$string['airpay_proctoring:manage']        = 'Manage proctoring settings + reviewer assignments';
$string['airpay_proctoring:bypass']        = 'Bypass proctoring (emergency, audit-logged)';
...
// Privacy.
$string['privacy:metadata:local_airpay_proctor_sessions'] = 'Proctored exam sessions';
$string['privacy:metadata:local_airpay_proctor_identity'] = 'Identity verification scores (photos deleted after match)';
$string['privacy:metadata:local_airpay_proctor_events']   = 'Per-attempt behavioural events';
$string['privacy:metadata:local_airpay_proctor_recordings'] = 'S3 keys for webcam/screen recordings';
$string['privacy:metadata:local_airpay_proctor_reviews']  = 'Human reviewer notes and decisions';
