...
$plugin->component = 'local_sentientia_courses';
...
$plugin->version   = 2026091700;  // Browse Airpay Library: F-12 (format_string'd slots rendered once) + page copy via lang strings (en+hi)
// 2026090800:
$plugin->requires  = 2024100700;
$plugin->maturity  = MATURITY_STABLE;
$plugin->release   = '1.11.5';  // tenant-scoped Manage Courses KPI + category filter
$plugin->dependencies = [
...
//          + local_sentientia_courses_tenant_share table
//          + share_course / unshare_course / list_course_shares WS
//          + local/sentientia_courses:share_to_tenant capability
...
//          + local_sentientia_courses_remind_sent table (idempotency)
...
//          + local_sentientia_courses_requests table (pending/approved/rejected)
//          + request_course / approve_request / reject_request WS
//          + list_pending_requests / list_my_tenant_requests WS
//          + local/sentientia_courses:request_course capability (manager-grantable)
//          + local/sentientia_courses:approve_request capability (siteadmin only)
