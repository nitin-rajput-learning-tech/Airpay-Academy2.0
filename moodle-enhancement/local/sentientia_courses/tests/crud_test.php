...
/**
 * CRUD tests for sentientia_courses (delete + toggle visibility).
 *
 * Locks in:
 ...
 * - external\delete_course requires local/sentientia_courses:delete capability
 * - external\toggle_visibility requires local/sentientia_courses:visibility capability
 *
