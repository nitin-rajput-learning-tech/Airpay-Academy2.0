 ...
 *      course in /local/airpay_courses/browse_airpay.php and clicks
 *      "Request access". The page calls request_manager::create_request.
 *
 *   2. The Airpay Super Admin opens /local/airpay_courses/manage_requests.php,
...
class request_manager {
    ...
    public static function create_request(int $courseid,
        ...
        $existing = $DB->get_record('local_airpay_courses_requests', [
            'courseid'          => $courseid,
        ...
        $now = time();
        $id = (int) $DB->insert_record('local_airpay_courses_requests', (object) [
            'courseid'          => $courseid,
            'requesting_tenant' => $requesting_tenant,
    ...
    public static function approve_request(int $request_id,
        ...
        $req = $DB->get_record('local_airpay_courses_requests',
        ...
        $DB->update_record('local_airpay_courses_requests', $req);
    ...
    public static function list_pending_requests(int $limit = 100): array {
        ...
        $rows = $DB->get_records_sql(
            "SELECT r.id, r.courseid, r.requesting_tenant, r.requester_userid,
               ...
               FROM {local_airpay_courses_requests} r
