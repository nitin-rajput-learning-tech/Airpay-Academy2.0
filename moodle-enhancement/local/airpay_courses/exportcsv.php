...
/**
 * CSV export for the airpay_courses management page.
 *
 ...
 * Mirrors the pattern of local/airpay_users/exportcsv.php.
 *
...
$PAGE->set_url('/local/airpay_courses/exportcsv.php');
...
$filename = 'airpay_courses_' . date('Y-m-d_His') . '.csv';
