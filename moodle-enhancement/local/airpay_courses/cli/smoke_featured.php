...
//
// Run: php public/local/airpay_courses/cli/smoke_featured.php
//
...
$DB->delete_records('local_airpay_featured_courses');
...
$row = $DB->get_record('local_airpay_featured_courses', ['id' => $id1]);
...
$leftover = $DB->count_records('local_airpay_featured_courses');
if ($leftover !== 0) {
