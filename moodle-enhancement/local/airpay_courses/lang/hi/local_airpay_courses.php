...
//
// P1 #35 (2026-05-20) — Hindi (hi) translations for local_airpay_courses.
...
// Capabilities.
$string['airpay_courses:manage']     = 'कोर्स प्रबंधित करें';
$string['airpay_courses:enrol']      = 'यूज़र्स को कोर्स में नामांकित करें';
$string['airpay_courses:view']       = 'कोर्स प्रबंधन देखें';
$string['airpay_courses:create']     = 'कोर्स बनाएँ';
$string['airpay_courses:update']     = 'कोर्स संपादित करें';
$string['airpay_courses:delete']     = 'कोर्स हटाएँ';
$string['airpay_courses:visibility'] = 'कोर्स दिखाएँ या छिपाएँ';
...
// Privacy.
$string['privacy:metadata'] = 'एयरपे airpay_courses प्लगइन अपनी टेबल्स में व्यक्तिगत डेटा संग्रहीत नहीं करता; उपयोगकर्ता स्थिति कोर Sentientia LMS टेबल्स में रहती है जो अपने-अपने प्रदाताओं द्वारा एक्सपोर्ट की जाती हैं।';

// Sprint C — cross-tenant sharing.
$string['airpay_courses:share_to_tenant'] = 'अन्य टेनेंट्स के साथ कोर्स साझा करें';
...
$string['airpay_courses:request_course']       = 'अनुरोध करें कि कोई कोर्स मेरे टेनेंट के साथ साझा किया जाए';
$string['airpay_courses:approve_request']      = 'अन्य टेनेंट्स के शेयर अनुरोधों को मंज़ूर/अस्वीकार करें';
...
$string['reminder_enabled_help']            = 'जब बंद हो (डिफ़ॉल्ट), शेड्यूल्ड टास्क निष्क्रिय रहता है। चालू होने पर, टास्क दैनिक चलता है, समय-सीमा के निकट सीखने वालों को सूचनाएँ भेजता है, और प्रत्येक सेंड को डी-डुप के लिए <code>local_airpay_courses_remind_sent</code> में रिकॉर्ड करता है।';
...
$string['reminder_last_run_never']          = 'समय-सीमा-रिमाइंडर क्रॉन कभी नहीं चला। टास्क सक्षम करें और कल 09:00 सर्वर समय के बाद जाँचें, या इसे मैन्युअल रूप से चलाने के लिए कमांड लाइन से <code>php admin/cli/scheduled_task.php --execute=\\\\local_airpay_courses\\\\task\\\\course_reminder</code> चलाएँ।';
...
$string['overdue_enabled_help']            = 'बंद होने पर (डिफ़ॉल्ट), टास्क निष्क्रिय। चालू होने पर, अतिदेय सीखने वालों को उनके पर्यवेक्षक को एस्केलेट करता है और उसी <code>local_airpay_courses_remind_sent</code> टेबल के विरुद्ध डी-डुप करता है (नकारात्मक <code>days_before_deadline</code> मान पोस्ट-समय-सीमा पंक्तियों को चिह्नित करते हैं)।';
...
$string['overdue_last_run_never']          = 'पर्यवेक्षक-एस्केलेशन क्रॉन कभी नहीं चला। टास्क सक्षम करें या <code>php admin/cli/scheduled_task.php --execute=\\\\local_airpay_courses\\\\task\\\\course_overdue</code> चलाएँ।';
