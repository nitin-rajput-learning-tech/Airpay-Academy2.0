 ...
 *
 * URL pattern: /local/airpay_courses/my_requests.php
 *
...
$rows_raw = \local_airpay_courses\request_manager::list_tenant_requests(
    $viewer_tenant);
...
$PAGE->set_url(new moodle_url('/local/airpay_courses/my_requests.php'));
...
$data = [
    ...
    'browse_url'        => (new moodle_url('/local/airpay_courses/browse_airpay.php'))->out(false),
];

echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_airpay_courses/my_requests', $data);
echo $OUTPUT->footer();
