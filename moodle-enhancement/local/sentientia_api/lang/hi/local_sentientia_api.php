...
// ── SCIM समूह + सत्यापन (ADR-030 वेव C) ────────────────────────────────
$string['scim_events']            = 'प्रोविज़निंग घटनाएँ (सत्यापन)';
$string['scim_events_intro']      = 'पहचान प्रदाता ने SCIM के माध्यम से जो भी खाता बनाया, पुनः सक्रिय किया, निष्क्रिय किया, अद्यतन किया या स्थानांतरित किया - समय और क्लाइंट के साथ; यही वह डी-प्रोविज़निंग साक्ष्य है जो ऑडिटर माँगते हैं।';
$string['scim_events_none']       = 'अभी कोई प्रोविज़निंग घटना नहीं है।';
$string['scim_event_time']        = 'कब (UTC)';
$string['scim_event_action']      = 'क्रिया';
$string['scim_event_client']      = 'क्लाइंट';
$string['scim_event_user']        = 'उपयोगकर्ता';
$string['scim_event_external']    = 'externalId';
$string['scim_event_detail']      = 'विवरण';
$string['scim_export_csv']        = 'सत्यापन CSV डाउनलोड करें';
$string['scim_action_created']     = 'बनाया गया';
$string['scim_action_reactivated'] = 'पुनः सक्रिय किया गया';
$string['scim_action_deactivated'] = 'निष्क्रिय किया गया';
$string['scim_action_updated']     = 'अद्यतन किया गया';
$string['scim_action_moved']       = 'समूह स्थानांतरित';
$string['scim_groups_readonly']    = 'समूह संगठन वृक्ष को प्रतिबिंबित करते हैं और SCIM के माध्यम से बनाए, पुनर्नामित या हटाए नहीं जा सकते; पदानुक्रम को संगठन प्रशासन में प्रबंधित करें। सदस्यता परिवर्तन स्वीकार किए जाते हैं।';
$string['scim_groups_unavailable'] = 'समूह सदस्यता के लिए संगठन-वृक्ष उपयोगकर्ता कॉलम आवश्यक हैं, जो इस साइट में नहीं हैं।';
$string['scim_member_outside_scope'] = 'एक या अधिक सदस्य इस क्लाइंट के टेनेंट में नहीं हैं।';
$string['privacy:metadata:scimevt']             = 'पहचान प्रदाताओं द्वारा SCIM के माध्यम से किए गए खाता परिवर्तनों का सत्यापन लॉग।';
$string['privacy:metadata:scimevt:userid']      = 'प्रभावित उपयोगकर्ता।';
$string['privacy:metadata:scimevt:action']      = 'पहचान प्रदाता ने क्या किया (बनाया, पुनः सक्रिय, निष्क्रिय, अद्यतन, स्थानांतरित)।';
$string['privacy:metadata:scimevt:externalid']  = 'उस समय पहचान प्रदाता का पहचानकर्ता।';
$string['privacy:metadata:scimevt:timecreated'] = 'यह कब हुआ।';
