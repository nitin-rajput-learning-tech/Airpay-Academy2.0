...
// Capabilities.
$string['airpay_reports:view']   = 'View saved reports';
$string['airpay_reports:manage'] = 'Manage saved reports';
$string['airpay_reports:export'] = 'Export saved reports to CSV';
