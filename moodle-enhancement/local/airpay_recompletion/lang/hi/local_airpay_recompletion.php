...
//
// P1 #53 (2026-05-20) — Hindi (hi) translations for local_airpay_recompletion.
...
// Capabilities.
$string['airpay_recompletion:view']   = 'रीकम्प्लीशन नियम और इतिहास देखें';
$string['airpay_recompletion:manage'] = 'रीकम्प्लीशन नियम प्रबंधित करें';
$string['airpay_recompletion:reset']  = 'मैन्युअल रूप से यूज़र पूर्णता रीसेट करें';
...
// Privacy.
$string['privacy:metadata:local_airpay_recompletion_rules']            = 'रीकम्प्लीशन नियम परिभाषाएँ';
$string['privacy:metadata:local_airpay_recompletion_history']          = 'प्रति-यूज़र रीसेट ऑडिट लॉग';
$string['privacy:metadata:local_airpay_recompletion_history:userid']   = 'जिस यूज़र की पूर्णता रीसेट की गई';
$string['privacy:metadata:local_airpay_recompletion_history:courseid'] = 'जो कोर्स रीसेट किया गया';
$string['privacy:metadata:local_airpay_recompletion_history:reason']   = 'रीसेट क्यों ट्रिगर हुआ';
