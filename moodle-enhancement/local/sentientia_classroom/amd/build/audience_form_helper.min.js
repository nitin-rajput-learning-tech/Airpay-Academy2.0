 ...
 * `local_airpay_learningpath/audience_form_helper` — the only difference
 ...
 *   2. Debounced preview via `local_airpay_classroom_preview_audience`
 *
 * @module local_airpay_classroom/audience_form_helper
 */
...
define(['core/ajax', 'core/notification'], function(Ajax, Notification) {
    ...
    function refreshPreview(root) {
        ...
        Ajax.call([{
            methodname: 'local_airpay_classroom_preview_audience',
