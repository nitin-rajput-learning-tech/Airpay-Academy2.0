...
/**
 * P1 #13 (2026-05-16) — wire the bulk-enrol-by-audience modal on the
 * classroom Users tab. Sibling of
 * `local_sentientia_learningpath/audience_form_helper` — the only difference
 * is the preview WS endpoint (classroom-namespaced).
 *
 * Strategy + behaviour match the learningpath helper:
 *   1. Populate filter dropdowns from
 *      `local_sentientia_users_list_filter_options` (the shared W2 #1 WS)
 *   2. Debounced preview via `local_sentientia_classroom_preview_audience`
 *
 * @module local_sentientia_classroom/audience_form_helper
 */
...
define(['core/ajax', 'core/notification'], function(Ajax, Notification) {
    ...
    function refreshPreview(root) {
        ...
        Ajax.call([{
            methodname: 'local_sentientia_classroom_preview_audience',
