...
class unenrol_classroom_user extends external_api {
    ...
    public static function execute(int $classroomid, int $userid): array {
        ...
        // learner from your own classroom reaches into no other tenant.
        \local_sentientia_classroom\session_manager::require_classroom_access($params['classroomid']);
        \local_sentientia_classroom\session_manager::require_unenrol_target(
        ...
        return [
            ...
            'message'     => get_string('userunenrolled', 'local_sentientia_classroom'),
        ];
    }
