...
$plugin->version   = 2026092501;  // locations table + locationid in install.xml; lat/long NUMBER(10,6)
...
$plugin->release   = '1.10.5';  // locations schema parity (1.10.4: ADR-031 tenant scope; 1.10.3: waitlist in install.xml + privacy coverage)
$plugin->dependencies = [
