...
$plugin->version   = 2026092400;  // waitlist table in install.xml + created where missing
// 2026092200: count_classrooms takes a path, not a LIKE pattern
// 2026052001:
$plugin->requires  = 2024100700;
$plugin->maturity  = MATURITY_STABLE;
$plugin->release   = '1.10.3';  // waitlist in install.xml + privacy coverage (1.10.2: P1 #44 Hindi top-up)
$plugin->dependencies = [
