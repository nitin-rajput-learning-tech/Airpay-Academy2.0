...
namespace local_sentientia_recompletion\event;
 ...
 *
 *   $observers = [[
 *     'eventname' => '\\local_sentientia_recompletion\\event\\completion_reset',
 ...
 *                       reason column on `local_sentientia_recompletion_history`).
 *
 ...
 * the affected pair, and use `local_sentientia_recompletion_history` for
...
class completion_reset extends \core\event\base {
    ...
    public function get_url(): \moodle_url {
        ...
        return new \moodle_url(
            '/local/sentientia_recompletion/history.php',
