 ...
 *
 * URL: /local/sentientia_platform/admin/styleguide.php
 *
 * Access: site admin only. Future Phase Δ may open this to anyone with
 * the `local/sentientia_platform:viewstyleguide` capability so brand teams can
...
$PAGE->set_url('/local/sentientia_platform/admin/styleguide.php');
