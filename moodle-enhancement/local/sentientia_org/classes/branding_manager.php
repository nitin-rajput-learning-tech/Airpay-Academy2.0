...
class branding_manager {
    ...
    public static function get_logo_url(int $itemid): string {
        ...
        // Try local_sentientia_org component first.
        $url = self::resolve_logo_file($itemid, 'local_sentientia_org', 'org_logo');
        if (!empty($url)) {
            return $url;
        }
     ...
     *
     * @param int    $itemid
     * @param string $component  e.g. 'local_sentientia_org' or 'local_costcenter'
