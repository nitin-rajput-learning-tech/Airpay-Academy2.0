...
require_capability('local/sentientia_org:view', $context);

$can_manage = is_siteadmin() || has_capability('local/sentientia_org:manage', $context);

$PAGE->set_context($context);
$PAGE->set_url(new moodle_url('/local/sentientia_org/admin.php'));
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_sentientia_org/manage', $data);
echo $OUTPUT->footer();
