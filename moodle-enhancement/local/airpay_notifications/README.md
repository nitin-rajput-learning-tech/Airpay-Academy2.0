# local_airpay_notifications

In-platform notification rule engine. Complements the email dispatcher
(`local_airpay_emails`) — this plugin produces Moodle native messages
...
`local_airpay_notif_log`, `local_airpay_notif_rules`,
`local_airpay_notif_prefs`.
...
```powershell
php "C:/xampp/htdocs/moodle5/public/local/airpay_notifications/cli/smoke_prefs.php"
php "C:/xampp/htdocs/moodle5/public/local/airpay_notifications/cli/smoke_preview_send.php"
```
