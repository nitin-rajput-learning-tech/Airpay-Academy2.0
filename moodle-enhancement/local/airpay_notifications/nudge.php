 ...
 *
 * Usage: /local/airpay_notifications/nudge.php?userid=123&type=compliance
 *
...
$PAGE->set_url('/local/airpay_notifications/nudge.php', ['userid' => $targetid, 'type' => $type]);
...
if ($action === 'send' && confirm_sesskey()) {
    ...
    $message->component = 'local_airpay_notifications';
    ...
    redirect(new moodle_url('/local/airpay_notifications/nudge.php',
...
<div class="ap-nudge" style="max-width:600px; margin:0 auto;">
    ...
    <form action="<?php echo (new moodle_url('/local/airpay_notifications/nudge.php'))->out(false); ?>" method="post">
