...
- `local_airpay_skills` — skill catalogue.
- `local_airpay_skill_cats` — categories grouping skills.
- `local_airpay_skill_levels` — proficiency-level definitions.
- `local_airpay_user_skills` — user-to-skill-level mapping.
- `local_airpay_role_skills` — target-role skill requirements.
- `local_airpay_course_skills` — course-to-skill development mapping.

## Verify after install

```powershell
php "C:/xampp/htdocs/moodle5/public/local/airpay_skills/cli/smoke_course_mapping.php"
php "C:/xampp/htdocs/moodle5/public/local/airpay_skills/cli/smoke_observer.php"
```
