...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_database_table('local_airpay_user_skill_hist', [
    ...
    public static function get_users_in_context(userlist $userlist): void {
        ...
        // until erasure runs).
        $userlist->add_from_sql('userid',
            "SELECT DISTINCT userid FROM {local_airpay_user_skill_hist}", []);
        ...
        $userlist->add_from_sql('changed_by_userid',
            "SELECT DISTINCT changed_by_userid
               FROM {local_airpay_user_skill_hist}
    ...
    public static function export_user_data(approved_contextlist $contextlist): void {
        ...
        $history = $DB->get_records_sql("
            SELECT h.*, s.name AS skill_name
              ...
              JOIN {local_airpay_skills} s ON s.id = h.skillid
             WHERE h.userid = :u
    ...
    public static function delete_data_for_all_users_in_context(\context $context): void {
        ...
        $DB->delete_records('local_airpay_user_skill_hist');
    }

    public static function delete_data_for_user(approved_contextlist $contextlist): void {
        global $DB;
        $uid = $contextlist->get_user()->id;
        $DB->delete_records('local_airpay_user_skills', ['userid' => $uid]);
        ...
        $DB->delete_records('local_airpay_user_skill_hist', ['userid' => $uid]);
        $DB->set_field('local_airpay_user_skill_hist',
    ...
    public static function delete_data_for_users(approved_userlist $userlist): void {
        ...
        $DB->execute("DELETE FROM {local_airpay_user_skill_hist} WHERE userid $insql", $inparams);
        $DB->execute("UPDATE {local_airpay_user_skill_hist}
