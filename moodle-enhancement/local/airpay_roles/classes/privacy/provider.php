...
/**
 * Privacy Subsystem implementation for local_airpay_roles.
 *
 * Stores PII in `local_airpay_roles_auditlog` via two columns:
...
class provider implements
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        $sql = "SELECT DISTINCT contextid
                  FROM {local_airpay_roles_auditlog}
    ...
    public static function get_users_in_context(userlist $userlist): void {
        ...
        $sql = "SELECT changedby AS userid FROM {local_airpay_roles_auditlog}
                 WHERE contextid = :ctx AND changedby > 0
                 UNION
                SELECT targetuserid AS userid FROM {local_airpay_roles_auditlog}
    ...
    public static function export_user_data(approved_contextlist $contextlist): void {
        ...
        [$insql, $inparams] = $DB->get_in_or_equal($contextlist->get_contextids(),
            SQL_PARAMS_NAMED);
        $sql = "SELECT * FROM {local_airpay_roles_auditlog}
    ...
    public static function delete_data_for_all_users_in_context(\context $context): void {
        ...
        $DB->execute("UPDATE {local_airpay_roles_auditlog}
