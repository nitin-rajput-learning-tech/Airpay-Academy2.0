...
class unassign_user extends external_api {
    ...
    public static function execute(int $roleid, int $userid, string $reason = ''): array {
        ...
        require_capability('local/airpay_roles:assign', $context);
        require_sesskey();

        role_manager::unassign_user_from_role(
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'unassigned' => new external_value(PARAM_BOOL, 'Unassigned'),
        ]);
    }
}
