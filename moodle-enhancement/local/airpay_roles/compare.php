...
$PAGE->set_url(new moodle_url('/local/airpay_roles/compare.php'));
$PAGE->set_pagelayout('admin');
$PAGE->set_title('Compare roles');
$PAGE->set_heading('Compare roles');
require_capability('local/airpay_roles:view', $ctx);
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_airpay_roles/compare', [
    ...
    'export_url'    => $compare_data
        ? (new moodle_url('/local/airpay_roles/compare_export.php',
