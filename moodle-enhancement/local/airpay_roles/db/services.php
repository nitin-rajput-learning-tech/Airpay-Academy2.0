...
$functions = [
    ...
    'local_airpay_roles_bulk_update_capability' => [
        'classname'   => 'local_airpay_roles\external\bulk_update_capability',
        'methodname'  => 'execute',
    ...
    'local_airpay_roles_list_assignments' => [
        'classname'   => 'local_airpay_roles\external\list_role_assignments',
        'methodname'  => 'execute',
    ...
    'local_airpay_roles_assign_user' => [
        'classname'   => 'local_airpay_roles\external\assign_user',
        'methodname'  => 'execute',
        'description' => 'Assign a user to a role at system context (audited).',
        'type'        => 'write',
        'capabilities' => 'local/airpay_roles:assign',
        'ajax'        => true,
        'loginrequired' => true,
    ],
    'local_airpay_roles_unassign_user' => [
        'classname'   => 'local_airpay_roles\external\unassign_user',
        'methodname'  => 'execute',
