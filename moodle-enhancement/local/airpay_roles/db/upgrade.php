...
function xmldb_local_airpay_roles_upgrade(int $oldversion): bool {
    global $DB;
    $dbman = $DB->get_manager();

    if ($oldversion < 2026050700) {
        // Initial table — audit log.
        $table = new xmldb_table('local_airpay_roles_auditlog');
        ...
        upgrade_plugin_savepoint(true, 2026050700, 'local', 'airpay_roles');
    }
