...
$is_member = $DB->record_exists('local_airpay_classroom_users', [
    'classroomid' => $session->classroomid, 'userid' => $USER->id,
]);
$can_view = is_siteadmin() || $is_member
    || has_capability('local/airpay_classroom:view', $context);
if (!$can_view) {
...
$ics = \local_airpay_classroom\ics_builder::build_session(
