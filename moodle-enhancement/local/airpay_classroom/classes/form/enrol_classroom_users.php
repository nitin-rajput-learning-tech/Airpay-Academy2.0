 ...
 *
 * Mirrors local_airpay_learningpath\form\enrol_users_form (same UX
...
class enrol_classroom_users extends \core_form\dynamic_form {
    ...
    protected function definition() {
        ...
        $already = [];
        if ($DB->get_manager()->table_exists('local_airpay_classroom_users')) {
            $already = $DB->get_fieldset_select('local_airpay_classroom_users',
        ...
        $mform->addElement('select', 'userids',
            get_string('enrol_users', 'local_airpay_classroom'),
            $options,
    ...
    public function process_dynamic_submission() {
        ...
        $count = \local_airpay_classroom\session_manager::enrol_users($classroomid, $userids);

        return [
            'classroomid' => $classroomid,
            'enrolled'    => $count,
            'message'     => get_string('users_enrolled_success', 'local_airpay_classroom', $count),
        ];
    }
