 ...
 * the classroom Users tab. Mirrors the airpay_learningpath form
 * (P1 #11).
 *
...
class bulk_enrol_audience_form extends \core_form\dynamic_form {
    ...
    protected function definition() {
        ...
        $mform->addElement('static', 'preview', '',
            ...
            . get_string('audience_users_matched', 'local_airpay_classroom')
            . '<div data-airpay-audience-sample class="small text-muted mt-2"></div>'
            . '</div>');

        $this->add_action_buttons(true,
            get_string('audience_enrol_button', 'local_airpay_classroom'));
    }
    ...
    public function process_dynamic_submission() {
        ...
        $result = \local_airpay_classroom\classroom_audience_enroller::enrol_by_filter(
        ...
        return [
            ...
            'message'     => sprintf(
                get_string('audience_enrol_result', 'local_airpay_classroom'),
    ...
    protected function check_access_for_dynamic_submission(): void {
        require_capability('local/airpay_classroom:enrol',
    ...
    private function get_cohort_options(): array {
        global $DB;
        $options = [0 => get_string('audience_any_cohort', 'local_airpay_classroom')];
