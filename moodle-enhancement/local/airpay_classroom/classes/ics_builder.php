...
class ics_builder {
     ...
     *
     * @param object $session   row from local_airpay_classroom_sessions
     * @param object $classroom row from local_airpay_classroom
    ...
    public static function build_session(object $session,
        ...
        $description_lines[] = 'View in Moodle: '
            . $CFG->wwwroot . '/local/airpay_classroom/index.php?id='
            . (int) $classroom->id;
        $description = implode("\\n", $description_lines);
