...
`local_airpay_classroom`, `local_airpay_classroom_sessions`,
`local_airpay_classroom_attendance`, `local_airpay_classroom_users`.
...
```powershell
php "C:/xampp/htdocs/moodle5/public/local/airpay_classroom/cli/smoke_waitlist.php"
php "C:/xampp/htdocs/moodle5/public/local/airpay_classroom/cli/smoke_ics.php"
```
