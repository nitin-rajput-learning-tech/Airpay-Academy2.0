...
$string['reminder_enabled_help']           = 'When OFF (default) the task is a no-op. When ON it fires daily, sends notifications to learners approaching exam timeclose, and dedupes via <code>local_sentientia_exams_remind_sent</code>.';
...
$string['reminder_last_run_never']         = 'The exam-deadline-reminder cron has never run. Enable the task and check back after 09:15 server time, or run <code>php admin/cli/scheduled_task.php --execute=\\\\local_sentientia_exams\\\\task\\\\exam_reminder</code> from the command line to fire it manually.';
...
$string['overdue_last_run_never']          = 'The exam supervisor-escalation cron has never run. Enable it and check back, or run <code>php admin/cli/scheduled_task.php --execute=\\\\local_sentientia_exams\\\\task\\\\exam_overdue</code> manually.';
