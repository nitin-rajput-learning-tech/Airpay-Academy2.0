 ...
 */
define("local_sentientia_roles/role_actions", [
    "core_form/modalform",
    "core/str",
    "core/notification",
    "core/ajax"
    ...
    function openEditCapForm(roleid, capability, current, returnFocus) {
        return getString("form_edit_cap", "local_sentientia_roles").then(function(title) {
            ...
            modalForm.addEventListener(modalForm.events.FORM_SUBMITTED, function() {
                getString("cap_updated_success", "local_sentientia_roles", capability).then(function(msg) {
