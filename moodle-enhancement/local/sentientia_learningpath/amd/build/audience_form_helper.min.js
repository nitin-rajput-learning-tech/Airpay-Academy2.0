 ...
 *   1. Populate filter dropdowns from `local_airpay_users_list_filter_options`
 *   2. On any filter change, call `local_airpay_learningpath_preview_audience`
 *      and render count + 5-name sample in the preview pane
 *
 * Called from path_actions.js right after the modal opens.
 *
 * @module local_airpay_learningpath/audience_form_helper
 */
...
define(['core/ajax', 'core/notification'], function(Ajax, Notification) {
    ...
    function refreshPreview(root) {
        ...
        Ajax.call([{
            methodname: 'local_airpay_learningpath_preview_audience',
