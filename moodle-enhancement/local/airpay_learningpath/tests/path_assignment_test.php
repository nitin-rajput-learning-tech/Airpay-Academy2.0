...
final class path_assignment_test extends \advanced_testcase {
    ...
    public function test_assign_courses_inserts_rows(): void {
        ...
        $this->assertEquals(2, $DB->count_records('local_airpay_learningpath_courses', ['pathid' => $pid]));
    }
    ...
    public function test_assign_courses_idempotent(): void {
        ...
        $this->assertEquals(1, $DB->count_records('local_airpay_learningpath_courses', ['pathid' => $pid]));
    }
    ...
    public function test_assign_courses_appends_to_sortorder(): void {
        ...
        $records = $DB->get_records('local_airpay_learningpath_courses',
    ...
    public function test_unassign_course_returns_true_when_present(): void {
        ...
        $this->assertEquals(0, $DB->count_records('local_airpay_learningpath_courses', ['pathid' => $pid]));
    }
    ...
    public function test_reorder_courses_ignores_non_member_courses(): void {
        ...
        $c2sort = (int) $DB->get_field('local_airpay_learningpath_courses', 'sortorder',
            ['pathid' => $pid, 'courseid' => $c2->id]);
        $c1sort = (int) $DB->get_field('local_airpay_learningpath_courses', 'sortorder',
            ['pathid' => $pid, 'courseid' => $c1->id]);
        $this->assertSame(1, $c2sort);
        $this->assertSame(2, $c1sort);
        // Outsider was not added.
        $this->assertFalse($DB->record_exists('local_airpay_learningpath_courses',
    ...
    public function test_enrol_users_inserts_rows(): void {
        ...
        $this->assertSame(2, $count);
        $this->assertEquals(2, $DB->count_records('local_airpay_learningpath_users', ['pathid' => $pid]));
        // All start at status NEW.
        $statuses = $DB->get_fieldset_select('local_airpay_learningpath_users',
