...
/**
 * Upgrade script for local_airpay_learningpath.
 *
 * @package   local_airpay_learningpath
 * @copyright 2026 Airpay Payment Services
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
function xmldb_local_airpay_learningpath_upgrade(int $oldversion): bool {
    global $DB;
    ...
    if ($oldversion < 2026051600) {
        $table = new xmldb_table('local_airpay_learningpath');
        ...
        upgrade_plugin_savepoint(true, 2026051600, 'local', 'airpay_learningpath');
    }
