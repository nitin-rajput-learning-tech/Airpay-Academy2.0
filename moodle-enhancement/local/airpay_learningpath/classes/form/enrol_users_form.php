...
class enrol_users_form extends \core_form\dynamic_form {
    ...
    protected function definition() {
        ...
        $already = $DB->get_fieldset_select('local_airpay_learningpath_users',
        ...
        $mform->addElement('select', 'userids',
            get_string('enrol_users', 'local_airpay_learningpath'),
            $options,
    ...
    public function process_dynamic_submission() {
        ...
        $count = \local_airpay_learningpath\path_manager::enrol_users($pathid, $userids);
    ...
    protected function check_access_for_dynamic_submission(): void {
        require_capability('local/airpay_learningpath:enrol', $this->get_context_for_dynamic_submission());
    }
