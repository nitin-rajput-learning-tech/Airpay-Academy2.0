...
- `local_airpay_learningpath` — path container.
- `local_airpay_learningpath_courses` — ordered list of courses in a path.
- `local_airpay_learningpath_users` — user-to-path enrolment.
