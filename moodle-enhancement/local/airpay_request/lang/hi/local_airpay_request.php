...
//
// P1 #54 (2026-05-20) — Hindi (hi) translations for local_airpay_request.
...
// Capabilities.
$string['airpay_request:request']       = 'प्रतिबंधित कोर्सेज़ में नामांकन का अनुरोध करें';
$string['airpay_request:approve']       = 'कोर्स अनुरोध स्वीकृत / अस्वीकृत करें';
$string['airpay_request:viewall']       = 'टेनेंट में सभी अनुरोध देखें';
$string['airpay_request:overrideroute'] = 'अनुमोदन रूटिंग ओवरराइड करें';
...
// Privacy.
$string['privacy:metadata:local_airpay_request']                 = 'कोर्स नामांकन अनुरोध';
$string['privacy:metadata:local_airpay_request:userid']          = 'अनुरोध करने वाला यूज़र';
$string['privacy:metadata:local_airpay_request:courseid']        = 'अनुरोधित कोर्स';
$string['privacy:metadata:local_airpay_request:reason']          = 'अनुरोधकर्ता से मुक्त-पाठ कारण';
$string['privacy:metadata:local_airpay_request:decision_note']   = 'अनुमोदक का निर्णय नोट';
$string['privacy:metadata:local_airpay_request:approver_userid'] = 'जिस यूज़र ने अनुरोध पर निर्णय लिया';
$string['privacy:metadata:local_airpay_request:status']          = 'लंबित / स्वीकृत / अस्वीकृत / आदि।';
$string['privacy:metadata:local_airpay_request:timecreated']     = 'अनुरोध कब रखा गया';
