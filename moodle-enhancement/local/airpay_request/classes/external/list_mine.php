...
class list_mine extends external_api {
    ...
    public static function shape(\stdClass $r): array {
        ...
        $badgemap = [
            'pending'   => ['label' => get_string('status_pending',   'local_airpay_request'),
                            'class' => 'bg-warning text-dark'],
            'approved'  => ['label' => get_string('status_approved',  'local_airpay_request'),
                            'class' => 'bg-success'],
            'rejected'  => ['label' => get_string('status_rejected',  'local_airpay_request'),
                            'class' => 'bg-danger'],
            'cancelled' => ['label' => get_string('status_cancelled', 'local_airpay_request'),
                            'class' => 'bg-secondary'],
            'expired'   => ['label' => get_string('status_expired',   'local_airpay_request'),
                            'class' => 'bg-secondary'],
        ];
