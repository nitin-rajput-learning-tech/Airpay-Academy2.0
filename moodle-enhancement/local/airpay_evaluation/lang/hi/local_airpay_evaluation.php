...
$string['notify_admin_on_response_help']     = 'टिक करने पर, हर सफल सबमिशन सभी साइट एडमिन को एक प्लेटफ़ॉर्म सूचना भेजता है। वे अपनी सूचना प्राथमिकताओं में प्रति चैनल (ईमेल / पॉपअप / मोबाइल पुश) ऑप्ट आउट कर सकते हैं। कम-वॉल्यूम रणनीतिक सर्वे (C-suite पल्स, घटना-पश्चात डीब्रीफ) के लिए उपयोगी। उच्च-वॉल्यूम L1 प्रतिक्रिया फॉर्म के लिए बंद रखें — अन्यथा एडमिन मेल में डूब जाएँगे।';
...
$string['template_payload_corrupt']      = 'इस टेम्पलेट का payload डिकोड नहीं हो सका। पंक्ति प्लेटफ़ॉर्म के बाहर संपादित की गई हो सकती है। हटाएँ और पुनः सहेजें।';
