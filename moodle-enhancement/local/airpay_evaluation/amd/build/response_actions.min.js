    ...
    var collectAnswers = function(root) {
        ...
        for (var i = 0; i < cards.length; i++) {
            ...
            if (qtype === "text") {
                ...
                value = (num && num.value.trim() !== "") ? num.value.trim() : null;
            } else if (qtype === "multichoice_multi") {
                // P1 #18 — collect every checked option as a JSON-array string.
                var picks = [];
                var boxes = card.querySelectorAll('input[type="checkbox"]:checked');
                for (var j = 0; j < boxes.length; j++) picks.push(boxes[j].value);
