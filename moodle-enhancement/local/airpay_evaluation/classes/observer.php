 ...
 * `\local_airpay_evaluation\evaluation_manager::TRIGGER_EVENTS`. Each handler
...
class observer {
    ...
    public static function course_completed(\core\event\course_completed $event): void {
        try {
            ...
            debugging('local_airpay_evaluation observer (course_completed) failed: '
    ...
    public static function program_completed(\core\event\base $event): void {
        try {
            ...
            debugging('local_airpay_evaluation observer (program_completed) failed: '
                . $e->getMessage(), DEBUG_DEVELOPER);
        }
    }
    ...
    public static function classroom_ended(\core\event\base $event): void {
        try {
            ...
            debugging('local_airpay_evaluation observer (classroom_ended) failed: '
                . $e->getMessage(), DEBUG_DEVELOPER);
        }
    }
}
