...
class evaluation_engine {
    ...
    private const TRIGGER_TABLE  = 'local_airpay_evaluation_triggers';
    private const EVAL_TABLE     = 'local_airpay_evaluation';
    private const RESPONSE_TABLE = 'local_airpay_evaluation_responses';
     ...
     *
     * Queries `local_airpay_evaluation` for ACTIVE rows whose `trigger_event`
    ...
    private static function send_invite_notification(int $userid, \stdClass $eval): void {
        ...
        $url = new \moodle_url('/local/airpay_evaluation/respond.php', [
