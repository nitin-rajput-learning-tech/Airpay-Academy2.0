 ...
 * parity-audit-2026-05-15/airpay_evaluation.md. Pairs with P1 #37's
...
class evaluation_audience_assigner {
    ...
    public static function assign_by_filter(int $evaluationid,
        ...
        global $DB;
        $DB->get_record('local_airpay_evaluation', ['id' => $evaluationid],
        ...
        foreach ($userids as $uid) {
            $before = $DB->record_exists('local_airpay_evaluation_assign', [
