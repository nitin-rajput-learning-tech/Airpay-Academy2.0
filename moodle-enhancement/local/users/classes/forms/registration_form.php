...
class registration_form extends moodleform {
    public function definition() {
        ...
        // Password — use standard password field on registration (not passwordunmask which shows "Click to enter text").
        $mform->addElement('password', 'password', get_string('password'), ['size' => '20', 'autocomplete' => 'new-password']);
        ...
        // Single combined Privacy + Terms checkbox with links to Airpay custom pages.
        $privacyurl = $CFG->wwwroot . '/local/airpay_pages/index.php?page=privacy';
        $termsurl = $CFG->wwwroot . '/local/airpay_pages/index.php?page=terms';
        $policylabel = 'I have read and agree to the <a href="' . $privacyurl . '" target="_blank">Privacy Policy & Terms of Use</a>';
        $mform->addElement('advcheckbox', 'open_privacypolicy', '', $policylabel);
        $mform->addRule('open_privacypolicy', 'You must accept the Privacy Policy & Terms of Use to register.', 'required', null, 'client');
