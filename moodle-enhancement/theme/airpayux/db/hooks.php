...
/**
 * Hook subscriptions for theme_airpayux.
 *
 * Registers the new-style Moodle 5.2 hook callbacks. The legacy
 * function-name callbacks in lib.php (e.g.
 * `theme_airpayux_before_standard_top_of_body_html`) are intentionally
 ...
 *   "Callback before_standard_top_of_body_html in theme_airpayux
...
$callbacks = [
    [
        ...
        'callback' => \theme_airpayux\hook_callbacks::class . '::before_standard_top_of_body_html_generation',
        'priority' => 0,
    ],
];
