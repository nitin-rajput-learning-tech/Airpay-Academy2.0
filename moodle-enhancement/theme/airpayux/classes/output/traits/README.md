# airpayux theme — core_renderer trait decomposition
...
4. In `core_renderer.php`:
   - Add `use \theme_airpayux\output\traits\<trait_name>;` at the
     top of the class.
...
```powershell
# Lint:
php -l moodle-enhancement/theme/airpayux/classes/output/core_renderer.php
php -l moodle-enhancement/theme/airpayux/classes/output/traits/<trait>.php

# Deploy + cache purge:
Copy-Item -Recurse moodle-enhancement/theme/airpayux/classes/output/* `
    C:/xampp/htdocs/moodle5/public/theme/airpayux/classes/output/
