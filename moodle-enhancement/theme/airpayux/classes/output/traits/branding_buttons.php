 ...
 *
 * The trait is consumed by `\theme_airpayux\output\core_renderer` via
 * a `use \theme_airpayux\output\traits\branding_buttons;` declaration.
 *
 * Methods provided:
...
trait branding_buttons {
     ...
     * `theme_airpayux/socialicons` template.
     *
