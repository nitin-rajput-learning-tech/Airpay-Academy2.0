...
/**
 * Hook callbacks for theme_airpayux.
 *
 * Replaces the legacy function-name callbacks (e.g.
 * `theme_airpayux_before_standard_top_of_body_html`) with proper hook
...
class hook_callbacks {
     ...
     * theme_airpayux/user_status_badge reads this JSON and paints
