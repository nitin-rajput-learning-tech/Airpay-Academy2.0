...
final class role_detector_test extends \advanced_testcase {
    ...
    /**
     * L&D Admin via the `local/courses:manage` capability at system context.
     */
    public function test_ldadmin_via_capability(): void {
        ...
        // Create a role that has local/courses:manage and assign it.
        ...
        if (!empty($caps['local/courses:manage'])) {
            assign_capability('local/courses:manage', CAP_ALLOW, $roleid, $context);
            ...
            $this->assertTrue($r['isldadmin'],
                'User with local/courses:manage cap should be L&D Admin');
            $this->assertTrue($r['isadmin']);
            $this->assertFalse($r['ismanager']);
        } else {
            $this->markTestSkipped(
                'local/courses:manage capability not available — '
    ...
    public function test_switched_to_employee_demotes(): void {
        ...
        $caps = get_all_capabilities();
        if (empty($caps['local/courses:manage'])) {
            $this->markTestSkipped('local/courses:manage cap not available');
        }
