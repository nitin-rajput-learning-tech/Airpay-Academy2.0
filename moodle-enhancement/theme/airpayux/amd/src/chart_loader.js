...
//
// theme_airpayux/chart_loader — Chart.js loader for dashboard analytics
...
// flips.
//
// @module     theme_airpayux/chart_loader
...
define(['core/chartjs'], function(Chart) {
    ...
    return {
        ...
        // `require(['theme_airpayux/chart_loader'], function(loader) {
        //      new loader.Chart(...)
