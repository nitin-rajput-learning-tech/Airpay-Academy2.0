...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_airpayux/drawers:show}
     * @property {String} drawerShown See {@link event:theme_airpayux/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_airpayux/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_airpayux/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_airpayux/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_airpayux/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_airpayux/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_airpayux/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_airpayux/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_airpayux/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_airpayux/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_airpayux/drawers:hidden',
    };
     ...
     * @returns {module:theme_airpayux/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_airpayux/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_airpayux/drawers:close');
     ...
     *
     * @param {module:theme_airpayux/drawers} comparisonInstance
     */
