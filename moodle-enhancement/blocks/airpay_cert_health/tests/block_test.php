...
namespace block_airpay_cert_health;

defined('MOODLE_INTERNAL') || die();

/**
 * @covers \block_airpay_cert_health
 *
...
class block_test extends \advanced_testcase {
     ...
     * instantiating.
     */
    private function make_block(): \block_airpay_cert_health {
        global $CFG;
        ...
        require_once(__DIR__ . '/../block_airpay_cert_health.php');
        $b = new \block_airpay_cert_health();
        $b->init();
        return $b;
    }
