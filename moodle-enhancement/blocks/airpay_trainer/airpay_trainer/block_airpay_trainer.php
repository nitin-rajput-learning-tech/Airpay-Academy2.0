 ...
 *
 * @package    block_airpay_trainer
 * @copyright  2026 Airpay Payment Services
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_airpay_trainer extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_airpay_trainer');
    }
    ...
    public function get_content() {
        ...
        if (empty($sessions)) {
            $this->content->text = \html_writer::tag('p',
                get_string('notrainings', 'block_airpay_trainer'),
                ['class' => 'text-muted']);
            return $this->content;
        }
