...
$string['airpay_cron_health:addinstance'] = 'Add an Airpay Cron Health block';
$string['airpay_cron_health:myaddinstance'] = 'Add an Airpay Cron Health block to the My Moodle page';
