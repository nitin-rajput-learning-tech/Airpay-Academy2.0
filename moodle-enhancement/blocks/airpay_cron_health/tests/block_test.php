...
namespace block_airpay_cron_health;

defined('MOODLE_INTERNAL') || die();

/**
 * @covers \block_airpay_cron_health
 *
 * Unit tests for the cron-health dashboard block. Parallel to
 * block_airpay_cert_health/tests/block_test.php — same shape so
...
class block_test extends \advanced_testcase {
     ...
     */
    private function make_block(): \block_airpay_cron_health {
        global $CFG;
        require_once($CFG->dirroot . '/blocks/moodleblock.class.php');
        require_once(__DIR__ . '/../block_airpay_cron_health.php');
        $b = new \block_airpay_cron_health();
        $b->init();
        return $b;
    }
