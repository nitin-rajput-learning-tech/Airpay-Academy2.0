...
class block_learnerscript_observer {
    ...
    public static function ls_timestats(){
        ...
        // CLI guard (F-077, 2026-05-28 stabilization audit Phase 1):
        // This observer relies on $_SERVER['REQUEST_URI'] for time-tracking.
        // Under CLI (cron / admin/cli scripts) REQUEST_URI is unset and
        // parse_url(null) emits a deprecation warning every invocation,
        // polluting production cron logs. Time-tracking is meaningless in
        // CLI context anyway — there is no page request to track.
        if (defined('CLI_SCRIPT') && CLI_SCRIPT) {
            return true;
        }
        // Web-context belt-and-braces: explicitly require REQUEST_URI
        // before any parse_url call below.
