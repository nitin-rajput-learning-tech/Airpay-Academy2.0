    ...
    public function get_required_javascript() {
        $this->page->requires->js_call_amd('block_learnerscript/reportwidget', 'CreateDashboardwidget'
            , array(array('reportid' => $this->config->reportlist,
                'reporttype' => $this->config->reportcontenttype, 'instanceid' => $this->instance->id )));
        $this->page->requires->js('/blocks/learnerscript/js/highcharts/highcharts.js');
