...
'block_reportdashboard_complianceslist' => array(
        'classname' => 'block_reportdashboard_external',
        'methodname' => 'complianceslist',
        'classpath' => 'blocks/reportdashboard/externallib.php',
        'description' => 'case Add complicanes to Dashboard',
        'ajax' => true
    ),
'block_reportdashboard_compliancedetails' => array(
        'classname' => 'block_reportdashboard_external',
        'methodname' => 'compliancedetails',
        'classpath' => 'blocks/reportdashboard/externallib.php',
        'description' => 'case Add complicanes to Dashboard',
        'ajax' => true
    )
