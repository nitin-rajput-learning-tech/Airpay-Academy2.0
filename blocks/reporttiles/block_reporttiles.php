...
class block_reporttiles extends block_base {
    ...
    public function get_content() {
        ...
        if (isset($this->config->reportlist) &&
            ...
            $configtitlefullname = isset($configtitlefullname) ? ucwords($configtitlefullname) : '';
            ...
            // commenter by Raghuvaran for below changes
            $reporttileformat == 'fill' ? $colorformat = "style = background:#".$pickedcolor.";opacity:0.8" : $colorformat = "style=border-bottom:0px;border-bottom-style:solid;border-bottom-color:#$pickedcolor";
