...
$string['report_coursesoverview'] = 'Courses Overview';
$string['coursesoverviewcolumns'] = 'Courses Overview Columns';
$string['report_coursescompletions'] = "Courses Completions";
$string['coursescompletionscolumns'] = "Courses Completions Columns";
$string['classroom_completions'] = "Classroom Completions";
$string['report_classroom_completions'] = "Classroom Completions";
$string['classroomcompletionscolumns'] = "Classroom Completions Columns";
$string['report_coursegradeactivities'] = "Course Grade Activities";
$string['coursegradeactivities'] = "Course Grade Activities";
$string['completed'] = "Completed";
$string['not_completed'] = "Not Completed";
$string['classroomsoverviewcolumns'] = 'classroomsoverviewcolumns';
$string['report_classroomsoverview'] = 'Classrooms overview';
$string['programsoverviewcolumns'] = 'programsoverviewcolumns';
$string['report_programsoverview'] = 'Programs overview';
$string['learningplansoverviewcolumns'] = 'learningpathoverviewcolumns';
$string['report_learningplansoverview'] = 'Learningpath Overview';
$string['progarmfield'] = 'Program fields';
$string['programcompletioncolumns'] = 'programcompletioncolumns';
$string['report_programcompletions'] = 'Program Completion';
$string['report_learningplancomletions'] = 'Learningpath Completion';
$string['learningpathfield'] = 'Learningpath fields';
$string['onlinetestsoverviewcolumns'] = 'Onlineexamsoverviewcolumns';
$string['onlinetestfield'] = 'Onlinetest field';
$string['report_onlinetestsoverview'] = 'Onlineexams overview';
$string['onlinetestscompletionscolumns'] = 'Onlineexamscompletionscolumns';
$string['report_onlinetestscompletions'] = 'Onlineexams Completion';
$string['feedbackoverviewcolumns'] = 'feedbackoverviewcolumns';
$string['report_feedbackoverview'] = 'Feedback Overview';
$string['feedbacks'] = 'Feedbacks';
$string['feedbackcompletionscolumns'] ='feedbackcompletionscolumns';
$string['report_feedbackcompletions'] = 'Feedback Completions';
$string['learningpath'] = 'Learningpath';
$string['select_onlinetest'] = 'Select onlineexam';
$string['onlinetests'] = 'Onlineexams';
...
$string['myclassrooms'] = 'Myclassrooms';
$string['report_myclassrooms'] = 'Myclassrooms';
$string['orgusers'] = 'orgusers';
$string['report_orgusers'] = 'Organization users';
$string['report_skill'] = "Skill Report";
$string['mycoursess'] = 'Mycourses';
$string['report_mycoursess'] = 'Mycourses';
$string['mylearningplan'] = 'Mylearningplan';
$string['report_mylearningplan'] = 'Mylearningpath';
$string['myprograms'] = 'myprograms';
$string['report_myprograms'] = 'Myprograms';
$string['myonlinetests'] = 'myonlineexams';
$string['report_myonlinetests'] = 'Myonlineexams';
$string['feedbackfield'] = 'Feedbackfield';
$string['selectlearningplan'] = 'Select learningplan';
$string['selectclassroom'] = 'Select Classroom';
$string['filter_mycoursess'] = 'Select Courses';
$string['select_learningpath'] = 'Select Learningpath';
$string['selectonlinetest'] = 'Select onlinetest';
$string['programfield'] = 'Programfield';
$string['myclassroomscolumns'] = 'My Classrooms';
$string['mylearningpathsscolumn'] = 'My Learningpaths';
$string['learningplancompletionscolumns'] = 'learningplancompletionscolumns';
$string['certificatesoverviewcolumns'] = 'certificatesoverviewcolumns';
$string['report_certificatesoverview'] = 'Certificate Overview';
...
$string['managereports'] = 'Manage Reports';
$string['classroom_nameforreports'] = 'Classroom';
$string['certification_nameforreports'] = 'Certification';
$string['program_nameforreports'] = 'Program';
...
$string['classroomfield'] = "Classroom field";
...
$string['nolsinstance'] = 'Reports are not configured in this page';
...
$string['report_certificatecompletions'] ='Certificate Completions';
$string['sitelevelroles'] = 'sitelevelroles';
$string['userdata'] = 'userdata';
$string['report_mycertification'] = 'mycertification';
$string['mycoursescolumn'] = 'My Courses';
$string['skill'] = 'skill';
$string['mycertification'] = 'mycertification';
$string['certification_nameforreports'] = 'Certificate';
$string['certificates'] = 'Certificate';
$string['mycertificates'] = 'My Certificate';
$string['filter_mycertificates'] = 'Select Certificate';
$string['report_orgusers_help'] = 'This report provides list of all the Employees and their Sitelevel roles information';
$string['report_userdata_help'] = 'This report provides list of all the users and their  information';
$string['report_certificatecompletions_help'] = '<p><strong>Description: </strong>List of Certifications and its basic information along Completions status.</p>';
$string['report_certificatesoverview_help'] = '<p><strong>Description: </strong>List of Certifications and its basic information along with the Enrolments and Completions count.</p>';
$string['report_classroomsoverview_help'] = '<p><strong>Description: </strong>List of Classrooms and its basic information along with the Enrolments and Completions count.</p>';
$string['report_classroom_completions_help'] = '<p><strong>Description: </strong>List of Classrooms and its basic information along Completions status.</p>';
$string['report_feedbackcompletions_help'] = '<p><strong>Description: </strong>List of Feedbacks and its basic information along Completions status.</p>';
$string['report_feedbackoverview_help'] = '<p><strong>Description: </strong>List of Feedbacks and its basic information along with the Enrolments and Completions count.</p>';
$string['report_learningplancomletions_help'] = '<p><strong>Description: </strong>List of Learningplans and its basic information along Completions status.</p>';
$string['report_learningplansoverview_help'] = '<p><strong>Description: </strong>List of Learningplans and its basic information along with the Enrolments and Completions count.</p>';
$string['report_onlinetestscompletions_help'] = '<p><strong>Description: </strong>List of Onlineexams and its basic information along Completions status.</p>';
$string['report_onlinetestsoverview_help'] = '<p><strong>Description: </strong>List of Onlineexams and its basic information along with the Enrolments and Completions count.</p>';
$string['report_programcompletions_help'] = '<p><strong>Description: </strong>List of Programs and its basic information along Completions status.</p>';
$string['report_programsoverview_help'] = '<p><strong>Description: </strong>List of Programs and its basic information along with the Enrolments and Completions count.</p>';
$string['report_myclassrooms_help'] = 'List of Classrooms and its basic information along with the Enrolments and Completions status.';
$string['report_mycoursess_help'] = 'List of Courses and its basic information along with the Enrolments and Completions status.';
$string['report_mylearningplan_help'] = 'List of Learningplans and its basic information along with the Enrolments and Completions status.';
$string['report_myonlinetests_help'] = 'List of Onlineexams and its basic information along with the Enrolments and Completions status.';
$string['report_myprograms_help'] = 'List of Programs and its basic information along with the Enrolments and Completions status.';
$string['report_skill_help'] = 'Skills report';
$string['skills'] = 'Skills';
$string['filter_skills'] = 'Select skill';
$string['report_userdata'] = 'Userdata';
$string['report_mycertification_help'] = 'Mycertification report';
$string['myonlinetestscolumns'] = 'My Onlineexams';
$string['classroomstatus'] = 'Classroomstatus';
$string['report_coursescompletions_help'] = 'This report provides complete information about the Courses with user enrolments and their completion status';
$string['report_coursegradeactivities_help'] = 'This report provides enrolled users finalgrade information in the the Quiz and Scorm activities in the selected course';
$string['myprogramscolumn'] = 'My Programs';
$string['reportnames'] = 'Report Name';
$string['organizations'] = 'Organization';
$string['downloadedby'] = 'Downloaded By';
$string['downloadedon'] = 'Downloaded On';
...
$string['report_traininghoursvsusersvstrainers'] = 'ClassroomsTrainersAndUsersByMonths';
$string['traininghoursvsusersvstrainers'] = 'ClassroomsTrainersAndUsersByMonths';
$string['report_trainingsprogress'] = 'Classrooms By Month/Year';
$string['trainingsprogress'] = 'Classrooms By Month/Year';
$string['report_usersprogress'] = 'Users Progress';
$string['usersprogress'] = 'Users Progress';
$string['role'] = 'Role';
$string['report_departmentwiseclassrooms'] = 'Organization wise classrooms';
$string['departmentwiseclassrooms'] = 'Organization wise classrooms';
...
$string['report_classroomsessionattendence'] = 'Classroom Session Attendance';
$string['report_feedbackcourses'] = 'Course Feedback Responses';
$string['report_trainingsoverview'] = 'Trainings Overview';
$string['report_trainermanhours'] = 'Trainer ManHours';
