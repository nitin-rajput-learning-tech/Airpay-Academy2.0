...
class ls {
    ...
    public function userscormtimespent() {
    	...
    	foreach ($scormdetails as $scormdetail) {
	        ...
	        $insertdata->timespent = $scormdetail->time;
	        ...
	        $insertdata1->timespent = $scormdetail->time;
    ...
    public function userquiztimespent() {
    	...
    	foreach ($quizdetails as $quizdetail) {
	        ...
	        $insertdata->companyid = isset($companyinfo->companyid) ? $companyinfo->companyid : 0;
	        ...
	        $insertdata1->courseid = $quizdetail->courseid;
	        $insertdata1->companyid = isset($companyinfo->companyid) ? $companyinfo->companyid : 0;
        	$insertdata1->departmentid = isset($companyinfo->departmentid) ? $companyinfo->departmentid : 0;
	        $insertdata1->timespent = $quizdetail->time;
	        $insertdata1->timecreated = time();
	        $insertdata1->timemodified = 0;
	        $records1 = $DB->get_records('block_ls_coursetimestats',
	                    array('userid' => $insertdata1->userid,
