...
class report_learnerreport extends reportbase {
    /**
    ...
    public function __construct($report, $reportproperties) {
        ...
        $this->parent = true;
        $this->columns = array('coursefield' => ['coursefield'],'userfield' => array('userfield'), 'learnerreportcolumns' => array('enrolleddate', 'progress', 'completionstatus', 'completiondate', 'finalassespassinggrade','finalassesachievedgrade','finalgrade'));
    ...
    function select() {
        $this->sql = " SELECT ra.id as assignmentid ,u.id as userid, CONCAT(u.firstname,' ',u.lastname) AS fullname, u.*
                        , ra.timemodified as enrolleddate
                        , cc.timecompleted 
