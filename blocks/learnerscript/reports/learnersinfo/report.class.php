...
class report_learnersinfo extends reportbase {
    /**
    ...
    public function __construct($report, $reportproperties) {
        ...
        $this->parent = true;
        $this->columns = array('learnersinfocolumns' => array('learner', 'course', 'progress', 'completed', 'upcomingdeadline',  'overduedeadline'));
        $this->orderable = array('learner', 'course', 'progress', 'completed', 'upcomingdeadline',  'overduedeadline'); 
    ...
    function select() {
        $this->sql = " SELECT ue.id, ue.userid AS userid, CONCAT(u.firstname, '', u.lastname) AS learner,  c.id AS courseid, c.fullname AS course, cc.timecompleted AS completed ";
      parent::select();
    }
