...
class report_graphlearnercompletions extends reportbase implements report {
    /**
    ...
    public function __construct($report, $reportproperties) {
        ...
        $this->columns = ['graphlearnercompletionscolumns'=> ['month', 'completions']];    
        $this->parent = true;
        $this->orderable = array('month', 'completions');
