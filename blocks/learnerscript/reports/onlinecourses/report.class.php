...
class report_onlinecourses extends reportbase implements report {
    /**
    ...
    public function __construct($report, $reportproperties) {
        ...
        $this->parent = true;
        $this->columns = array('onlinecoursesfields' => array('learner', 'course', 'enrolmentdate', 'progress', 'dateofcompletion', 'completiondeadline', 'upcomingdeadline', 'overduedeadline'));
        ...
        $this->filters = array('onlinecourses', 'contentprovider', 'learningtype',  'solutionarea', 'technology', 'topic', 'vendor', 'level', 'language', 'jobrole');        
    ...
    public function where() { 
        $this->sql .= " WHERE 1 = 1 AND bll.moduletype IN ('Online Course','Webinar')";
    ...
    public function filters() { 
        ...
        if (!empty($this->params['filter_onlinecourses']) && $this->params['filter_onlinecourses'] > 0) {
            ...
            $this->sql .= " AND bll.learningformatid IN ($onlinecourseid) ";            
        }
