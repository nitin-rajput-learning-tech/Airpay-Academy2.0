...
class report_courseactivities extends reportbase implements report {
    ...
    public function __construct($report, $reportproperties) {
        ...
        $this->parent = false;
        $this->basicparams = array(['name' => 'organization'], ['name' => 'departments'], ['name'=>'subdepartments'], ['name' => 'course']); 
    ...
    public function column_queries($column, $activityid, $courses = null){
        ...
        $courseid = isset($this->params['filter_course']) ? $this->params['filter_course'] : SITEID;
