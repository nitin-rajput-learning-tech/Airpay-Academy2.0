        ...
        switch ($data->column) {
            ...
            case 'scorms':
                ...
                $scormurl = new moodle_url('/blocks/learnerscript/viewreport.php',
                    array('id' => $scormreportid, 'filter_users' => $row->id, 'filter_organization' => $this->reportfilterparams['filter_organization'], 'filter_departments' => $this->reportfilterparams['filter_departments'],'filter_subdepartments' => $this->reportfilterparams['filter_subdepartments']));
