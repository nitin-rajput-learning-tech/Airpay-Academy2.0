...
class trainerslist_form extends moodleform {

    public function definition() {
        global $DB, $USER, $CFG;
        $mform = & $this->_form;
        $mform->addElement('header', 'crformheader', get_string('trainerslist', 'block_learnerscript'), '');
        $columns = $DB->get_columns('trainerslist');
        $prinfocolumns = array();
