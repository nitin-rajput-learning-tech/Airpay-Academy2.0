            ...
            switch ($data->column) {
                ...
                case 'course':
                    ...
                    if(empty($reportid) || empty($checkpermissions)){
                        ...
                        $courserecord->{$data->column} = '<a href="'.$CFG->wwwroot.'/blocks/learnerscript/viewreport.php?id='.$reportid.'&filter_course='.$courserecord->course.'" />'.$coursename.'</a>';
                    }
                break;
                case 'visible':
                ...
                case 'section':
                    ...
                    $sectionid = $DB->get_field_sql("SELECT section FROM {course_sections} WHERE id = $courserecord->section ");
