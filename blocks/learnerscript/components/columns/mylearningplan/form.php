...
class mylearningplan_form extends moodleform {

    public function definition() {
        global $DB, $USER, $CFG;
        $mform = & $this->_form;
        $mform->addElement('header', 'crformheader', get_string('mylearningplan', 'block_learnerscript'), '');
        $columns = $DB->get_columns('userdata');
