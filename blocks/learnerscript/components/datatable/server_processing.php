...
$courses = optional_param('filter_course', $courseid, PARAM_TEXT);
$cmid = optional_param('cmid', 0, PARAM_INT);
$courseid = optional_param('courseid', SITEID, PARAM_INT);
...
$reportclass->courseid = $reportclass->params['courseid'] > SITEID ? $reportclass->params['courseid'] : $reportclass->params['filter_course'];
