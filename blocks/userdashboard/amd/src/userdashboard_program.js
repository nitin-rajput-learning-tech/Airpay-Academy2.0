...
define(['jquery',
    ...
    var userdashboardProgram = function(){       
      self._filter ='';         
      self._template='';
    ...
    userdashboardProgram.prototype._getajaxCourses = function(){
        ...
        var removeRelated = ajax.call([{
            methodname: 'block_userdashboard_data_for_program_courses',
                args:  {
                    filter: self._filter,
        ...
        removeRelated[0].done(function(context) {
            ...
            templates.render(self._template, context).then(function(html,js) { 
                if(self._menu == 1){
                    userdashboardProgram.prototype.frommenu_target_program(html,'#program_courses');
                }              
                else { 
    ...
    userdashboardProgram.prototype._setter = function(filter,filter_text){      
  
        self._filter = filter;
        self._filter_text = filter_text;
         
        if(self._filter =='inprogress'){
            self._template='block_userdashboard/program_courses_innercontent';
        ...
        return  userdashboardProgram.prototype._getajaxCourses();

    };
    
    userdashboardProgram.prototype.frommenu_target_program= function (html, menu_targetselector){
    ...
    userdashboardProgram.callProgram = function(filter,filter_text){
        userdashboardProgram.prototype._setter(filter,filter_text);
    };

    /** @alias module:block_userdashboard/userdashboard_elearning.js userdashboardElearning  */ 
    return userdashboardProgram;
