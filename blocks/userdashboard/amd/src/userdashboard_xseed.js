...
define(['jquery',
    ...
    var userdashboardXseed = function(){       
      self._filter ='';         
      self._template = '';
    ...
    userdashboardXseed.prototype._getajaxCourses = function(){
        ...
        var removeRelated = ajax.call([{
            methodname: 'block_userdashboard_data_for_xseed',
                args:  {
                    filter: self._filter,
        ...
        removeRelated[0].done(function(context) {
            ...
            templates.render(self._template, context).then(function(html,js) { 
                if(self._menu == 1){
                    userdashboardXseed.prototype.frommenu_target_xseed(html,'#xseed');
                }              
                else { 
    ...
    userdashboardXseed.prototype._setter = function(filter , filter_text){      
  
        self._filter = filter;
        self._filter_text = filter_text;
         
        if(self._filter =='inprogress'){
            self._template ='block_userdashboard/xseed_innercontent';
        ...
        return  userdashboardXseed.prototype._getajaxCourses();

    };
    
    userdashboardXseed.prototype.frommenu_target_xseed = function (html, menu_targetselector){
    ...
    userdashboardXseed.callXseed = function(filter, filter_text){
        // console.log(filter);
        userdashboardXseed.prototype._setter(filter, filter_text);
    };

    /** @alias module:block_userdashboard/userdashboard_elearning.js userdashboardElearning  */ 
    return userdashboardXseed;
