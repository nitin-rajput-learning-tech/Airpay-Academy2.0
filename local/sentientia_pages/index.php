 ...
 * Usage: /local/sentientia_pages/index.php?page=privacy
 *        /local/sentientia_pages/index.php?page=terms
 *        /local/sentientia_pages/index.php?page=help
 *        /local/sentientia_pages/index.php?page=contact
 *
...
$PAGE->set_url('/local/sentientia_pages/index.php', ['page' => $page]);
...
foreach ($validpages as $slug => $title) {
    ...
    $url = new moodle_url('/local/sentientia_pages/index.php', ['page' => $slug]);
