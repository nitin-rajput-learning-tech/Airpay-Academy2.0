...
// Capabilities.
$string['sentientia_request:request']    = 'Request enrolment in restricted courses';
$string['sentientia_request:approve']    = 'Approve / reject course requests';
$string['sentientia_request:viewall']    = 'View all requests across tenant';
$string['sentientia_request:overrideroute'] = 'Override the approval routing';
...
// Privacy.
$string['privacy:metadata:local_sentientia_request']                   = 'Course enrolment requests';
$string['privacy:metadata:local_sentientia_request:userid']            = 'The user who placed the request';
$string['privacy:metadata:local_sentientia_request:courseid']          = 'The requested course';
$string['privacy:metadata:local_sentientia_request:reason']            = 'Free-text reason from the requester';
$string['privacy:metadata:local_sentientia_request:decision_note']     = 'Approver\'s decision note';
$string['privacy:metadata:local_sentientia_request:approver_userid']   = 'The user who decided the request';
