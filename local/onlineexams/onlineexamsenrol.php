...
if (!$haveaccess) {
  redirect($CFG->wwwroot . '/local/onlineexams/error.php?id=2');
}
if ($roleid < 0) {
...
echo '<a class="btn-link btn-sm" title="' . get_string('filter') . '" href="javascript:void(0);" data-toggle="collapse" data-target="#local_onlineexamsenrol-filter_collapse" aria-expanded="false" aria-controls="local_onlineexamsenrol-filter_collapse">
        <i class="m-0 fa fa-sliders fa-2x" aria-hidden="true"></i>
      </a>';
echo  '<div class="collapse ' . $show . '" id="local_onlineexamsenrol-filter_collapse">
