 ...
 */
class request_commented extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($requestinfo){
            return "The user with id '$firstname ($this->userid)' has requested for component($requestinfo->compname), componentid($requestinfo->componentid), action(Approved) and requestedid ($requestinfo->id).";
        }else{
            return 'went wrong';
        }     
    ...
    public static function get_name() {
         return get_string('eventrequestapproved', 'local_request');
    }
    ...
    public function get_url() {
        global $DB;
        $url = new \mooddle_url('/local/request/index.php');
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'request', 'approved', $logurl, $this->component, $this->componentid);
    }
