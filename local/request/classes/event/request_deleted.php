...
class request_deleted extends \core\event\base {
    ...
    public function get_description() {
        ...
        if($requestinfo){
            return "The user with id '$firstname ($this->userid)' has requested for component($requestinfo->compname), componentid($requestinfo->componentid), action(Deleted) and requestedid ($requestinfo->id).";
        }else{
            return 'went wrong';
        }     
    ...
    public static function get_name() {
         return get_string('eventrequestdeleted', 'local_request');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'request', 'deleted', $logurl, $this->other['component'],  $this->other['componentid']);
    }
