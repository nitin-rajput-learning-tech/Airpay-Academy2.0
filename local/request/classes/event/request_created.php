...
class request_created extends \core\event\base {
    ...
    public function get_description() {
        ...
        if($requestinfo){
            return "The user with id '$firstname ($this->userid)' has requested for component($requestinfo->compname), componentid($requestinfo->componentid) and requestedid ($requestinfo->id).";
        }else{
            return 'went wrong';
        }
    }
    ...
    public static function get_name() {
        return get_string('eventrequestcreated', 'local_request');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'request', 'add', $logurl, $this->other['component'], $this->other['componentid']);
    }
