...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_database_table('local_sentientia_recompletion_history', [
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        global $DB;
        if ($DB->record_exists('local_sentientia_recompletion_history', ['userid' => $userid])) {
    ...
    public static function get_users_in_context(userlist $userlist): void {
        ...
        $ids = $DB->get_fieldset_sql(
            "SELECT DISTINCT userid FROM {local_sentientia_recompletion_history}");
    ...
    public static function export_user_data(approved_contextlist $contextlist): void {
        ...
        $rows = $DB->get_records('local_sentientia_recompletion_history',
    ...
    public static function delete_data_for_all_users_in_context(\context $context): void {
        ...
        global $DB;
        $DB->execute("UPDATE {local_sentientia_recompletion_history} SET userid = 0");
    }
    ...
    private static function redact_for_user(int $userid): void {
        ...
        $DB->execute("UPDATE {local_sentientia_recompletion_history}
