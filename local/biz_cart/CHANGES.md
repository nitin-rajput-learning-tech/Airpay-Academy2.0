...
This feature can be turned on by activating the setting 'local_biz_cart | allowrebooking'.
...
* Bugfix: Moodle exception: Exception - Class "local_biz_cart\biz_cart\context_system" not found.
...
* Bugfix: Daily sums need to sum up prices from local_biz_cart_ledger (not local_biz_cart_history).
...
**Tests:**
* Behat: Adjusting biz_cart test (a) settings separated for better optimization; (b) to use 2-digits prices.
...
**Improvements:**
* Add index for local_biz_cart_credits for better performance.
