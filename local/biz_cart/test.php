...
use local_biz_cart\output\button;
...
$PAGE->set_heading('Testing local_biz_cart');
$PAGE->navbar->add('Testing local_biz_cart', new moodle_url('/test.php'));
echo $OUTPUT->header();
...
// See \local_biz_cart\biz_cart\service_provider for real values.
$item = new cartitem(
    1,
    '1',
    10.00,
...
$data = [
    'checkouturl' => $CFG->wwwroot . "/local/biz_cart/checkout.php",
    'count' => 2,
];
echo $OUTPUT->render_from_template('local_biz_cart/checkout_button', $data);
echo '</div>';
