...
/**
 * Provides the local_biz_cart_search_entities external function.
 *
 * @package     local_biz_cart
 * @category    external
 * @copyright   2023 Moodle India <georg.maisser@wunderbyt.at>
...
class search_users extends external_api
{
    ...
    public static function execute(string $query): array
    {
        ...
        return biz_cart::load_users($params['query']);
    }
