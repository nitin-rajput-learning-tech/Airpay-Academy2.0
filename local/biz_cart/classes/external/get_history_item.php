...
class get_history_item extends external_api
{
    ...
    /**
     * Webservice for biz_cart class to add a new item to the cart.
     *
    ...
    public static function execute(
        ...
        $item = biz_cart_history::get_most_recent_historyitem(
        ...
        return [
            ...
            'cancelationfee' => get_config('local_biz_cart', 'cancelationfee') < 1
            ? 0 : get_config('local_biz_cart', 'cancelationfee'),
        ];
    }
