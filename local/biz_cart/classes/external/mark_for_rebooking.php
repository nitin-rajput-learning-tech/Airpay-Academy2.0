...
class mark_for_rebooking extends external_api
{
    ...
    /**
     * Webservice for biz_cart_history class to mark history item for rebooking.
     *
     * @param int $historyid
     * @param int $userid
     * @return array
    ...
    public static function execute(int $historyid, int $userid): array
    {
        ...
        if (!has_capability('local/biz_cart:cashier', $context)
            ...
            throw new moodle_exception('norighttobookforotherusers', 'local_biz_cart');
        }

        return biz_cart_history::toggle_mark_for_rebooking($params['historyid'], $params['userid']);
    }
