...
class cancel_purchase extends external_api
{
    ...
    public static function execute_parameters(): external_function_parameters
    {
        return new external_function_parameters([
            ...
            'historyid' => new external_value(PARAM_INT, 'id of entry in biz_cart_history db', VALUE_REQUIRED),
    ...
    public static function execute(
        ...
        return biz_cart::cancel_purchase($params['itemid'], $params['area'], $params['userid'], $params['componentname'],
