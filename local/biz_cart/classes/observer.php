...
/**
 * Event observer for local_biz_cart.
 */
class observer
{
    ...
    public static function payment_error(\core\event\base $event): string
    {
        ...
        /* biz_cart_history::error_occured_for_identifier($itemid, $data['userid']); */
    ...
    {
        $invoiceprovidername = get_config('local_biz_cart', 'invoicingplatform');
        $invoiceproviderclass = "local_biz_cart\\invoice\\" . $invoiceprovidername . "_invoice";
