...
class modal_cancel_all_addcredit extends dynamic_form
{
    ...
    public function definition()
    {
        ...
        if (!$bookedusers = biz_cart_history::get_user_list_for_option($itemid, $componentname, $area)) {
            $bookedusers = [];
        }
        ...
        if (count($bookedusers) == 0) {
            $list = get_string('nousersfound', 'local_biz_cart');
        }
        ...
        $mform->addElement('static', 'bodytext', '', get_string('confirmcancelallbody', 'local_biz_cart', $data));
    ...
    public function process_dynamic_submission()
    {
        ...
        $bookedusers = biz_cart_history::get_user_list_for_option($data->itemid, $data->componentname, $data->area);
        ...
        booking_option::cancelbookingoption($data->itemid, get_string('optioncancelled', 'local_biz_cart'));
        ...
        foreach ($bookedusers as $buser) {
            ...
            biz_cart::cancel_purchase($buser->itemid, $data->area, $buser->userid, $componentname,
