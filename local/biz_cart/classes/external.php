            ...
            'records' => new external_multiple_structure(
                            new external_single_structure(
                                array(
                                    ...
                                    'courseid'=>new external_value(PARAM_RAW, 'id in notification', VALUE_OPTIONAL),
                                    'coursename'=>new external_value(PARAM_RAW, 'context id in notification', VALUE_OPTIONAL),
                                    'transactioncode' => new external_value(PARAM_RAW, 'type in notification', VALUE_OPTIONAL),
        
                                    'invoicedate' => new external_value(PARAM_RAW, 'code', VALUE_OPTIONAL),
                                    'amount' => new external_value(PARAM_RAW, 'subject of notification', VALUE_OPTIONAL),
                                    'status' => new external_value(PARAM_RAW, 'organization name in notification', VALUE_OPTIONAL),
