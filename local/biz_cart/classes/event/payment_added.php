...

{
    ...
    {
        return get_string('payment_added', 'local_biz_cart');
    }
    ...
    public function get_description()
    {
        ...
        return get_string('payment_added_log', 'local_biz_cart', $data);
    }
    ...
    {
        return new \moodle_url('/local/biz_cart/checkout.php');
    }
}
