...
/**
 * Privacy subsystem implementation for local_biz_cart
 *
 ...
 */
namespace local_biz_cart\privacy;
...

{
    ...
    public static function get_metadata(collection $collection): collection
    {
        $collection->add_database_table(
            'local_biz_cart_history',
            [
                'userid' => 'privacy:metadata:local_biz_cart_history:userid',
                'itemid' => 'privacy:metadata:local_biz_cart_history:itemid',
                'itemname' => 'privacy:metadata:local_biz_cart_history:itemname',
                'price' => 'privacy:metadata:local_biz_cart_history:price',
                'tax' => 'privacy:metadata:local_biz_cart_history:tax',
                'taxpercentage' => 'privacy:metadata:local_biz_cart_history:taxpercentage',
                'discount' => 'privacy:metadata:local_biz_cart_history:discount',
                'currency' => 'privacy:metadata:local_biz_cart_history:currency',
                'componentname' => 'privacy:metadata:local_biz_cart_history:componentname',
                'identifier' => 'privacy:metadata:local_biz_cart_history:identifier',
                'payment' => 'privacy:metadata:local_biz_cart_history:payment',
                'paymentstatus' => 'privacy:metadata:local_biz_cart_history:paymentstatus',
                'usermodified' => 'privacy:metadata:local_biz_cart_history:usermodified',
                'timecreated' => 'privacy:metadata:local_biz_cart_history:timecreated',
                'canceluntil' => 'privacy:metadata:local_biz_cart_history:canceluntil',
                'serviceperiodstart' => 'privacy:metadata:local_biz_cart_history:serviceperiodstart',
                'serviceperiodend' => 'privacy:metadata:local_biz_cart_history:serviceperiodend',
                'area' => 'privacy:metadata:local_biz_cart_history:area',
                'usecredit' => 'privacy:metadata:local_biz_cart_history:usecredit',
                'costcenter' => 'privacy:metadata:local_biz_cart_history:costcenter',
            ],
            'privacy:metadata:local_biz_cart_history'
        );

        $collection->add_database_table(
            'local_biz_cart_credits',
            [
                'userid' => 'privacy:metadata:local_biz_cart_history:userid',
                'credits' => 'privacy:metadata:local_biz_cart_history:credits',
                'currency' => 'privacy:metadata:local_biz_cart_history:currency',
                'balance' => 'privacy:metadata:local_biz_cart_history:balance',
                'usermodified' => 'privacy:metadata:local_biz_cart_history:usermodified',
                'timecreated' => 'privacy:metadata:local_biz_cart_history:timecreated',
                'timemodified' => 'privacy:metadata:local_biz_cart_history:timemodified',
            ],
            'privacy:metadata:local_biz_cart_credits'
        );

        $collection->add_database_table(
            'local_biz_cart_ledger',
            [
                'userid' => 'privacy:metadata:local_biz_cart_history:userid',
                'itemid' => 'privacy:metadata:local_biz_cart_history:itemid',
                'itemname' => 'privacy:metadata:local_biz_cart_history:itemname',
                ...
                'tax' => 'privacy:metadata:local_biz_cart_history:tax',
                'taxpercentage' => 'privacy:metadata:local_biz_cart_history:taxpercentage',
                'taxcategory' => 'privacy:metadata:local_biz_cart_history:taxcategory',
                'discount' => 'privacy:metadata:local_biz_cart_history:discount',
                'credits' => 'privacy:metadata:local_biz_cart_history:credits',
                'fee' => 'privacy:metadata:local_biz_cart_history:fee',
                'currency' => 'privacy:metadata:local_biz_cart_history:currency',
                'componentname' => 'privacy:metadata:local_biz_cart_history:componentname',
                'identifier' => 'privacy:metadata:local_biz_cart_history:identifier',
                'payment' => 'privacy:metadata:local_biz_cart_history:payment',
                ...
                'canceluntil' => 'privacy:metadata:local_biz_cart_history:canceluntil',
                'area' => 'privacy:metadata:local_biz_cart_history:area',
                'annotation' => 'privacy:metadata:local_biz_cart_history:annotiation',
                'costcenter' => 'privacy:metadata:local_biz_cart_history:costcenter',
            ],
            'privacy:metadata:local_biz_cart_ledger'
        );

        $collection->add_database_table(
            'local_biz_cart_invoices',
            [
                'identifier' => 'privacy:metadata:local_biz_cart_history:identifier',
                'timecreated' => 'privacy:metadata:local_biz_cart_history:timecreated',
                'invoiceid' => 'privacy:metadata:local_biz_cart_history:invoiceid',
            ],
            'privacy:metadata:local_biz_cart_invoices'
        );
    ...
    public static function export_user_data(approved_contextlist $contextlist)
    {
        ...
        if (!$record = $DB->get_records('local_biz_cart_history', ['userid' => $user->id])) {
            return;
        }
    ...
    public static function delete_data_for_all_users_in_context(context $context)
    {
        ...
        $DB->delete_records('local_biz_cart_history');
        $DB->delete_records('local_biz_cart_credits');

        // Ledger and invoices should never be deleted, regardless what.
        $DB->delete_records('local_biz_cart_ledger');
        $DB->delete_records('local_biz_cart_invoices');
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist)
    {
        ...
        $user = $contextlist->get_user();
        // Check if there is at least one record.
        if (!$records = $DB->get_records('local_biz_cart_history', ['userid' => $user->id])) {
            return;
        }
        foreach ($contextlist->get_contexts() as $context) {
            if ($context->contextlevel != CONTEXT_SYSTEM) {
            ...
            $DB->delete_records('local_biz_cart_history', ['userid' => $user->id]);
            $DB->delete_records('local_biz_cart_credits', ['userid' => $user->id]);

            foreach ($records as $record) {
                // Delete identifier.
                $DB->delete_records('local_biz_cart_invoices', ['identifier' => $record->identifier]);
            }

            if (!empty(get_config('local_biz_cart', 'deleteledger'))) {
                $DB->delete_records('local_biz_cart_leger', ['userid' => $user->id]);
            }
        }
    }
    ...
    public static function delete_data_for_users(approved_userlist $userlist)
    {
        ...
        if ($identifiers = $DB->get_fieldset_sql($sql, $params)) {
            $DB->delete_records_list('local_biz_cart_invoices', 'identifier', $identifiers);
        }

        $DB->delete_records_list('local_biz_cart_history', 'userid', $userids);
        $DB->delete_records_list('local_biz_cart_credits', 'userid', $userids);

        if (!empty(get_config('local_biz_cart', 'deleteledger'))) {
            $DB->delete_records_list('local_biz_cart_ledger', 'userid', $userids);
        }
    }
    ...
    private static function export_all_historyitems($contextlist)
    {
        ...
        foreach ($DB->get_records_sql($sql, $params) as $sch) {
            ...
            $subcontext = [
                get_string('pluginname', 'local_biz_cart'),
                get_string('history', 'local_biz_cart'),
                $sch->itemname];
    ...
    private static function export_all_ledgeritems($contextlist)
    {
        ...
        $sql = "
            ...
            FROM {local_biz_cart_ledger} scl
            LEFT JOIN {local_biz_cart_invoices} sci ON scl.identifier=sci.identifier
        ...
        foreach ($DB->get_records_sql($sql, $params) as $scl) {
            ...
            $subcontext = [
                get_string('pluginname', 'local_biz_cart'),
                get_string('ledger', 'local_biz_cart'),
    ...
    private static function export_all_creditsitems($contextlist)
    {
        ...
        $sql = "
                SELECT sch.*, u.firstname, u.lastname
                FROM {local_biz_cart_credits} sch
                JOIN {user} u ON sch.userid=u.id
                WHERE sch.userid = :userid
                ";
        $params = [
        ...
        foreach ($DB->get_records_sql($sql, $params) as $scc) {
            ...
            $subcontext = [
                get_string('pluginname', 'local_biz_cart'),
                get_string('credits', 'local_biz_cart'),
                $scc->id];
