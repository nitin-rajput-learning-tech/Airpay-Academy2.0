...
class taxcategories_test extends TestCase
{
    ...
    public function test_single_line()
    {
        ...
        $expected = [
            taxcategories::local_biz_cart_DEFAULT_COUNTRY_INDEX => ["A" => 0.2, "B" => 0.1, "C" => 0.0],
        ];
    ...
    public function test_single_value_empty_default_category()
    {
        ...
        $this->assertEquals(taxcategories::local_biz_cart_DEFAULT_CATEGORY_KEY,
            $fromraw->defaultcategory(), "Unexpected default category");
        $this->assertEqualsCanonicalizing([taxcategories::local_biz_cart_DEFAULT_CATEGORY_KEY], $fromraw->validcategories());
        $expected = [
            taxcategories::local_biz_cart_DEFAULT_COUNTRY_INDEX => [
                taxcategories::local_biz_cart_DEFAULT_CATEGORY_KEY => 0.2,
            ],
        ];
        $this->assertEqualsCanonicalizing($expected, $fromraw->taxmatrix());
    }
    ...
    public function test_multi_line()
    {
        ...
        $this->assertEqualsCanonicalizing(['A', 'B', 'C'], $fromraw->validcategories());
        $expected = [
            taxcategories::local_biz_cart_DEFAULT_COUNTRY_INDEX => ["A" => 0, "B" => 0, "C" => 0.0],
