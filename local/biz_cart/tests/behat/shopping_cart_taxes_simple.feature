...
Feature: Admin tax actions with simple taxin shopping cart.
  ...
  Scenario: Add single item to the shopping cart as user when tax without categories enabled
    ...
    And I click on "#btn-local_biz_cart-main-4" "css_element"
    ...
    And I should see "13.94 EUR" in the "#item-local_biz_cart-main-4 .item-price" "css_element"
    And I should see "(12.12 EUR + 15%)" in the "#item-local_biz_cart-main-4 .item-price" "css_element"
