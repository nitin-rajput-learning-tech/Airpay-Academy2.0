...
Feature: Admin tax actions with tax categories in shopping cart.
  ...
  Scenario: Add single item to the shopping cart as user when tax categories enabled
    ...
    And I should see "11.50 EUR" in the "#item-local_biz_cart-main-1 .item-price" "css_element"
    And I should see "(10.00 EUR + 15%)" in the "#item-local_biz_cart-main-1 .item-price" "css_element"
  ...
  Scenario: Add two items to the shopping cart as user when tax categories enabled
    ...
    And I wait until the page is ready
    And I click on "#btn-local_biz_cart-main-1" "css_element"
    And I click on "#btn-local_biz_cart-main-2" "css_element"
    And I click on "#nav-biz_cart-popover-container" "css_element"
    Then I should see "my test item 1" in the "#item-local_biz_cart-main-1" "css_element"
    And I should see "11.50 EUR" in the "#item-local_biz_cart-main-1 .item-price" "css_element"
    And I should see "(10.00 EUR + 15%)" in the "#item-local_biz_cart-main-1 .item-price" "css_element"
    And I should see "my test item 2" in the "#item-local_biz_cart-main-2" "css_element"
    And I should see "22.33 EUR" in the "#item-local_biz_cart-main-2 .item-price" "css_element"
    And I should see "(20.30 EUR + 10%)" in the "#item-local_biz_cart-main-2 .item-price" "css_element"
  ...
  Scenario: Add three items to the shopping cart when tax categories enabled and goto checkout
    ...
    And I visit "/local/biz_cart/checkout.php"
    And I wait until the page is ready
    And I should see "Your shopping cart"
    Then I should see "my test item 1" in the ".checkoutgrid.checkout #item-local_biz_cart-main-1" "css_element"
    And I should see "11.50 EUR" in the ".checkoutgrid.checkout #item-local_biz_cart-main-1 .item-price" "css_element"
    And I should see "(10.00 EUR + 15%)" in the ".checkoutgrid.checkout #item-local_biz_cart-main-1 .item-price" "css_element"
    And I should see "my test item 2" in the ".checkoutgrid.checkout #item-local_biz_cart-main-2" "css_element"
    And I should see "22.33 EUR" in the ".checkoutgrid.checkout #item-local_biz_cart-main-2 .item-price" "css_element"
    And I should see "(20.30 EUR + 10%)" in the ".checkoutgrid.checkout #item-local_biz_cart-main-2 .item-price" "css_element"
    And I should see "my test item 3" in the ".checkoutgrid.checkout #item-local_biz_cart-main-3" "css_element"
    And I should see "13.80 EUR" in the ".checkoutgrid.checkout #item-local_biz_cart-main-3 .item-price" "css_element"
    And I should see "(13.80 EUR + 0%)" in the ".checkoutgrid.checkout #item-local_biz_cart-main-3 .item-price" "css_element"
