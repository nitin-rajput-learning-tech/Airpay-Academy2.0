...
Feature: User cancellation after cash payment on the checkout page.
  ...
  Background:
    ...
    And the following "local_biz_cart > user credits" exist:
  ...
  Scenario: User select two items procedd to checkout cancel one than pay with credits
    ...
    And I should see "my test item 1" in the ".checkoutgrid.checkout #item-local_biz_cart-main-1" "css_element"
    And I should see "10.00 EUR" in the ".checkoutgrid.checkout #item-local_biz_cart-main-1 .item-price" "css_element"
    And I should see "my test item 2" in the ".checkoutgrid.checkout #item-local_biz_cart-main-2" "css_element"
    And I should see "20.30 EUR" in the ".checkoutgrid.checkout #item-local_biz_cart-main-2 .item-price" "css_element"
