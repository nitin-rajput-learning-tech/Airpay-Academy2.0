...
Feature: Cashier actions in shopping cart with tax categories enabled.
  ...
  Scenario: Cashier buys three items when tax categories eanbled
    ...
    And I visit "/local/biz_cart/cashier.php"
    And I wait until the page is ready
    And I set the field "Select a user..." to "Username1"
    And I should see "Username1 Test"
    And I click on "Continue" "button"
    And I click on "#biz_cart-cashiers-section #checkout-btn" "css_element"
    And I wait "2" seconds
    Then I should see "my test item 1" in the "#biz_cart-cashiers-section ul.shopping-cart-items" "css_element"
    And I should see "11.50 EUR" in the "#biz_cart-cashiers-section ul.shopping-cart-items #item-local_biz_cart-main-1 .item-price" "css_element"
    And I should see "(10.00 EUR + 15%)" in the "#biz_cart-cashiers-section ul.shopping-cart-items #item-local_biz_cart-main-1 .item-price" "css_element"
    And I should see "my test item 2" in the "#biz_cart-cashiers-section ul.shopping-cart-items" "css_element"
    And I should see "22.33 EUR" in the "#biz_cart-cashiers-section ul.shopping-cart-items #item-local_biz_cart-main-2 .item-price" "css_element"
    And I should see "(20.30 EUR + 10%)" in the "#biz_cart-cashiers-section ul.shopping-cart-items #item-local_biz_cart-main-2 .item-price" "css_element"
    And I should see "my test item 3" in the "#biz_cart-cashiers-section ul.shopping-cart-items" "css_element"
    And I should see "13.80 EUR" in the "#biz_cart-cashiers-section ul.shopping-cart-items #item-local_biz_cart-main-3 .item-price" "css_element"
    And I should see "(13.80 EUR + 0%)" in the "#biz_cart-cashiers-section ul.shopping-cart-items #item-local_biz_cart-main-3 .item-price" "css_element"
    And I should see "44.10" in the "#biz_cart-cashiers-section .sc_totalprice_net" "css_element"
    And I should see "47.63" in the "#biz_cart-cashiers-section .sc_totalprice" "css_element"
    And I click on "#biz_cart-cashiers-section .btn_cashpayment" "css_element"
