...
Feature: Cashier actions in shopping cart.
  ...
  Scenario: Cashier rewievs an item the shopping cart of user
    ...
    Then I should see "my test item 1" in the "#biz_cart-cashiers-cart" "css_element"
    And I should see "10.00 EUR" in the "#biz_cart-cashiers-cart .item-price" "css_element"
  ...
  Scenario: Cashier adds discount without rounding for user cart item
    ...
    And I set the following administration settings values:
      | Round discounts | |
    When I visit "/local/biz_cart/cashier.php"
    And I wait until the page is ready
    And I set the field "Select a user..." to "Username1"
    And I should see "Username1 Test"
    And I click on "Continue" "button"
    And I should see "my test item 1" in the "#biz_cart-cashiers-cart" "css_element"
    And I click on "#biz_cart-cashiers-cart [data-item=\"biz_cart_item\"] i.shoppingcart-discount-icon" "css_element"
    And I set the following fields to these values:
      | discountabsolute | 4.5 |
    And I press "Save changes"
    And I click on "#biz_cart-cashiers-section #checkout-btn" "css_element"
    Then I should see "5.50 EUR" in the "#biz_cart-cashiers-section .sc_totalprice" "css_element"
  ...
  Scenario: Cashier adds discount with rounding for user cart item
    ...
    And I press "Save changes"
    And I click on "#biz_cart-cashiers-section #checkout-btn" "css_element"
    Then I should see "5.00 EUR" in the "#biz_cart-cashiers-section .sc_totalprice" "css_element"
  ...
  Scenario: Cashier buys item for user with cash and cancel purchase with cancellation fee
    ...
    Then I should see "my test item 1" in the "#biz_cart-cashiers-cart" "css_element"
    And I click on "#biz_cart-cashiers-section #checkout-btn" "css_element"
    Then I should see "10.00 EUR" in the "#biz_cart-cashiers-section .sc_totalprice" "css_element"
    And I click on "#biz_cart-cashiers-section .btn_cashpayment" "css_element"
    Then I should see "Payment successful" in the "div.payment_message_result" "css_element"
  ...
  Scenario: Cashier buys discounted item for user with cash and cancel purchase with cancellation fee
    ...
    And I click on "#btn-local_biz_cart-main-1" "css_element"
    Given I log in as "admin"
    And I visit "/admin/category.php?category=local_biz_cart"
    And I set the following fields to these values:
      | s_local_biz_cart_rounddiscounts | 0 |
    And I press "Save changes"
    And I visit "/local/biz_cart/cashier.php"
    And I set the field "Select a user..." to "Username1"
    And I should see "Username1 Test"
    ...
    And I press "Save changes"
    And I click on "#biz_cart-cashiers-section #checkout-btn" "css_element"
    Then I should see "7.50 EUR" in the "#biz_cart-cashiers-section .sc_totalprice" "css_element"
    And I click on "#biz_cart-cashiers-section .btn_cashpayment" "css_element"
    Then I should see "Payment successful" in the "div.payment_message_result" "css_element"
    And I reload the page
    And I wait until the page is ready
