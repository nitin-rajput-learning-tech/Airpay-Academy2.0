...
(async() => {
    cashoutsuccess = await getString('cashoutsuccess', 'local_biz_cart');
    cashtransfersuccess = await getString('cashtransfersuccess', 'local_biz_cart');
})();
...
export function cashoutModal(button) {
    ...
    const modalForm = new ModalForm({
        ...
        formClass: "local_biz_cart\\form\\modal_cashout",
        // Add as many arguments as you need, they will be passed to the form:
        args: {},
        // Pass any configuration settings to the modal dialogue, for example, the title:
        modalConfig: {title: getString('cashout', 'local_biz_cart')},
...
export function cashtransferModal(button) {
    ...
    const modalForm = new ModalForm({
        ...
        // Name of the class where form is defined (must extend \core_form\dynamic_form):
        formClass: "local_biz_cart\\form\\modal_cashtransfer",
        // Add as many arguments as you need, they will be passed to the form:
        args: {},
        // Pass any configuration settings to the modal dialogue, for example, the title:
        modalConfig: {title: getString('cashtransfer', 'local_biz_cart')},
        // DOM element that should get the focus after the modal dialogue is closed:
        returnFocus: button
    });
