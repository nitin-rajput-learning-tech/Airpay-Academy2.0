...
if ($hassiteconfig) {
    ...
    $settings->add(
        new admin_setting_configcheckbox($componentname . '/bookingfeeonlyonce',
            get_string('bookingfeeonlyonce', 'local_biz_cart'),
            get_string('bookingfeeonlyonce_desc', 'local_biz_cart'), 1));

    // Setting to round percentage discounts to full integers.
    $settings->add(
        new admin_setting_configcheckbox($componentname . '/rounddiscounts',
            get_string('rounddiscounts', 'local_biz_cart'),
            get_string('rounddiscounts_desc', 'local_biz_cart'), 1));

    // Setting to round percentage discounts to full integers.
    $settings->add(
        new admin_setting_configcheckbox($componentname . '/allowrebooking',
            get_string('allowrebooking', 'local_biz_cart'),
            get_string('allowrebooking_desc', 'local_biz_cart'), 0));
    ...
    $settings->add(
        new admin_setting_configcheckbox($componentname . '/samecostcenter',
            get_string('samecostcenter', 'local_biz_cart'),
            get_string('samecostcenter_desc', 'local_biz_cart'), 0));

    // Setting to activate manual rebooking for cashier.
    $settings->add(
        new admin_setting_configcheckbox($componentname . '/manualrebookingisallowed',
            get_string('manualrebookingisallowed', 'local_biz_cart'),
            get_string('manualrebookingisallowed_desc', 'local_biz_cart'), 0));
    ...
    $settings->add(
        new admin_setting_configcheckbox($componentname . '/accepttermsandconditions',
            get_string('accepttermsandconditions', 'local_biz_cart'),
            get_string('accepttermsandconditions:description', 'local_biz_cart'), 0));
    ...
    '<table cellpadding="5" cellspacing="0" style="width: 100%; ">
        ...
        <tr>
            <td style="font-size:1.3em; font-weight: bold;">
                <br><br>
                ' . get_string('receipt:bookingconfirmation', 'local_biz_cart') . '<br>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="text-align: left;">' .
    get_string('receipt:transactionno', 'local_biz_cart') . ': [[id]]</td>
        </tr>
        <tr>
            <td colspan="2" style="text-align: left;">
    ...
    <table cellpadding="5" cellspacing="0" style="width: 100%;" border="0">
        <tr style="background-color: #cccccc; padding:5px;">
            ...
            <td style="text-align: left; width: 40%;"><b>' . get_string('receipt:name', 'local_biz_cart') . '</b></td>
            <td style="text-align: left; width: 15%;"><b>' . get_string('receipt:location', 'local_biz_cart') . '</b></td>
            <td style="text-align: left; width: 15%;"><b>' . get_string('receipt:dayofweektime', 'local_biz_cart') . '</b></td>
            <td style="text-align: center; width: 20%;"><b>' . get_string('receipt:price', 'local_biz_cart') . '</b></td>
        </tr>
        [[items]]
        <tr>
        ...
        <table cellpadding="5" cellspacing="0" style="width: 100%;" border="0">
        <tr>
        <td colspan="3"><b>' . get_string('receipt:total', 'local_biz_cart') . ': </b></td>
    ...
    $fileid = 'local_biz_cart_receiptimage';
    $name = 'local_biz_cart/receiptimage';
    $title = get_string('receiptimage', 'local_biz_cart');
    $description = get_string('receiptimage:description', 'local_biz_cart');
    $opts = ['accepted_types' => ['.png', '.jpg'], 'maxfiles' => 1];
    $setting = new admin_setting_configstoredfile($name, $title, $description, $fileid, 0, $opts);
    $settings->add($setting);

    // Cancellation settings.
    $cancellationsettings = new admin_settingpage('local_biz_cart_cancellation_settings',
        get_string('cancellationsettings', 'local_biz_cart'));
    ...
    $cancellationsettings->add(
        new admin_setting_configcheckbox($componentname . '/calculateconsumation',
            get_string('calculateconsumation', 'local_biz_cart'),
            get_string('calculateconsumation_desc', 'local_biz_cart'), 0));

    $fixedpercentages[-1] = get_string('nofixedpercentage', 'local_biz_cart');
    ...
    $cancellationsettings->add(
        new admin_setting_configselect($componentname . '/calculateconsumationfixedpercentage',
            get_string('calculateconsumationfixedpercentage', 'local_biz_cart'),
            get_string('calculateconsumationfixedpercentage_desc', 'local_biz_cart'), -1, $fixedpercentages));

    $cancellationsettings->add(
        new admin_setting_configcheckbox($componentname . '/fixedpercentageafterserviceperiodstart',
            get_string('fixedpercentageafterserviceperiodstart', 'local_biz_cart'),
            get_string('fixedpercentageafterserviceperiodstart_desc', 'local_biz_cart'), 1));

    $cancellationsettings->add(
        new admin_setting_configcheckbox($componentname . '/allowrebookingcredit',
            get_string('allowrebookingcredit', 'local_biz_cart'),
            get_string('allowrebookingcredit_desc', 'local_biz_cart'), 0));

    $ADMIN->add($componentname, $cancellationsettings);

    // Cash report settings.
    $cashreportsettings = new admin_settingpage('local_biz_cart_cashreport_settings',
        get_string('cashreportsettings', 'local_biz_cart'));
    $cashreportsettings->add(
        new admin_setting_configcheckbox($componentname . '/cashreportshowcustomorderid',
            get_string('cashreport:showcustomorderid', 'local_biz_cart'),
            get_string('cashreport:showcustomorderid_desc', 'local_biz_cart'), 0));
    $cashreportsettings->add(
        new admin_setting_configcheckbox($componentname . '/showdailysums',
            get_string('showdailysums', 'local_biz_cart'),
            '', 1));
    $cashreportsettings->add(
        new admin_setting_configcheckbox($componentname . '/showdailysumscurrentcashier',
            get_string('showdailysumscurrentcashier', 'local_biz_cart'),
            '', 1));
    ...
    $limitopts = [
        '0' => get_string('nolimit', 'local_biz_cart'),
        '10' => '10',
        '50' => '50',
        '100' => '100',
        '500' => '500',
    ...
    $cashreportsettings->add(new admin_setting_configselect('local_biz_cart/downloadcashreportlimit',
        get_string('downloadcashreportlimit', 'local_biz_cart'),
        get_string('downloadcashreportlimitdesc', 'local_biz_cart'),
        '10000', // Default value.
        $limitopts
    ));
    ...
    $taxsettings = new admin_settingpage('local_biz_cart_tax_settings', get_string('taxsettings', 'local_biz_cart'));
    $taxsettings->add(
        new admin_setting_configcheckbox($componentname . '/enabletax',
            get_string('enabletax', 'local_biz_cart'),
            get_string('enabletax_desc', 'local_biz_cart'), 0));

    $taxprocessingenabled = get_config('local_biz_cart', 'enabletax') == 1;
    ...
    $settings->add(new admin_setting_heading('local_biz_cart/invoicingplatformheading',
        get_string('invoicingplatformheading', 'local_biz_cart'),
        get_string('invoicingplatformdescription', 'local_biz_cart')
    ));
    ...
    $options = [
        'erpnext' => get_string('erpnext', 'local_biz_cart'),
        'noinvoice' => get_string('noselection', 'form'),
    ];
    $settings->add(new admin_setting_configselect('local_biz_cart/invoicingplatform',
        get_string('chooseplatform', 'local_biz_cart'),
        get_string('chooseplatformdesc', 'local_biz_cart'),
        'noinvoice', // Default value.
        $options
    ));

    // Add a text field for the Base URL.
    $settings->add(new admin_setting_configtext('local_biz_cart/baseurl',
        get_string('baseurl', 'local_biz_cart'),
        get_string('baseurldesc', 'local_biz_cart'),
        '',
        PARAM_URL
    ));

    // Add a text field for the Token.
    $settings->add(new admin_setting_configtext('local_biz_cart/token',
        get_string('token', 'local_biz_cart'),
        get_string('tokendesc', 'local_biz_cart'),
        '',
        PARAM_TEXT
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'local_biz_cart/defaultcountry',
        get_string('choosedefaultcountry', 'local_biz_cart'),
        get_string('choosedefaultcountrydesc', 'local_biz_cart'),
        'Austria', // Default value (empty for none selected).
        $newcountries
    ));

    // Add a heading for the section.
    $settings->add(new admin_setting_heading('local_biz_cart/privacyheading',
        get_string('privacyheading', 'local_biz_cart'),
        get_string('privacyheadingdescription', 'local_biz_cart')
    ));

    // Setting to round percentage discounts to full integers.
    $settings->add(
        new admin_setting_configcheckbox($componentname . '/deleteledger',
            get_string('deleteledger', 'local_biz_cart'),
            get_string('deleteledgerdescription', 'local_biz_cart'), 0));
}
