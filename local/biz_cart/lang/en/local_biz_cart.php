...
// Capabilities.
$string['biz_cart:canbuy'] = 'Can buy';
$string['biz_cart:history'] = 'See History';
$string['biz_cart:cashier'] = 'Is a cashier';
$string['biz_cart:cashiermanualrebook'] = 'Can manually rebook users';
$string['biz_cart:cashtransfer'] = 'Can transfer cash from one cashier to another';
...
// Access.php.
$string['local/biz_cart:cashier'] = 'User has cashier rights';
...
$string['item_deleted'] = 'Course removed from cart';
...
// GDPR.
$string['privacy:metadata:local_biz_cart_history'] = 'Shopping Cart History';
$string['privacy:metadata:local_biz_cart_history:userid'] = 'Userid of the user who optained something.';
$string['privacy:metadata:local_biz_cart_history:itemid'] = 'Id of the item bought.';
$string['privacy:metadata:local_biz_cart_history:itemname'] = 'Name of the item bought';
$string['privacy:metadata:local_biz_cart_history:price'] = 'Item price.';
$string['privacy:metadata:local_biz_cart_history:tax'] = 'Tax applied to this item';
$string['privacy:metadata:local_biz_cart_history:taxpercentage'] = 'Tax applied to this item price in percent float';
$string['privacy:metadata:local_biz_cart_history:fee'] = 'Fees are only saved during cancelation';
$string['privacy:metadata:local_biz_cart_history:taxcategory'] = 'Tax category defined for this item.';
$string['privacy:metadata:local_biz_cart_history:discount'] = 'Applied discount.';
$string['privacy:metadata:local_biz_cart_history:credits'] = 'Credits used for payment.';
$string['privacy:metadata:local_biz_cart_history:currency'] = 'Currency in which it was paid.';
$string['privacy:metadata:local_biz_cart_history:componentname'] = 'Component which provided the item.';
$string['privacy:metadata:local_biz_cart_history:identifier'] = 'Identifier of the cart checkout process.';
$string['privacy:metadata:local_biz_cart_history:payment'] = 'Type of payment.';
$string['privacy:metadata:local_biz_cart_history:paymentstatus'] = 'Was the transaction successful or not?';
$string['privacy:metadata:local_biz_cart_history:usermodified'] = 'The user who effected the transaction.';
$string['privacy:metadata:local_biz_cart_history:timecreated'] = 'Time this entry was created.';
$string['privacy:metadata:local_biz_cart_history:timemodified'] = 'Time this entry was modified.';
$string['privacy:metadata:local_biz_cart_history:canceluntil'] = 'Time until cancel.';
$string['privacy:metadata:local_biz_cart_history:serviceperiodstart'] = 'The period over which an item is consumed';
$string['privacy:metadata:local_biz_cart_history:serviceperiodend'] = 'The period over which an item is consumed';
$string['privacy:metadata:local_biz_cart_history:area'] = 'One component can provide different areas with independent ids.';
$string['privacy:metadata:local_biz_cart_history:usecredit'] = 'Store if credits have been used for the payment of this item.';
$string['privacy:metadata:local_biz_cart_history:costcenter'] = 'The cost center of the bought item if provided by the item plugin.';
$string['privacy:metadata:local_biz_cart_history:balance'] = 'Balance after this booking.';
$string['privacy:metadata:local_biz_cart_history:annotiation'] = 'Annotation or OrderID.';
$string['privacy:metadata:local_biz_cart_history:invoiceid'] = 'Invoice ID from the invoicing platform';

$string['privacy:metadata:local_biz_cart_credits'] = 'Shopping Cart Credits';
$string['privacy:metadata:local_biz_cart_credits:userid'] = 'Userid of the concerned user.';
$string['privacy:metadata:local_biz_cart_credits:credits'] = 'Credits.';
$string['privacy:metadata:local_biz_cart_credits:currency'] = 'Currency in which it was paid.';
$string['privacy:metadata:local_biz_cart_credits:balance'] = 'Balance after this booking.';
$string['privacy:metadata:local_biz_cart_credits:usermodified'] = 'The user who effected the transaction.';
$string['privacy:metadata:local_biz_cart_credits:timecreated'] = 'Time this entry was created.';
$string['privacy:metadata:local_biz_cart_credits:timemodified'] = 'Time this entry was modified.';

$string['privacy:metadata:local_biz_cart_ledger'] = 'This ledger only supports insert and works as a reliable record of all payments.';
$string['privacy:metadata:local_biz_cart_ledger:userid'] = 'Id of the user who bought the item.';
$string['privacy:metadata:local_biz_cart_ledger:itemid'] = 'Id of the bought item.';
$string['privacy:metadata:local_biz_cart_ledger:itemname'] = 'Name of the item bought';
$string['privacy:metadata:local_biz_cart_ledger:price'] = 'The actually paid price of the item';
$string['privacy:metadata:local_biz_cart_ledger:tax'] = 'Tax applied to this item';
$string['privacy:metadata:local_biz_cart_ledger:taxpercentage'] = 'Tax applied to this item price in percent float';
$string['privacy:metadata:local_biz_cart_ledger:taxcategory'] = 'Tax category defined for this item.';
$string['privacy:metadata:local_biz_cart_ledger:discount'] = 'Given discount in absolute amount.';
$string['privacy:metadata:local_biz_cart_ledger:credits'] = 'Credits used for payment.';
$string['privacy:metadata:local_biz_cart_ledger:fee'] = 'Fees are only saved during cancelation, when price goes back to the user, but a cancelation fee is kept.';
$string['privacy:metadata:local_biz_cart_ledger:currency'] = 'Currency which was used to pay this item.';
$string['privacy:metadata:local_biz_cart_ledger:componentname'] = 'Name of the component which provided the item, like mod_booking.';
$string['privacy:metadata:local_biz_cart_ledger:costcenter'] = 'The cost center of the bought item if provided by the item plugin.';
$string['privacy:metadata:local_biz_cart_ledger:identifier'] = 'The identifier is used during checkout to identify a whole cart.';
$string['privacy:metadata:local_biz_cart_ledger:payment'] = 'The type of payment.';
$string['privacy:metadata:local_biz_cart_ledger:paymentstatus'] = 'Was the transaction successful or not?';
$string['privacy:metadata:local_biz_cart_ledger:accountid'] = 'Id of the moodle payment account used.';
$string['privacy:metadata:local_biz_cart_ledger:usermodified'] = 'Which user actually effectuated the transaction';
$string['privacy:metadata:local_biz_cart_ledger:timemodified'] = 'The time modified';
$string['privacy:metadata:local_biz_cart_ledger:timecreated'] = 'The time created';
$string['privacy:metadata:local_biz_cart_ledger:canceluntil'] = 'The cancel until time';
$string['privacy:metadata:local_biz_cart_ledger:area'] = 'One component can provide different areas with independent ids.';
$string['privacy:metadata:local_biz_cart_ledger:annotation'] = 'Annotation or OrderID.';

$string['privacy:metadata:local_biz_cart_invoices'] = 'Table for issued invoices';
$string['privacy:metadata:local_biz_cart_invoices:identifier'] = 'Reference to local_biz_cart_ledger';
...
$string['confirm_item_delete'] = 'Are you sure you want to remove course from cart ?';
...
$string['user_fullname'] = 'User Fullname';
$string['event'] = 'Event';
$string['message'] = 'Message';
$string['action'] = 'Action';
$string['orderid'] = 'Order ID';
$string['ordermethod'] = 'Order Method';
