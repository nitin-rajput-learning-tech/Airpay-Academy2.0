...
// Capabilities.
$string['biz_cart:canbuy'] = 'Kann kaufen';
$string['biz_cart:history'] = 'Verlauf (History) anzeigen';
$string['biz_cart:cashier'] = 'Ist berechtigt für die Kassa';
$string['biz_cart:cashiermanualrebook'] = 'Kann Benutzer:innen manuell nachbuchen';
$string['biz_cart:cashtransfer'] = 'Kann Bargeld von einer Kassa auf eine andere Kassa umbuchen';
...
// Access.php.
$string['local/biz_cart:cashier'] = 'NutzerIn hat Kassier-Rechte';
