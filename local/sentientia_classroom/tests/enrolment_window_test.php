 ...
 *
 * Mirrors `local_sentientia_learningpath\enrolment_window_test` to make sure
...
final class enrolment_window_test extends \advanced_testcase {
    ...
    public function test_create_persists_dates(): void {
        ...
        $row = $DB->get_record('local_sentientia_classroom', ['id' => $cid], '*', MUST_EXIST);
    ...
    public function test_form_validation_rejects_end_before_start(): void {
        ...
        $form = new \local_sentientia_classroom\form\edit_classroom();
