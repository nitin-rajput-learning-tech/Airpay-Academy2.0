...
namespace local_sentientia_classroom\event;
...
class classroom_completed extends \core\event\base {
    ...
    protected function init(): void {
        ...
        $this->data['objecttable'] = 'local_sentientia_classroom';
    }

    public static function get_name(): string {
        return get_string('event_classroom_completed', 'local_sentientia_classroom');
    }
