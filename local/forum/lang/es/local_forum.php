...
$string['createnewcourse']='<i class="icon popupstringicon fa fa-comments-o" aria-hidden="true"></i>Crear curso <div class="popupstring">Aquí puedes crear un curso';
$string['editcourse']='<i class="icon popupstringicon fa fa-comments-o" aria-hidden="true"></i>Actualizar curso <div class="popupstring">Aquí puedes actualizar el curso';
...
$string['addcategory']='<i class="fa fa-comments-o popupstringicon" aria-hidden="true"></i><i class="fa fa-comments-o secbook popupstringicon cat_pop_icon" aria-hidden="true"></i> Crear nueva categoría <div class="popupstring"></div>';
$string['editcategory']='<i class="fa fa-comments-o popupstringicon" aria-hidden="true"></i><i class="fa fa-comments-o secbook popupstringicon cat_pop_icon" aria-hidden="true"></i> Actualizar categoría <div class="popupstring"></div>';
