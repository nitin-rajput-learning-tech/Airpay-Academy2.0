...
$string['createforum'] = '<i class="icon popupstringicon fa fa-book" aria-hidden="true"></i>Create Forum <div class="popupstring">Here you can create Forum</div>';
$string['editforum'] = '<i class="icon popupstringicon fa fa-book" aria-hidden="true"></i>Update Forum <div class="popupstring">Here you can update Forum</div>';
