...
//
// Run: php public/local/sentientia_evaluation/cli/smoke_anonymous_question.php
//
...
$row = $DB->get_record('local_sentientia_evaluation_questions', ['id' => $q2]);
...
$resp_id = $DB->insert_record('local_sentientia_evaluation_responses', (object) [
    'evaluationid'  => $evalid,
    'userid'        => $user->id,
