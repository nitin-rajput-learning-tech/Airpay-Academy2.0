...
//
// Reads the local_sentientia_evaluation_assign table P1 #37 created;
...
$count_responded = count(\local_sentientia_evaluation\evaluation_manager::list_assignments(
...
$data = [
    ...
    'tab_pending_url'   => (new moodle_url('/local/sentientia_evaluation/non_respondents.php',
        ['id' => $evaluationid, 'tab' => 'pending']))->out(false),
    'tab_responded_url' => (new moodle_url('/local/sentientia_evaluation/non_respondents.php',
...
$PAGE->requires->js_call_amd(
    'local_sentientia_evaluation/non_respondents_actions', 'init');

echo $OUTPUT->header();
echo $OUTPUT->render_from_template(
    'local_sentientia_evaluation/non_respondents', $data);
echo $OUTPUT->footer();
