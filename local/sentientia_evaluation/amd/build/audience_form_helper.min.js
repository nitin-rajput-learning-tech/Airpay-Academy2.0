 ...
 * evaluation admin UI. Sibling of `local_sentientia_classroom/audience_form_helper`
 * (P1 #13) and `local_sentientia_programs/audience_form_helper` (P1 #14) —
 ...
 *      `local_sentientia_evaluation_preview_audience` (P1 #39's WS).
 *
 * @module local_sentientia_evaluation/audience_form_helper
 */
...
define(['core/ajax', 'core/notification'], function(Ajax, Notification) {
    ...
    function refreshPreview(root) {
        ...
        Ajax.call([{
            methodname: 'local_sentientia_evaluation_preview_audience',
