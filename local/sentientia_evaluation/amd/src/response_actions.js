...
// @module     local_sentientia_evaluation/response_actions
...
const submit = async (root) => {
    ...
    if (missing) {
        ...
        const msg = await getString('please_answer_required', 'local_sentientia_evaluation');
    ...
    try {
        await Ajax.call([{
            methodname: 'local_sentientia_evaluation_submit_response',
            args: {
        ...
        const success = await getString('response_submitted', 'local_sentientia_evaluation');
