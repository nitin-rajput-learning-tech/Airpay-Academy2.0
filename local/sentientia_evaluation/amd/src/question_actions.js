...
const confirmDelete = async (questionid, returnFocus) => {
    const [title, message, label, success] = await Promise.all([
        getString('deletequestion', 'local_sentientia_evaluation'),
        getString('confirmdeletequestion', 'local_sentientia_evaluation'),
        getString('delete', 'core'),
        getString('questiondeleted', 'local_sentientia_evaluation'),
    ]);
...
const saveOrder = async (root) => {
    ...
    try {
        ...
        const success = await getString('orderupdated', 'local_sentientia_evaluation');
        Notification.addNotification({message: success, type: 'success'});
