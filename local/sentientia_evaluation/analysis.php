...
//
// URL: /local/sentientia_evaluation/analysis.php
...
$PAGE->set_url(new moodle_url('/local/sentientia_evaluation/analysis.php'));
...
$summary = \local_sentientia_evaluation\evaluation_manager::get_kirkpatrick_summary($filters);
...
$reset_url = (new moodle_url('/local/sentientia_evaluation/analysis.php'))->out(false);
...
$data = [
    ...
    // Filter form context.
    'filter_action_url'   => (new moodle_url('/local/sentientia_evaluation/analysis.php'))->out(false),
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_sentientia_evaluation/analysis', $data);
echo $OUTPUT->footer();
