...
class bulk_assign_audience_form extends \core_form\dynamic_form {
    ...
    protected function definition() {
        ...
        $mform->addElement('static', 'preview', '',
            ...
            . get_string('audience_users_matched', 'local_sentientia_evaluation')
    ...
    protected function get_page_url_for_dynamic_submission(): \moodle_url {
        $evaluationid = (int) $this->optional_param('evaluationid', 0, PARAM_INT);
        return new \moodle_url('/local/sentientia_evaluation/non_respondents.php',
            ['id' => $evaluationid]);
    }

    private function get_cohort_options(): array {
        global $DB;
        $options = [0 => get_string('audience_any_cohort', 'local_sentientia_evaluation')];
