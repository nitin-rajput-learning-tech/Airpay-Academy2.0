...
class privacy_manager {
    ...
    private static function notify_admin_of_request(int $userid, string $type, int $requestid): void {
            ...
            try {
                $html = \local_sentientia_emails\email_renderer::render(
                    'local_sentientia_emails/privacy/deletion_request_admin', [
                        ...
                        'admin_url'        => (new \moodle_url('/local/sentientia_privacy/index.php'))->out(false),
        ...
        foreach ($admins as $admin) {
            ...
            $message->component         = 'local_sentientia_privacy';
            ...
            $message->contexturl        = new \moodle_url('/local/sentientia_privacy/index.php');
