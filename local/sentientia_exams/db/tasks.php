...
// parity-audit-2026-05-15/sentientia_exams.md (exam-side mirror of P1
...
$tasks = [
    [
        'classname' => '\\local_sentientia_exams\\task\\exam_reminder',
        'blocking'  => 0,
        'minute'    => '15',
        'hour'      => '9',
        'day'       => '*',
    ...
    // configured.
    [
        'classname' => '\\local_sentientia_exams\\task\\exam_overdue',
        'blocking'  => 0,
        'minute'    => '45',
        'hour'      => '9',
        'day'       => '*',
