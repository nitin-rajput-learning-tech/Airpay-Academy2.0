...
const openExamForm = async (examid, returnFocus) => {
    ...
    const title = await getString(titleKey, 'local_sentientia_exams');
...
const confirmStatus = async (examid, name, makeActive, returnFocus) => {
    ...
    const [title, message, success] = await Promise.all([
        getString(titleKey, 'local_sentientia_exams'),
        getString(msgKey, 'local_sentientia_exams', name),
        getString('examstatuschanged', 'local_sentientia_exams'),
    ]);
...
const confirmDelete = async (examid, name, returnFocus) => {
    const [title, message, label, success] = await Promise.all([
        getString('deleteexam', 'local_sentientia_exams'),
        getString('confirmdelete', 'local_sentientia_exams', name),
        getString('delete', 'core'),
        getString('examdeleted', 'local_sentientia_exams'),
    ]);
