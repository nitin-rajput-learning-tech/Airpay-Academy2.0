...
//
// P1 #36 (2026-05-20) — Hindi (hi) translations for local_sentientia_exams.
...
$string['reminder_enabled_help']          = 'बंद होने पर (डिफ़ॉल्ट) टास्क निष्क्रिय। चालू होने पर दैनिक चलता है, परीक्षा timeclose के निकट सीखने वालों को सूचनाएँ भेजता है, और <code>local_sentientia_exams_remind_sent</code> के माध्यम से डी-डुप करता है।';
...
$string['reminder_last_run_never']        = 'परीक्षा-समय-सीमा-रिमाइंडर क्रॉन कभी नहीं चला। टास्क सक्षम करें या <code>php admin/cli/scheduled_task.php --execute=\\\\local_sentientia_exams\\\\task\\\\exam_reminder</code> चलाएँ।';
...
— {$a->sitename}';
$string['reminder_body_html']    = '<p>नमस्ते,</p><p>यह एक रिमाइंडर है कि परीक्षा <strong>{$a->examname}</strong> (कोर्स: {$a->coursename}) <strong>{$a->deadline}</strong> को बंद हो रही है — अब से {$a->days_remaining} दिन।</p><p><a href="{$a->exam_url}">परीक्षा दें</a></p><p style="color:#777;">— {$a->sitename}</p>';
...
$string['overdue_last_run_never']    = 'परीक्षा पर्यवेक्षक-एस्केलेशन क्रॉन कभी नहीं चला। टास्क सक्षम करें या <code>php admin/cli/scheduled_task.php --execute=\\\\local_sentientia_exams\\\\task\\\\exam_overdue</code> चलाएँ।';
