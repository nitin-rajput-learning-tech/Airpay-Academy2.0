...
$string['sentientia_manager:view']     = 'View team dashboard + requests + allocations';
$string['sentientia_manager:approve']  = 'Approve / reject enrolment requests';
$string['sentientia_manager:allocate'] = 'Assign courses to direct reports';
