...
$string['sentientia_programs:manage'] = 'Manage certification programs';
$string['sentientia_programs:enrol']  = 'Enrol into programs';
$string['sentientia_programs:create'] = 'Create programs';
$string['sentientia_programs:update'] = 'Edit programs';
$string['sentientia_programs:delete'] = 'Delete programs';
