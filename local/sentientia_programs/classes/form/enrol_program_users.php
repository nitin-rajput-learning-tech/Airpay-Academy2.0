...
class enrol_program_users extends \core_form\dynamic_form {
    ...
    protected function definition() {
        ...
        $already = [];
        if ($DB->get_manager()->table_exists('local_sentientia_programs_users')) {
            $already = $DB->get_fieldset_select('local_sentientia_programs_users',
        ...
        $mform->addElement('select', 'userids',
            get_string('enrol_users', 'local_sentientia_programs'),
            $options,
    ...
    public function process_dynamic_submission() {
        ...
        \local_sentientia_programs\program_manager::require_users_in_scope($userids);

        $count = \local_sentientia_programs\program_manager::enrol_users($programid, $userids);

        return [
            'programid' => $programid,
            'enrolled'  => $count,
            'message'   => get_string('users_enrolled_success', 'local_sentientia_programs', $count),
        ];
    }
    ...
    protected function check_access_for_dynamic_submission(): void {
        require_capability('local/sentientia_programs:enrol', $this->get_context_for_dynamic_submission());
