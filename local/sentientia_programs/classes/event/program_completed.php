...
namespace local_sentientia_programs\event;
 ...
 *
 *     \local_sentientia_programs\event\program_completed::create([
...
class program_completed extends \core\event\base {
    ...
    protected function init(): void {
        ...
        $this->data['objecttable'] = 'local_sentientia_programs';
    }

    public static function get_name(): string {
        return get_string('event_program_completed', 'local_sentientia_programs');
    }
