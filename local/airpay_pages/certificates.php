...
if (empty($certificates)) {
    ...
    echo '<i class="fa fa-info-circle"></i> You haven\'t earned any certificates yet. ';
    echo '<a href="' . $CFG->wwwroot . '/local/search/allcourses.php">Browse courses</a> to get started.';
    echo '</div>';
} else {
