...
$PAGE->set_url(new moodle_url('/local/sentientia_courses/enrol_csv.php'));
...
class local_sentientia_courses_enrolcsv_form extends moodleform {
...
$form = new local_sentientia_courses_enrolcsv_form();
$summary = null;
...
if ($data = $form->get_data()) {
    ...
    if ($content === false || $content === '') {
        ...
        try {
            $summary = \local_sentientia_courses\enrol_csv_processor::process(
...
if ($summary) {
    ...
    echo $OUTPUT->render_from_template(
        'local_sentientia_courses/enrol_csv_summary', $context_data);
}
