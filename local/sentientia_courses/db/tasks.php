...
// parity-audit-2026-05-15/sentientia_courses.md (BizLMS
...
$tasks = [
    [
        'classname' => '\\local_sentientia_courses\\task\\course_reminder',
        'blocking'  => 0,
        'minute'    => '0',
        'hour'      => '9',
        'day'       => '*',
    ...
    [
        'classname' => '\\local_sentientia_courses\\task\\course_overdue',
        'blocking'  => 0,
        'minute'    => '30',
        'hour'      => '9',
        'day'       => '*',
