...
class bulk_enrol_audience_form extends \core_form\dynamic_form {
    ...
    protected function definition() {
        ...
        $mform->addElement('select', 'cohortid',
            get_string('cohort', 'local_sentientia_learningpath'),
        ...
        $mform->addElement('static', 'preview', '',
            ...
            . get_string('audience_users_matched', 'local_sentientia_learningpath')
            . '<div data-airpay-audience-sample class="small text-muted mt-2"></div>'
            . '</div>');

        $this->add_action_buttons(true,
            get_string('audience_enrol_button', 'local_sentientia_learningpath'));
    }
    ...
    public function process_dynamic_submission() {
        ...
        return [
            ...
            'message'  => sprintf(
                get_string('audience_enrol_result', 'local_sentientia_learningpath'),
    ...
    protected function check_access_for_dynamic_submission(): void {
        require_capability('local/sentientia_learningpath:enrol',
    ...
    private function get_cohort_options(): array {
        global $DB;
        $options = [0 => get_string('audience_any_cohort', 'local_sentientia_learningpath')];
        // ADR-031: a scoped caller sees only cohorts with members in their own
        // tenant (the audience itself is tenant-scoped anyway); no tenant,
        // none. Until 2026-09-25 every cohort on the site was listed.
