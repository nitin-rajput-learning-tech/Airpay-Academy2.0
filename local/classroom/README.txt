...
Classroom are used to keep track of in-person trainings which
...
1- Unpack the plugin into your moodle install in order to create a
   local/classroom directory.

2- Visit the /admin/index.php page to trigger the database installation.

3- (Optional) Change the default options in the configuration.
