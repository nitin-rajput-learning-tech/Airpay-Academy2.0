...
$string['createclassroom'] = '<span class="fa fa-desktop icon">
        </span> Create Classroom <div class="popupstring">Here you will create classrooms based upon the department </div>';
$string['updateclassroom']= '<span class="fa fa-desktop icon">
        </span> Update Classroom <div class="popupstring">Here you will update classrooms based upon the department </div>';
...
$string['classroom:manage_owndepartments'] = 'Manage Own Department Classrooms.';
