...
class classroom_deleted extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
       ...
       if($classroom_name){
         return "The user with id '$firstname ($this->userid)' has deleted the classroom with id '$classroom_name ($this->objectid) '.";
       }else{
         return "The user with id '$firstname ($this->userid)' has deleted the classroom with id '$this->objectid'.";
       }
    }
    ...
    public static function get_name() {
        return get_string('eventclassroomdeleted', 'local_classroom');
    }
