...
/**
 * The local_classroom post completed event class.
 *
...
class classroom_completed extends \core\event\base {
    ...
    public function get_description() {
        ...
        $classroomname = $DB->get_field_sql("SELECT name FROM {local_classroom} where id=$this->objectid");
        if ($classroomname) {
            return "The user with id '$firstname ($this->userid)' has completed the classroom with id '$classroomname ($this->objectid) '.";
        } else {
            return "The user with id '$firstname ($this->userid)' has completed the classroom with id '$this->objectid'.";
        }
    }
    /**
    ...
    public static function get_name() {
        return get_string('eventclassroomcompleted', 'local_classroom');
    }
    /**
