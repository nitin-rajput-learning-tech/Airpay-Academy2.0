...
use stdclass;
class classroom_cancel extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if ($classroomname) {
            return "The user with id '$firstname ($this->userid)' has cancel the classroom with id '$classroomname ($this->objectid) '.";
        } else {
            return "The user with id '$firstname ($this->userid)' has cancel the classroom with id '$this->objectid'.";
        }
    }
    /**
    ...
    public static function get_name() {
        return get_string('eventclassroomcancel', 'local_classroom');
    }
    /**
