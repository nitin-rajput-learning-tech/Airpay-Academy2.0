...
class classroom_updated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($classroom_name){
            return "The user with id '$firstname ($this->userid)' has updated the classroom with id '$classroom_name ($this->objectid) '.";
        }else{
            return "The user with id '$firstname ($this->userid)' has updated the classroom with id '$this->objectid'.";
        }
    ...
    public static function get_name() {
        return get_string('eventclassroomupdated', 'local_classroom');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'classroom', 'update classroom', $logurl, $this->objectid, $this->contextinstanceid);
    }
