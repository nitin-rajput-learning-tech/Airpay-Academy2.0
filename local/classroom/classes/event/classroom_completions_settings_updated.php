...
class classroom_completions_settings_updated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($classroom_id){
             ...
             return "The user with id '$firstname ($this->userid)' has updated the classroom completions setting with id '$classroom_name ($classroom_id) '.";
        }else{
             return "The user with id '$firstname ($this->userid)' has updated the classroom completions setting with id '$this->objectid'.";
        }
    ...
    public static function get_name() {
        return get_string('eventclassroomcompletions_settings_updated', 'local_classroom');
    }
