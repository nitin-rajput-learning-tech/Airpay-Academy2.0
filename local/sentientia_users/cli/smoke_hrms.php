...
//
// Usage:  php local/sentientia_users/cli/smoke_hrms.php
//
...
$header = implode(',', \local_sentientia_users\hrms_importer::STANDARD_COLUMNS);
$rows = [
...
$run_id = \local_sentientia_users\hrms_importer::import_csv($csv, $caller_userid,
    'smoke_test.csv', 'web');
...
$run_id2 = \local_sentientia_users\hrms_importer::import_csv($csv, $caller_userid,
    'smoke_test.csv', 'web');
$run2 = $DB->get_record('local_sentientia_users_sync_runs', ['id' => $run_id2]);
