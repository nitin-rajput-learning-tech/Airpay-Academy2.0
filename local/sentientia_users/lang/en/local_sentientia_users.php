...
$string['sentientia_users:view'] = 'View user profiles';
$string['sentientia_users:bulkstatuschange'] = 'Bulk status change';
...
$string['activeregistration_help'] = 'When enabled, users can sign up at /local/sentientia_users/signup.php. New accounts go to the Public tenant by default (configurable below).';
