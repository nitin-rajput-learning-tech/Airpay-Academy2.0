...
// N1 (2026-09-24) — दूसरे यूज़र की प्रोफ़ाइल के लिए एकमात्र अस्वीकृति संदेश।
$string['error_profilenotavailable'] = 'यह प्रोफ़ाइल आपके लिए उपलब्ध नहीं है।';
// ADR-031 (2026-09-25).
$string['invalidtenant']          = 'आपका अकाउंट किसी संगठन से जुड़ा नहीं है, इसलिए यह कार्रवाई आपके लिए उपलब्ध नहीं है।';
$string['outoftenant']            = 'वह संगठन आपके अपने टेनेंट से बाहर है।';
$string['cannotsuspendself']      = 'आप अपना अकाउंट निलंबित नहीं कर सकते।';
