...
/**
 * Bridge between the sentientia_emails sender pipeline and the bundled
 ...
 *
 * The temp directory used here is `$CFG->tempdir/sentientia_emails/`,
...
class certificate_helper {
    ...
    public static function materialise_pdf(\stdClass $issue): ?array {
        ...
        $tmpdir = $CFG->tempdir . '/sentientia_emails';
        if (!is_dir($tmpdir)) {
