...
$string['setting_lrs_rate_limit']      = 'LRS rate limit (requests per window)';
$string['setting_lrs_rate_limit_desc'] = 'Maximum number of /lrs/statements requests a single authenticated client (registered client credential, or the site-wide fallback token/basic credential) may make per window. Default: 600.';
$string['setting_lrs_rate_window']     = 'LRS rate limit window (seconds)';
$string['setting_lrs_rate_window_desc'] = 'Length of the fixed rate-limit window in seconds. Default: 60 (so the default is 600 requests per 60 seconds per client).';
...
$string['error_lrs_ratelimited']    = 'Rate limit exceeded: this client is limited to {$a} requests per window. Try again after the Retry-After period.';
...
$string['privacy:metadata:local_sentientia_xapi_statements:timestored'] = 'Timestamp when the statement was stored in the LRS.';
