...
$pageurl = new moodle_url('/local/evaluation/userdashboard.php',array('tab' => $tab));
$PAGE->set_url($pageurl);
$PAGE->set_pagelayout('standard');
$PAGE->set_context($systemcontext);
$heading = get_string($tab.'_evaluation', 'local_evaluation');
...
$filterparams = $renderer->get_userdashboard_evaluation($tab, true,$formattype);
echo $OUTPUT->header();
 $display_url = new moodle_url('/local/evaluation/userdashboard.php',array('tab' => $tab,'formattype' => $formattype_url));  
...
echo $OUTPUT->render_from_template('local_evaluation/userdashboard_inner_tab', array());
echo $OUTPUT->render_from_template('local_costcenter/global_filter', $filterparams);
$content = $renderer->get_userdashboard_evaluation($tab,false,$formattype);
