...
/**
 * The local_evaluation enrolled event.
 *
...
class evaluation_enrolled extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
...
//        return "The user with id '$this->userid' enrolled the user with id '$this->userid' to the feedback of id '$this->objectid'.";
        return get_string('user_enrolled_feedback', 'local_evaluation', $stringHelpers);        
    }
    ...
    public static function get_name() {
        return get_string('eventevaluationenrolled', 'local_evaluation');
    }
