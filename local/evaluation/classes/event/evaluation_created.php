...
/**
 * The local_evaluation created event.
 *
...
//        return "The user with id '$this->userid' has created the feedback with id '$this->objectid'.";
        return get_string('user_created_feedback', 'local_evaluation', $stringHelpers);
    }
    ...
    public static function get_name() {
        return get_string('eventevaluationcreated', 'local_evaluation');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'evaluation', 'add feedback', $logurl, $this->objectid, $this->contextinstanceid);
    }
