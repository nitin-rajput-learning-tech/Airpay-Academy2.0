    ...
    public function definition() {
        ...
        $mform->addElement('select',
                            ...
                            array('r'=>get_string('radio', 'local_evaluation'),
                                  'c'=>get_string('check', 'local_evaluation'),
        ...
        $mform->addElement('textarea', 'values', get_string('multichoice_values', 'local_evaluation'),
            'wrap="virtual" rows="10" cols="65"');

        $mform->addElement('static', 'hint', '', get_string('use_one_line_for_each_value', 'local_evaluation'));
