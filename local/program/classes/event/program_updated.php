...
//        return "The user with id '$username ($USER->id)' has updated the program with id ' $this->objectid '.";
        return get_string('user_updated_program', 'local_program', $stringHelpers);
    }
    ...
    public static function get_name() {
        return get_string('event:programupdated', 'local_program');
    }
