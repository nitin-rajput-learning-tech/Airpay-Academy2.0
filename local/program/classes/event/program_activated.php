 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class program_activated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
...
//        return "The user with id '$username ($USER->id)' has activated the program with id '$this->objectid '.";
        return get_string('user_activated_program', 'local_program', $stringHelpers);
    ...
    public static function get_name() {
        return get_string('event:programactivated', 'local_program');
    }
