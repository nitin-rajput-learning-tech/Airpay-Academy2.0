...
//        return "The user with '$username ($USER->id)' has created the program with id ' $this->objectid '.";
         return get_string('user_created_program', 'local_program', $stringHelpers);
    }
    ...
    public static function get_name() {
        return get_string('event:programcreated', 'local_program');
    }
