...
/**
 * The local_program post sessions_updated event.
 *
...
/**
 * The local_program post sessions_updated event class.
 *
 * @package    local_program
 * @since      Moodle 3.4
 * @copyright  2018 Arun Kumar M <arun@eabyas.in>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bclevelcourse_session_updated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('event:bclevelcoursesession_updated', 'local_program');
    }
