...
/**
 * @covers \local_sentientia_platform\customer::get_customer_config
 * @covers \local_sentientia_platform\customer::set_customer_config
 *
...
class customer_config_test extends \advanced_testcase {
    ...
    public function test_get_reads_canonical_config_key(): void {
        ...
        // local_sentientia_platform/customer_<id>_<key>. A value written there
        // directly (as settings.php does) must be visible to the getter.
        set_config('customer_1_aiquiz_prompt_template', 'DIRECT WRITE', 'local_sentientia_platform');
