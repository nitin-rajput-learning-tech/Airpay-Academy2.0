...
class feature_flags_test extends \advanced_testcase {
    ...
    public function test_registered_default_returns_when_no_override(): void {
        ...
        // local/sentientia_platform/db/feature_flags.php.
        $this->assertTrue(
    ...
    public function test_set_creates_override_row(): void {
        ...
        $row = $DB->get_record('local_sentientia_feature_flags',
    ...
    public function test_set_writes_audit_row(): void {
        ...
        $before = $DB->count_records('local_sentientia_feature_flag_audit',
        ...
        $after = $DB->count_records('local_sentientia_feature_flag_audit',
            ['flag_key' => 'ai.assistant.enabled']);
        ...
        $rows = $DB->get_records('local_sentientia_feature_flag_audit',
    ...
    public function test_set_with_same_value_is_noop(): void {
        ...
        $audit_count = $DB->count_records('local_sentientia_feature_flag_audit') - $before;
    ...
    public function test_all_returns_every_registered_flag(): void {
        ...
        // The 5 seeded flags from local_sentientia_platform/db/feature_flags.php
