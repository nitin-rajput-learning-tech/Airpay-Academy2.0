...
$plugin->component = 'local_sentientia_platform';
...
// from parity-audit-2026-05-15/sentientia_courses.md ("local_logs parity").
...
// Adds customer_id column to local_sentientia_feature_flags + audit table.
...
// stored under config_plugins (local_sentientia_platform/customer_<id>_<key>).
...
$plugin->version   = 2026092500;  // ADR-031: local/sentientia_platform:crosstenant + tenant::is_cross_tenant/scope_path/require_same_tenant_user
...
$plugin->release   = '1.9.0';  // +ADR-031 cross-tenant authority
...
//          + local_sentientia_feature_flags table (overrides)
//          + local_sentientia_feature_flag_audit table (history)
//          + \local_sentientia_platform\feature_flags resolver class
//          + Switchboard admin page at /local/sentientia_platform/admin/switchboard.php
