...
class tagindex implements templatable {
    ...
    public function __construct($tag, $component, $itemtype, $content,
        ...
        $a = (object)array(
            'tagarea' => \local_tags_area::display_name($component, $itemtype),
            'tag' => \local_tags_tag::make_display_name($tag)
        );
        if ($exclusivemode) {
        ...
        $url = local_tags_tag::make_url($tag->tagcollid, $tag->rawname, $exclusivemode, $fromctx, $ctx, $rec);
