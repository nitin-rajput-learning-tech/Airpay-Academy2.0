...
/**
 * Contains class local_tags_collections_table
 *
 * @package   local_tags
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class local_tags_collections_table extends html_table {
    ...
    public function __construct($pageurl) {
        ...
        foreach ($tagcolls as $tagcoll) {
            ...
            $allareas = local_tags_collection::get_areas_names(null, false);
            $validareas = local_tags_collection::get_areas_names($tagcoll->id);
            ...
            $displayname = new \local_tags\output\tagcollname($tagcoll);
            $searchable = new \local_tags\output\tagcollsearchable($tagcoll);
            $this->data[] = array(
