...
$string['allocate_confirm_allocate'] = 'Are you sure you want to Allocate selected requests?';
$string['team_request_confirm'] = 'Are you sure you want to Approve selected requests?';
$string['members'] = 'Employee Name';
...
$string['manage_myteam'] = 'My Team';
$string['myteaminfo'] = '{$a->username} {$a->moduletype} Information';
$string['allocate_search_myteam'] = 'Allocate Search MyTeam';
$string['allocate_yes'] = 'Yes';
$string['reject_no'] = 'No';
$string['myteam:approve_myteam_request_record'] = 'Myteam request';
...
$string['requestedfor'] = '{$a} has requested for ';
$string['type'] = 'Type';
$string['status'] = 'Status';
$string['completedon'] = 'Completed On';
$string['action'] = 'Action';
$string['nodata'] = 'No data available';
$string['selectausertoproceed'] = 'Select a user to proceed.';
$string['requestprocessing'] = 'Request Processing...';
$string['information'] = 'Information';
$string['learningtypeallocated'] = 'Selected learning types has been allocated.';
