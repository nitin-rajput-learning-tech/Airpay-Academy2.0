...
/**
 * Upgrade routine for local_sentientia_whatsapp.
 *
 * @param int $oldversion previously installed version
 * @return bool always true on success
 */
function xmldb_local_sentientia_whatsapp_upgrade(int $oldversion): bool {
    global $DB;
    ...
    if ($oldversion < 2026051501) {
        ...
        // ── local_sentientia_dlt_templates (iter 2) ──────────────────────
        $table = new xmldb_table('local_sentientia_dlt_templates');
        ...
        // ── local_sentientia_send_log (iter 3+) ──────────────────────────
        $table2 = new xmldb_table('local_sentientia_send_log');
        ...
        upgrade_plugin_savepoint(true, 2026051501, 'local', 'sentientia_whatsapp');
    }
    ...
    if ($oldversion < 2026052101) {
        upgrade_plugin_savepoint(true, 2026052101, 'local', 'sentientia_whatsapp');
    }
    ...
    if ($oldversion < 2026052501) {
        ...
        upgrade_plugin_savepoint(true, 2026052501, 'local', 'sentientia_whatsapp');
    }
