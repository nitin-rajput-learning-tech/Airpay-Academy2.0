...
// हिन्दी translations — local_sentientia_whatsapp
...
$string['preferences_heading']     = '{$a} आप तक कैसे पहुँचे?';
$string['preferences_intro']       = 'चुनें कि हम किन चैनलों से आपको कोर्स अपडेट, डेडलाइन रिमाइंडर और सर्टिफिकेट अलर्ट भेज सकता है। ईमेल हमेशा चालू रहता है — यह वह आधार चैनल है जो बाकी चैनलों के न पहुँच पाने पर भी संदेश पहुँचाता है।';
...
$string['dlt_consent_body']        = 'ऑप्ट-इन करके मैं TCCCPR 2018 और DPDP अधिनियम 2023 के अनुसार ऊपर चुने गए चैनलों पर {$a} से लेन-देन और सेवा संदेश प्राप्त करने पर सहमत हूँ। मैं किसी भी समय इस पृष्ठ को संपादित करके सहमति वापस ले सकता/सकती हूँ।';
