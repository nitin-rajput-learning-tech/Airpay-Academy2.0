...
class learningplan_users_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($userid){
            ...
            return "The user with id '$firstname ($this->userid)' has added user with id '$learningplan_users_name ($userid)' in the Learning Path user referenceid ($this->objectid) with id '$lpname ($learningplan_id) '.";
        
        }else{
           return "The user with id '$firstname ($this->userid)' has added user in the Learning Path with id '$this->objectid'.";
        }
    }
    ...
    public static function get_name() {
        return get_string('eventlearningplanusers_created', 'local_learningplan');
    }
    ...
    public function get_url() {
        ...
        $learningplan_id=$DB->get_field_sql("SELECT planid FROM {local_learningplan_user} where id=$this->objectid");
       if($learningplan_id){
        $url = new \moodle_url('/local/learningplan/lpusers_enroll.php',array('lpid'=>$learningplan_id));
       }else{
