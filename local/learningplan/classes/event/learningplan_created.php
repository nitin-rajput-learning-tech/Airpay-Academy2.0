...
class learningplan_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($lpname){
            return "The user with id '$firstname ($this->userid)' has created the Learning Path with id '$lpname ($this->objectid) '.";
        }else{
            return "The user with id '$firstname ($this->userid)' has created the Learning Path with id '$this->objectid'.";
        }
    ...
    public static function get_name() {
        return get_string('eventlearningplancreated', 'local_learningplan');
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['learningplanid'] = array('db' => 'local_classroom', 'restore' => 'local_classroom');
