...
$PAGE->set_url(new moodle_url('/local/sentientia_cart/index.php'));
$PAGE->set_pagelayout('standard');
$PAGE->set_title(get_string('mycart', 'local_sentientia_cart'));
$PAGE->set_heading(get_string('mycart', 'local_sentientia_cart'));
...
$data = [
    ...
    'checkout_url'   => (new moodle_url('/local/sentientia_cart/checkout.php'))->out(false),
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_sentientia_cart/cart', $data);
echo $OUTPUT->footer();
