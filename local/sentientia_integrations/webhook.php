...
$provided = $_SERVER['HTTP_X_WEBHOOK_SECRET'] ?? optional_param('secret', '', PARAM_RAW);
...
$event_type = $payload['event'] ?? $payload['eventType'] ?? optional_param('event', 'unknown', PARAM_ALPHANUMEXT);
