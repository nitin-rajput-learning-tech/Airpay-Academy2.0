...
//
// Run: php public/local/sentientia_org/cli/smoke_dsr.php [--userid=N]
//
...
// All airpay plugins.
$airpay_plugins = [
    'sentientia_users', 'sentientia_org', 'sentientia_courses', 'sentientia_evaluation',
    'sentientia_classroom', 'sentientia_programs', 'sentientia_learningpath',
    'sentientia_catalog', 'sentientia_compliance_report', 'sentientia_emails',
    'sentientia_exams', 'sentientia_integrations', 'sentientia_lifecycle',
    'sentientia_notifications', 'sentientia_analytics', 'sentientia_assistant',
    'sentientia_roles', 'sentientia_challenge', 'sentientia_manager', 'sentientia_skills',
];
