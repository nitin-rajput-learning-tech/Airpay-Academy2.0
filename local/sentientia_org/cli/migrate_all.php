 ...
 *
 * Usage:
 *   php local/sentientia_org/cli/migrate_all.php
 *   php local/sentientia_org/cli/migrate_all.php --dry-run
 *
...
// ═══════════════════════════════════════════════════════
// 1. local_costcenter → local_sentientia_org
// ═══════════════════════════════════════════════════════
$results[] = migrate_table(
    'local_costcenter', 'local_sentientia_org',
    [
        'id'           => 'id',
        'fullname'     => 'fullname',
        'shortname'    => 'shortname',
