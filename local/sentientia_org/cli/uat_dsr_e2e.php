...
//
// Run: php public/local/sentientia_org/cli/uat_dsr_e2e.php
//
...
$full_plugins = [
    'sentientia_evaluation',
    'sentientia_classroom',
    'sentientia_programs',
    'sentientia_learningpath',
    'sentientia_emails',
    'sentientia_notifications',
    'sentientia_roles',
    'sentientia_challenge',
    'sentientia_manager',
    'sentientia_skills',
];
