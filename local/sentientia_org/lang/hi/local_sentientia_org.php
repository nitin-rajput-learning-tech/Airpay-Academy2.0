...
//
// P1 #54 (2026-05-20) — Hindi (hi) translations for local_sentientia_org.
...
$string['sentientia_org:manage_multiorganizations'] = 'कई संगठन प्रबंधित करें';
$string['sentientia_org:manage_ownorganization']    = 'अपना संगठन प्रबंधित करें';
$string['sentientia_org:manage_owndepartments']     = 'अपने विभाग प्रबंधित करें';
$string['sentientia_org:view']                      = 'संगठन देखें';
...
$string['migrationskipped']      = 'माइग्रेशन छोड़ा गया — local_sentientia_org तालिका में पहले से डेटा है।';
...
$string['error_parent_outofscope'] = 'अपने ही संगठन के भीतर का कोई मूल संगठन चुनें। नया टॉप-लेवल टेनेंट केवल प्लेटफ़ॉर्म (क्रॉस-टेनेंट) एडमिनिस्ट्रेटर ही बना सकता है।';
