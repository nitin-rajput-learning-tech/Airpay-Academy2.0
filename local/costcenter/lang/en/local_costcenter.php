...
$string['selectsubcostcenter']='Bussiness Unit';
...
$string['subdepartment_structure'] = 'Bussiness Unit Structure';
...
$string['viewsubdepartments'] = 'View Bussiness Unit\'s';
$string['top'] = 'Top';
...
$string['update_costcenter'] = 'Update Country';
$string['update_subdept'] = 'Update Bussiness Unit';
...
$string['cannotdeletecostcenter'] = 'As the country "{$a->scname}" has bussiness unit, you cannot delete it. Please delete the assigned Countries or programs first and come back here. ';
...
// $string['subsubdepartment'] = 'Sub Bussiness Unit';
...
$string['adnewsubdept'] = '<i class="fa fa-sitemap popupstringicon" aria-hidden="true"></i> Create New Bussiness Unit <div class= "popupstring"></div>';
...
$string['createsubdepartment'] = 'Create New Bussiness Unit';
...
$string['confirmation_to_disable_subdepartment_0'] = 'Are you sure you want to active <b>{$a}</b> Bussiness Unit.';
$string['confirmation_to_disable_subdepartment_1'] = 'Are you sure you want to in-active <b>{$a}</b> Bussiness Unit.';
...
$string['addnewdept/subdept'] = 'Create New Country/Bussiness Unit';
$string['addnewsubdept'] = 'Create New Bussiness Unit';
...
$string['addnewsubsubdept']='ADD New Commercial Unit';
$string['addnewsubsubsubdept']='ADD New Territory';
$string['createsubsubdepartment']='Create New Commercial';
$string['createsubsubsubdepartment']='Create New Territory';
$string['subsubdepartment']='Commercial Unit';
$string['subsubsubdepartment']='Territory';
$string['viewsubsubdepartments']='View Commercial Unit';
$string['viewsubsubsubdepartments']='View Territory';
$string['subsubdepartment_structure']='Commercial Unit Structure';
$string['update_subsubdept']='Upadete Commercial Unit';
$string['update_subsubsubdept']='Upadete Territory';
