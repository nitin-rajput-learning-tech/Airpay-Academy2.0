...
$string['msg_add_reg_schl'] = 'Hi {$a->username}<br> You are assigned to Country {$a->costcentername}.';
$string['assignrole_help'] = 'Assign a role to the user in the selected Country.';
$string['assignedcostcenter'] = 'Assigned Countries';
$string['assigncostcenter_help'] = 'Assign this user to a Country.';
$string['anycostcenter'] = 'Any Country';
$string['campus'] = 'Campus';
$string['university'] = 'University';
$string['location'] = 'Location';
$string['costcenterlevel'] = 'Country Level';
$string['assignedtocostcenters'] = 'Assigned to Country';
$string['assigncostcenter'] = 'Assign Countries';
$string['notassignedcostcenter'] = 'Sorry you are not assigned to any costcenter.';
$string['costcenterscolleges'] = 'Countries';
$string['costcenterid'] = 'Countries';
$string['costcenterrequired'] = 'Country field is mandatory';
$string['missingcostcenter'] = 'Please select the Country';
$string['select'] = 'Select Country';
$string['selectsubcostcenter']='Commercial Unit';
$string['costcentername'] = 'Name';
$string['universitysettings'] = 'University Settings';
$string['cobaltLMSentitysettings'] = 'Entity Settings';
$string['costcentersettings'] = 'Country Settings';
$string['GPA/CGPAsettings'] = 'GPA/CGPA Settings';
$string['PrefixandSuffix'] = 'Prefix and Suffix';
$string['assignmanager_title'] = 'Country : Assign Managers';
$string['pluginname'] = 'Countries';
$string['orgStructure'] = 'Organization Structure';
$string['department_structure'] = 'Country Structure';
$string['subdepartment_structure'] = 'Commercial Unit Structure';
$string['orgmanage'] = 'Manage Organization';
$string['managecostcenters'] = 'Manage Countries';
...
$string['deletecostcenter'] = 'Delete Country';
$string['delconfirm'] = 'Do you really want to delete this Course?';
$string['createcostcenter'] = 'Create New +';
$string['editcostcenter'] = 'Edit Country';
$string['missingcostcentername'] = 'Name cannot be empty';
$string['viewcostcenter'] = 'View Countries';
$string['viewsubdepartments'] = 'View Commercial Unit\'s';
$string['top'] = 'Top';
$string['parent'] = 'Parent';
$string['parent_help'] = "To create a New Country at Parent Level, please select 'Parent' ";
$string['costcenter'] = 'Countries';
...
$string['nocostcenter'] = 'No Country is assigned';
$string['selectcostcenter'] = 'TOP Level';
$string['createsuccess'] = 'Country with name "{$a->costcenter}" created successfully';
$string['updatesuccess'] = 'Country with name "{$a->costcenter}" updated successfully';
$string['deletesuccess'] = 'Deleted Successfully';
$string['deletesuccesscostcenter'] = 'Country "<b>{$a}</b>" deleted Successfully';
$string['type'] = 'Type';
$string['type_help'] = 'Please select your Country Type. If it is "University" please select University as Type. If it is "Campus"  select Campus as Type.';
$string['chilepermissions'] = 'Do we need to allow the manager to see child courses of this costcenter.';
$string['create'] = 'Create Countries';
$string['update_dipartment'] = 'Update Country';
$string['update_subdipartment'] = 'Update Country';
$string['update_subsubdipartment'] = 'Update Commercial Unit';
$string['update_subsubsubdipartment'] = 'Update Commercial Area';
$string['update_subdept'] = 'Update Commercial Unit';
$string['view'] = 'View Countries';
$string['assignmanager'] = 'Assign Managers';
$string['info'] = 'Help';
$string['reports'] = 'Reports';
$string['alreadyassigned'] = 'Already user is assigned to selected country "{$a->costcenter}"';
$string['assignedsuccess'] = 'Successfully assigned manager to Country.';
$string['permissions'] = 'Permissions';
$string['permissions_help'] = 'Do we need to allow the manager to see child courses of this country.';
$string['programname'] = 'Program Name';
$string['unassignmanager'] = "Are you sure, you want to unassign Manager?";
$string['unassingheading'] = 'Unassign Manager';
$string['unassignedsuccess'] = 'Successfully Unassigned Manager from country';
$string['problemunassignedsuccess'] = 'There is a problem in Unassigning manager from country';
$string['assignedfailed'] = 'Error in assigning a user';
$string['cannotdeletecostcenter'] = 'As the country "{$a->scname}" has Commercial Unit, you cannot delete it. Please delete the assigned Countries or programs first and come back here. ';
$string['nousersyet'] = 'No User is having Manager Role';
$string['costcentername'] = 'Name';
$string['saction'] = 'Action';
$string['assignmanagertxt'] = "Assign the manager to a Country by selecting the respective manager, next selecting the respective organizations and then clicking on 'Assign Manager' ";
$string['costcenter:manage'] = 'costcenter:manage';
$string['costcenter:view'] = 'costcenter:view';
$string['costcenter:manage_owndepartments'] = 'costcenter:manage_owncountrys';
...
$string['costcenter:manage_multidepartments'] = 'costcenter:manage_multicountries';

$string['nopermissions'] = 'Sorry, You dont have Permissions ';
$string['errormessage'] = 'Error Message';
$string['assign_costcenter'] = 'Assigned Country ';
$string['programsandcostcenters'] = "<h3>Programs and Country Assigned to this costcenter</h3>";
$string['success'] = 'Country "{$a->costcenter}" successfully {$a->visible}.';
$string['failure'] = 'You can not inactivate Country.';
...
$string['uploadcostcenters'] = 'Upload Countries';
...
$string['uploadcostcenterspreview'] = 'Upload Countries preview';
$string['uploadcostcentersresult'] = 'Upload Countries results';
$string['costcenteraccountupdated'] = 'Countries updated';
$string['costcenteraccountuptodate'] = 'Countries up-to-date';
$string['costcenterdeleted'] = 'Country deleted';
$string['costcenterscreated'] = 'Country created';
$string['costcentersdeleted'] = 'Country deleted';
$string['costcentersskipped'] = 'Country skipped';
$string['costcentersupdated'] = 'Country updated';
$string['uubulk'] = 'Select for bulk costcenter actions';
$string['uubulkall'] = 'All Countries';
$string['uubulknew'] = 'New Countries';
$string['uubulkupdated'] = 'Updated Countries';
$string['uucsvline'] = 'CSV line';
$string['uuoptype'] = 'Upload type';
$string['uuoptype_addnew'] = 'Add new only, skip existing Countries';
$string['uuoptype_addupdate'] = 'Add new and update existing Countries';
$string['uuoptype_update'] = 'Update existing Countries only';
...
$string['uploadcostcenters'] = 'Upload Countries';
$string['uploadcostcenter'] = 'Upload Countries';
$string['costcenternotaddedregistered'] = 'Countries not added, Already manager';
$string['newcostcenter'] = 'New program created';
$string['parentid'] = 'Parentid';
$string['uploadcostcenterspreview'] = 'Uploaded Countries preview';
...
$string['uploadcostcenterspreview'] = 'Uploaded Countries Preview';
$string['uploadcostcenters'] = 'Upload Countries';
$string['costcenters'] = 'Countries';
$string['no_user'] = "No user is assigned till now";
$string['information'] = 'A costcenter in Cobalt Learning Management System is defined as college/institution that offers program(s). The costcenter(s) is instructed/disciplined by Instructor(s). A costcenter has its own programs and countries. ';
...
';
$string['help_des'] = '<h1>View Countries</h1>
<p>This page allows you to manage (delete/edit) the Countries that are defined under this institution.</b></p>
...
<p>Parent denotes the main institution that can be categorized into different Countries, campus, universities etc. It can have one or multiple (child) sub-institutions.</b></p>
...
$string['organization/department'] = 'Organization / Country';
...
$string['adnewcostcenter'] = '<i class="fa fa-sitemap popupstringicon" aria-hidden="true"></i> Create New Organization <div class= "popupstring"></div>';

$string['cuplan'] = 'cuplan';
$string['deptconfig'] = 'Country Configuration';
...
$string['adnewdept'] = '<i class="fa fa-sitemap popupstringicon" aria-hidden="true"></i> Create New Country <div class= "popupstring"></div>';
$string['adnewsubdept'] = '<i class="fa fa-sitemap popupstringicon" aria-hidden="true"></i> Create New Commercial Unit <div class= "popupstring"></div>';
$string['addnewdept'] = 'Create New Country';
...
$string['createdepartment'] = 'Create New Country';
$string['createsubdepartment'] = 'Create New Commercial Unit';
...
$string['confirmation_to_disable_department_0'] = 'Are you sure you want to active <b>{$a}</b> Country.';
$string['confirmation_to_disable_department_1'] = 'Are you sure you want to in-active <b>{$a}</b> Country.';
$string['confirmation_to_disable_subdepartment_0'] = 'Are you sure you want to active <b>{$a}</b> Commercial Unit.';
$string['confirmation_to_disable_subdepartment_1'] = 'Are you sure you want to in-active <b>{$a}</b> Commercial Unit.';

$string['costcenter_logo'] = 'Preferred Logo';
$string['preferredscheme'] = ' Select Preferred scheme';
$string['editdep'] = 'Edit Country';
$string['fieldlabel'] = 'Licence Key';
$string['notemptymsg'] = 'Licence Key should not be Empty';
$string['organisation'] = 'Organization';
$string['cannotcreatedept'] = 'You cannot create Country until atleast one Organization creation';
$string['addnewdept/subdept'] = 'Create New Country/Commercial Unit';
$string['addnewsubdept'] = 'Create New Commercial Unit';
$string['scheme_1'] = 'Greenish';
$string['scheme_2'] = 'Red Fox';
$string['scheme_3'] = 'Blue';
$string['scheme_4'] = 'Maroon';
$string['scheme_5'] = 'Midnight Blue';
$string['scheme_6'] = 'Lite Blue';
$string['costcenter:assign_multiple_departments_manage'] = 'Assign multiple countries';
$string['costcenter:manage_multiorganizations'] = 'Manage multiple organizations';
$string['costcenter:manage_ownorganization'] = 'Manage ownorganization';
$string['costcenter:manage_subdepartments_manage'] = 'Manage_subcountries';
...
$string['create_organization'] = 'Create New Organization';
...
$string['no_users_data'] = 'No Users Available';
...
$string['coursecount'] = 'Total Courses';
$string['activecoursecount'] = 'Active Courses';
$string['inactivecoursecount'] = 'In-Active Courses';
$string['alllearningplans'] = 'Total Learning Paths';
$string['activelearningplans'] = 'Active Learning Paths';
$string['inactivelearningplans'] = 'In-Active Learning Paths';
$string['allprogramcount'] = 'Total Programs';
$string['activeprogramcount'] = 'Active Programs';
$string['inactiveprogramcount'] = 'In-Active Programs';
$string['totalonlineexams'] = 'Total Online Exams';
$string['activeonlineexams'] = 'Active Online Exams';
$string['inactiveonlineexams'] = 'In-Active Online Exams';
...
$string['addnewsubsubdept']='Create New Commercial Area';
$string['addnewsubsubsubdept']='Create New Territory';
$string['createsubsubdepartment']='Create New Commercial Area';
$string['createsubsubsubdepartment']='Create New Territory';
$string['subsubdepartment']='Commercial Area';
$string['subsubsubdepartment']='Territory';
$string['viewsubsubdepartments']='View Commercial Area';
$string['viewsubsubsubdepartments']='View Territory';
$string['subsubdepartment_structure']='Commercial Area Structure';
$string['update_subsubdept']='Update Commercial Area';
$string['update_subsubsubdept']='Update Territory';
$string['open_costcenterid']='Organization';
$string['open_department']='Country';
$string['open_subdepartment']='Commercial Unit';
$string['open_level4department']='Commercial Area';
