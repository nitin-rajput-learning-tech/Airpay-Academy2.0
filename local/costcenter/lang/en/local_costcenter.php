...
$string['viewsubdepartments'] = 'View Sub Department\'s';
$string['top'] = 'Top';
...
$string['assignmanagertxt'] = "Assign the manager to a Department by selecting the respective manager, next selecting the respective organizations and then clicking on 'Assign Manager' ";
...
$string['adnewdept'] = '<i class="fa fa-sitemap popupstringicon" aria-hidden="true"></i> Create New Department <div class= "popupstring"></div>';
$string['adnewsubdept'] = '<i class="fa fa-sitemap popupstringicon" aria-hidden="true"></i> Create New Sub Department <div class= "popupstring"></div>';
...
$string['createdepartment'] = 'Create New Department';
$string['createsubdepartment'] = 'Create New Sub Department';
...
$string['confirmation_to_disable_subdepartment_0'] = 'Are you sure you want to active <b>{$a}</b> Sub Department.';
$string['confirmation_to_disable_subdepartment_1'] = 'Are you sure you want to in-active <b>{$a}</b> Sub Department.';
