...
NewRepository.prototype.init = function() {
 ...
 var editid = self.repositoryid;
 if (editid) {
     self.repositoryid = editid;
     upd_string=Str.get_string('editrepository', 'local_skillrepository');
 }
 else{
    upd_string=Str.get_string('adnewrepository', 'local_skillrepository');
 }
 return upd_string.then(function(title) {
     // Create the modal.
