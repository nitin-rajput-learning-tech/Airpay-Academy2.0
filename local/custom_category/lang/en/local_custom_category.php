...
$string['parent'] = 'Parent Category';
$string['action'] = 'Action';
$string['updatecuscategory'] = 'Update Category';
$string['shortnameexists'] = 'Shortname Already Exist';
$string['deletecategory'] = 'Are you sure to delete <b>{$a->name}</b>?';
$string['nodeletecategory'] = 'You cannot delete <b>{$a->name}</b> as it has linked child category or mapped to course . Please unmap to delete.?';
$string['yesdelete'] = 'Yes';
$string['reason'] = 'Reason';
$string['no'] = 'No';
$string['top'] = 'Top';
$string['organization'] = 'Company';
$string['open_costcenteridlocal_custom_category'] = 'Company';
$string['open_costcenteridlocal_custom_category_help'] = 'Company of category';
