 ...
 * `\local_sentientia_ratings\rating_manager::render()`. On click of a star, calls
 * the `local_sentientia_ratings_submit_rating` WS and updates the display
 ...
 *
 * @module     local_sentientia_ratings/rating_widget
 */
    ...
    function setupWidget(widget) {
        ...
        stars.forEach(function(btn) {
            ...
            btn.addEventListener('click', function() {
                ...
                Ajax.call([{
                    methodname: 'local_sentientia_ratings_submit_rating',
                    args: {
                        itemid:   itemid,
                        ratearea: ratearea,
                        rating:   newRating
