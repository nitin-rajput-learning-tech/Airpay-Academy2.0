...
$heading = get_string($tab.'_courses', 'local_courses');
$PAGE->set_title($heading);
$PAGE->set_heading($heading);
$PAGE->navbar->add($heading);
$PAGE->requires->js_call_amd('block_userdashboard/userdashboard', 'makeActive',array('identifier' => 'courses_'.$tab));
...
$filterparams = $renderer->get_userdashboard_courses($tab, true,$formattype);
echo $OUTPUT->header();
  $display_url = new moodle_url('/local/courses/userdashboard.php',array('tab' => $tab ,'formattype' => $formattype_url));
...
echo $OUTPUT->render_from_template('local_courses/userdashboard_inner_tab', array());
echo $OUTPUT->render_from_template('local_costcenter/global_filter', $filterparams);
// echo ;
$content = $renderer->get_userdashboard_courses($tab,false,$formattype);
