            ...
            if ($enroll) {
                ...
                if ($courseinfo->approvalreqd == 1 && $courseinfo->price_status == 0 && $courseinfo->selfenrol == 1) {
                    ...
                    if ($airpaypayment) {
                        ...
                        $selfenrolbutton = '<button class="btn btn-block cat_btn" type="button"  data-action="core_payment/triggerPayment" data-component="enrol_fee" data-paymentarea="fee" data-itemid="' . $airpaypayment->id . '" data-cost="' . $courseinfo->courseprice . '" data-successurl="'. $CFG->wwwroot .'"' . $courseid . '" data-description="Enrolment in course">' . $string . '</button>';
                    }
                }else{
                    $selfenrolbutton = '';
                }
