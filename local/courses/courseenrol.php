...
$systemcontext = (new \local_courses\lib\accesslib())::get_module_context($course->open_costcenterid,$course_id ,'local_courses');
...
$canenrol = has_capability('local/courses:enrol', $systemcontext);
