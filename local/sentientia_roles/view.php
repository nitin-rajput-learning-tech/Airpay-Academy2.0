...
$role = \local_sentientia_roles\role_manager::get_role($roleid);

$baseurl = new moodle_url('/local/sentientia_roles/view.php', ['id' => $roleid]);
$PAGE->set_url($baseurl);
$PAGE->navbar->add(get_string('heading_index', 'local_sentientia_roles'),
    new moodle_url('/local/sentientia_roles/index.php'));
...
$caps_columns = [
    ['key' => 'capability', 'label' => get_string('cap_col_name',      'local_sentientia_roles'), 'sortable' => true],
    ['key' => 'component',  'label' => get_string('cap_col_component', 'local_sentientia_roles'), 'sortable' => true],
    ['key' => 'risks_html', 'label' => get_string('cap_col_risks',     'local_sentientia_roles'), 'sortable' => false, 'format' => 'html'],
    ['key' => 'perm_label', 'label' => get_string('cap_col_perm',      'local_sentientia_roles'), 'sortable' => true],
    ['key' => 'actions',    'label' => get_string('cap_col_actions',   'local_sentientia_roles'), 'sortable' => false, 'format' => 'html'],
];
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_sentientia_roles/view', $data);
