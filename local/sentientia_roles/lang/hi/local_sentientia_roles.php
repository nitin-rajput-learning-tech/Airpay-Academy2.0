...
//
// P1 #56 (2026-05-20) — Hindi (hi) translations for local_sentientia_roles.
...
$string['sentientia_roles:manage'] = 'रोल पर क्षमता अनुमतियाँ संपादित करें';
$string['sentientia_roles:assign'] = 'यूज़र्स को रोल असाइन / अनअसाइन करें';
$string['sentientia_roles:audit']  = 'रोल-प्रबंधन ऑडिट लॉग देखें';
$string['sentientia_roles:export'] = 'रोल + क्षमता डेटा CSV में निर्यात करें';
