...
$string['sentientia_roles:manage'] = 'Edit capability permissions on roles';
$string['sentientia_roles:assign'] = 'Assign / unassign users to roles';
$string['sentientia_roles:audit']  = 'View role-management audit log';
$string['sentientia_roles:export'] = 'Export role + capability data to CSV';
