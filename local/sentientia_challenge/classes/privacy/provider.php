...
/**
 * Privacy Subsystem implementation for local_sentientia_challenge.
 *
...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_database_table('local_sentientia_challenge_challenges', [
        ...
        $collection->add_database_table('local_sentientia_challenge_attempts', [
        ...
        $collection->add_database_table('local_sentientia_challenge_leaderboard', [
    ...
    public static function get_users_in_context(userlist $userlist): void {
        ...
        $sql = "SELECT userid FROM {local_sentientia_challenge_attempts}
                 UNION
                SELECT userid FROM {local_sentientia_challenge_leaderboard}
                 UNION
                SELECT createdby AS userid FROM {local_sentientia_challenge_challenges}
                  WHERE createdby > 0";
    ...
    public static function export_user_data(approved_contextlist $contextlist): void {
        ...
        $created = $DB->get_records('local_sentientia_challenge_challenges',
            ['createdby' => $userid]);
        if (!empty($created)) {
        ...
        $attempts = $DB->get_records_sql("
         ...
         LEFT JOIN {local_sentientia_challenge_challenges} c ON c.id = a.challengeid
             WHERE a.userid = :u
        ...
        // Leaderboard.
        $leaderboard = $DB->get_records('local_sentientia_challenge_leaderboard',
            ['userid' => $userid]);
    ...
    public static function delete_data_for_all_users_in_context(\context $context): void {
        ...
        $DB->delete_records('local_sentientia_challenge_leaderboard');
        $DB->execute("UPDATE {local_sentientia_challenge_challenges}
    ...
    public static function delete_data_for_users(approved_userlist $userlist): void {
        ...
        $DB->execute("DELETE FROM {local_sentientia_challenge_attempts}    WHERE userid $insql", $inparams);
        $DB->execute("DELETE FROM {local_sentientia_challenge_leaderboard} WHERE userid $insql", $inparams);
        $DB->execute("UPDATE {local_sentientia_challenge_challenges}
                         SET createdby = 0, open_path = NULL
