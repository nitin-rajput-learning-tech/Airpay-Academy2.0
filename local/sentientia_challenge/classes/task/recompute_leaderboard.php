...
namespace local_sentientia_challenge\task;
...
class recompute_leaderboard extends \core\task\scheduled_task {
    ...
    public function get_name(): string {
        return get_string('task_recompute_leaderboard', 'local_sentientia_challenge');
    }
    ...
    public function execute(): void {
        ...
        if ($expired > 0) {
            mtrace("sentientia_challenge: expired $expired past-end-date attempts");
        }
